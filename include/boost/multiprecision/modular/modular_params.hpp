...
// {
//    typedef backends::montgomery_params<cpp_int_backend<MinBits, MinBits, SignType, Checked, void>> montgomery_policy;
//    typedef backends::barrett_params<cpp_int_backend<MinBits, MinBits, SignType, Checked, void>> barrett_policy;
//    typedef modular_params<cpp_int_backend<MinBits, MinBits, SignType, Checked, void>> self_type;
//
...
//
//    constexpr explicit modular_params(const Backend& v) : montgomery_policy(number_type(v)), barrett_policy(number_type(v)) {}
//
