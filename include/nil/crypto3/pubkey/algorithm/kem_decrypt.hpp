...
namespace nil {
    namespace crypto3 {
        namespace pubkey {
            ...
            using kem_decryption_policy = typename pubkey::modes::isomorphic<Scheme, nop_padding>::kem_decryption_policy;
        }
        /*!
         * @brief
         *
        ...
        OutputIterator kem_decrypt(const SinglePassRange &rng, const private_key<Scheme> &key, OutputIterator
        out) {
