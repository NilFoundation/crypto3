...
namespace nil {
    namespace crypto3 {
        ...
        template<typename PublicKeyCipher, typename InputIterator, typename PrivateKeyIterator, typename OutputIterator,
                 typename StreamDecrypter = typename detail::itr_stream_encrypt_traits<PublicKeyCipher,
                                                                                       InputIterator>::type>
        ...
        template<typename PublicKeyCipher, typename InputIterator, typename PrivateKeyIterator,
                 typename StreamDecrypter = typename detail::itr_stream_encrypt_traits<PublicKeyCipher,
                                                                                       InputIterator>::type>
        detail::range_encrypt_impl<PublicKeyCipher, detail::value_encrypt_impl<StreamDecrypter>> decrypt(
                InputIterator first, InputIterator last, PrivateKeyIterator key_first, PrivateKeyIterator key_last) {
            typedef detail::value_encrypt_impl<StreamDecrypter> StreamDecrypterImpl;
        ...
        template<typename PublicKeyCipher, typename InputIterator,
                 typename StreamDecrypter = typename detail::itr_stream_encrypt_traits<PublicKeyCipher,
                                                                                       InputIterator>::type>
        detail::range_encrypt_impl<PublicKeyCipher, detail::ref_encrypt_impl<StreamDecrypter>> decrypt(
                InputIterator first, InputIterator last, const private_key<PublicKeyCipher> &key) {
            typedef detail::ref_encrypt_impl<StreamDecrypter> StreamDecrypterImpl;
            typedef detail::range_encrypt_impl<PublicKeyCipher, StreamDecrypterImpl> DecrypterImpl;
        ...
        template<typename PublicKeyCipher, typename SinglePassRange, typename PrivateKeyRange, typename OutputIterator,
                 typename StreamDecrypter = typename detail::range_stream_encrypt_traits<PublicKeyCipher,
         ...
         * @return
         */
        template<typename Decrypter, typename SinglePassRange, typename OutputIterator,
                 typename StreamDecrypter = typename detail::range_stream_encrypt_traits<Decrypter,
                                                                                         SinglePassRange>::type>
        ...
        template<typename PublicKeyCipher, typename SinglePassRange, typename PrivateKeyRange,
                 typename StreamDecrypter = typename detail::range_stream_encrypt_traits<PublicKeyCipher,
                                                                                         SinglePassRange>::type>
        detail::range_encrypt_impl<PublicKeyCipher, detail::value_encrypt_impl<StreamDecrypter>> decrypt(
                const SinglePassRange &r, const PrivateKeyRange &key) {
        ...
        template<typename PublicKeyCipher, typename SinglePassRange,
                 typename StreamHash = typename detail::range_stream_encrypt_traits<PublicKeyCipher,
                                                                                    SinglePassRange>::type>
        detail::range_encrypt_impl<PublicKeyCipher, detail::ref_encrypt_impl<StreamHash>> decrypt(
                const SinglePassRange &rng, StreamHash &sh) {
