...
namespace nil {
    namespace crypto3 {
        namespace pubkey {
            ...
            using kem_encryption_policy = typename pubkey::modes::isomorphic<Scheme, nop_padding>::kem_encryption_policy;
        }
        /*!
         * @brief
         *
        ...
        OutputIterator kem_encrypt(const SinglePassRange &rng, const public_key<Scheme> &key, OutputIterator
        out) {
