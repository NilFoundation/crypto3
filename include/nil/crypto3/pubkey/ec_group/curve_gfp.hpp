...
namespace nil {
    namespace crypto3 {
        ...
        public:
            ...
            void curve_mul(number_type &z, const number_type &x, const number_type &y, secure_vector<word> &ws) const {
                CRYPTO3_DEBUG_ASSERT(x.sig_words() <= m_p_words);
                curve_mul_words(z, x.data(), x.size(), y, ws);
            }

            virtual void curve_mul_words(number_type &z, const word x_words[], std::size_t x_size, const number_type &y,
