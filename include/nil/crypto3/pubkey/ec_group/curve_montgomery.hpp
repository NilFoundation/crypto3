#ifndef CRYPTO3_PUBKEY_CURVE_GFP_MONTGOMERY_HPP
#define CRYPTO3_PUBKEY_CURVE_GFP_MONTGOMERY_HPP
        ...
        namespace pubkey {
            ...
            public:
                ...
                void curve_mul_words(number_type &z, const uint32_t x_words[], std::size_t x_size, const number_type &y,
                    ...
                    bigint_mul(z.mutable_data(), z.size(), x_words, x_size, std::min(m_p_words, x_size), y.data(),
                               y.size(), std::min(m_p_words, y.size()), ws.data(), ws.size());
