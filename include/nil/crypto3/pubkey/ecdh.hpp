#ifndef CRYPTO3_ECDH_KEY_HPP_
#define CRYPTO3_ECDH_KEY_HPP_
...
*/
        ...
        public:
            ...
            */
            ecdh_public_key(const algorithm_identifier &alg_id, const std::vector<uint8_t> &key_bits) : ec_public_key(
                    alg_id, key_bits) {
            }
            ...
            */
            ecdh_public_key(const ec_group &dom_par, const point_gfp &public_point) : ec_public_key(dom_par,
                                                                                                    public_point) {
            }
