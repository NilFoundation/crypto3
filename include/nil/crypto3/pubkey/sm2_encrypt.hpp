#ifndef CRYPTO3_SM2_ENC_KEY_HPP_
#define CRYPTO3_SM2_ENC_KEY_HPP_
...
*/
        ...
        public:
            ...
            */
            sm2_encryption_public_key(const ec_group &dom_par, const point_gfp &public_point) : ec_public_key(dom_par,
                                                                                                              public_point) {
            }
...
*/
            ...
            std::unique_ptr<pk_operations::decryption> create_decryption_op(random_number_generator &rng,
                                                                            const std::string &params,
                                                                            const std::string &provider) const override;
        };
    }
