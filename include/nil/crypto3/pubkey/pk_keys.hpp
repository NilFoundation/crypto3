#ifndef CRYPTO3_PK_KEYS_HPP_
#define CRYPTO3_PK_KEYS_HPP_
 ...
 */
        ...
        public:
            ...
            * @param provider the provider to use
            */
            virtual std::unique_ptr<pk_operations::kem_encryption> create_kem_encryption_op(
            ...
            * @param provider the provider to use
            */
            virtual std::unique_ptr<pk_operations::verification> create_verification_op(const std::string &params,
                                                                                        const std::string &provider) const;
        };
...
* @param provider the provider to use
*/
            virtual std::unique_ptr<pk_operations::kem_decryption> create_kem_decryption_op(
                    random_number_generator &rng, const std::string &params, const std::string &provider) const;
...
* @param provider the provider to use
*/
            virtual std::unique_ptr<pk_operations::key_agreement> create_key_agreement_op(random_number_generator &rng,
                                                                                          const std::string &params,
                                                                                          const std::string &provider) const;
