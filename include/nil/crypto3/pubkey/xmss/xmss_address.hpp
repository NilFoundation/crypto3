#ifndef CRYPTO3_PUBKEY_XMSS_ADDRESS_HPP
#define CRYPTO3_PUBKEY_XMSS_ADDRESS_HPP
...
namespace nil {
    namespace crypto3 {
        ...
        public:
             ...
             **/
            void set_layer_addr() {
                BOOST_ASSERT_MSG(false, "Only available in XMSS_MT.");
            }
            ...
            XMSS_Address(Type type) : m_data(m_address_size) {
                set_type(type);
            }
