            ...
            namespace pairing {
                namespace detail {
                    ...
                    public:
                        ...
                        void doubling_step_for_miller_loop(extended_g1_projective &current, Fq_conic_coefficients &cc) {
                        ...
                        gt tate_miller_loop(const tate_g1_precomp &prec_P, const tate_g2_precomp &prec_Q) {
