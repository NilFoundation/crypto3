...
#ifndef CRYPTO3_ALGEBRA_PAIRING_BN128_FUNCTIONS_HPP
#define CRYPTO3_ALGEBRA_PAIRING_BN128_FUNCTIONS_HPP

#include <sstream>

#include <nil/crypto3/algebra/pairing/detail/bn128/ate.hpp>
#include <nil/crypto3/algebra/pairing/detail/bn128/basic_functions.hpp>
#include <nil/crypto3/algebra/pairing/detail/bn128/basic_policy.hpp>
            ...
            namespace pairing {
                namespace detail {
                    ...
                    bn128_ate_g2_precomp<ModulusBits, GeneratorBits> &prec_Q2) {
                        ...
                        curves::bn128_gt<ModulusBits, GeneratorBits> result = bn128_double_ate_miller_loop(prec_P1,
                    prec_Q1, prec_P2, prec_Q2);
