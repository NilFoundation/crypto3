...
constexpr static const std::size_t element_size = modulus_bits;
                ...
                constexpr
                    typename modp_srp<1024, CHAR_BIT>::generator_type const modp_srp<1024, CHAR_BIT>::mul_generator;
                constexpr
                    typename modp_srp<1536, CHAR_BIT>::generator_type const modp_srp<1536, CHAR_BIT>::mul_generator;
                constexpr
                    typename modp_srp<2048, CHAR_BIT>::generator_type const modp_srp<2048, CHAR_BIT>::mul_generator;
                constexpr
                    typename modp_srp<3072, CHAR_BIT>::generator_type const modp_srp<3072, CHAR_BIT>::mul_generator;
                constexpr
                    typename modp_srp<4096, CHAR_BIT>::generator_type const modp_srp<4096, CHAR_BIT>::mul_generator;
                constexpr
                    typename modp_srp<6144, CHAR_BIT>::generator_type const modp_srp<6144, CHAR_BIT>::mul_generator;
                constexpr
                    typename modp_srp<8192, CHAR_BIT>::generator_type const modp_srp<8192, CHAR_BIT>::mul_generator;
