...
#pragma warning(disable : 4018 4389 4996)
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if_c<
                    ...
                    eval_eq(const cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>& a,
                            const cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>& b) BOOST_NOEXCEPT {
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if_c<
                    !is_trivial_cpp_int<
                        cpp_int_backend<MinBits, MaxBits, unsigned_magnitude, Checked, Allocator>>::value,
                    bool>::type
