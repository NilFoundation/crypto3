...
struct signed_cpp_int_literal_result_type
{
   ...
   using backend_type             = nil::crypto3::multiprecision::backends::cpp_int_backend<bits, bits, signed_magnitude, unchecked, void>;
...
{
   static constexpr unsigned bits = Digits * 4;
   using backend_type             = nil::crypto3::multiprecision::backends::cpp_int_backend<bits, bits, unsigned_magnitude, unchecked, void>;
   using number_type              = number<backend_type, et_off>;
};
...
template <char... STR>
constexpr typename nil::crypto3::multiprecision::literals::detail::signed_cpp_int_literal_result_type<(sizeof...(STR)) - 2>::number_type operator"" _cppi()
{
   using pt = typename nil::crypto3::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type;
   return nil::crypto3::multiprecision::literals::detail::make_backend_from_pack<pt, typename nil::crypto3::multiprecision::literals::detail::signed_cpp_int_literal_result_type<(sizeof...(STR)) - 2>::backend_type>::value;
}

template <char... STR>
constexpr typename nil::crypto3::multiprecision::literals::detail::unsigned_cpp_int_literal_result_type<(sizeof...(STR)) - 2>::number_type operator"" _cppui()
{
   using pt = typename nil::crypto3::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type;
   return nil::crypto3::multiprecision::literals::detail::make_backend_from_pack<pt, typename nil::crypto3::multiprecision::literals::detail::unsigned_cpp_int_literal_result_type<(sizeof...(STR)) - 2>::backend_type>::value;
}

#define BOOST_MP_DEFINE_SIZED_CPP_INT_LITERAL(Bits)                                                                                                                                                                                \
   template <char... STR>                                                                                                                                                                                                          \
   constexpr nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::backends::cpp_int_backend<Bits, Bits, nil::crypto3::multiprecision::signed_magnitude, nil::crypto3::multiprecision::unchecked, void> > operator"" BOOST_JOIN(_cppi, Bits)()    \
   {                                                                                                                                                                                                                               \
      using pt = typename nil::crypto3::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type;                                                                                                                       \
      return nil::crypto3::multiprecision::literals::detail::make_backend_from_pack<                                                                                                                                                      \
          pt,                                                                                                                                                                                                                      \
          nil::crypto3::multiprecision::backends::cpp_int_backend<Bits, Bits, nil::crypto3::multiprecision::signed_magnitude, nil::crypto3::multiprecision::unchecked, void> >::value;                                                                  \
   }                                                                                                                                                                                                                               \
   template <char... STR>                                                                                                                                                                                                          \
   constexpr nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::backends::cpp_int_backend<Bits, Bits, nil::crypto3::multiprecision::unsigned_magnitude, nil::crypto3::multiprecision::unchecked, void> > operator"" BOOST_JOIN(_cppui, Bits)() \
   {                                                                                                                                                                                                                               \
      using pt = typename nil::crypto3::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type;                                                                                                                       \
      return nil::crypto3::multiprecision::literals::detail::make_backend_from_pack<                                                                                                                                                      \
          pt,                                                                                                                                                                                                                      \
          nil::crypto3::multiprecision::backends::cpp_int_backend<Bits, Bits, nil::crypto3::multiprecision::unsigned_magnitude, nil::crypto3::multiprecision::unchecked, void> >::value;                                                                \
   }
...
{
   return cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>(a.backend(), nil::crypto3::multiprecision::literals::detail::make_negate_tag());
}
template <unsigned MinBits, cpp_int_check_type Checked>
constexpr number<cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>, et_off>
          operator-(number<cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>, et_off>&& a)
{
   return cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>(static_cast<const number<cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>, et_off>&>(a).backend(), nil::crypto3::multiprecision::literals::detail::make_negate_tag());
}
