...
// Note that this is not a complete header, it must be included as part of nil/crypto3/multiprecision/cpp_int.hpp.
//
...
{
   return checked_add_imp(a, b, std::integral_constant < bool, nil::crypto3::multiprecision::detail::is_signed<A>::value&& nil::crypto3::multiprecision::detail::is_integral<A>::value > ());
}
template <class A>
...
{
   return checked_subtract_imp(a, b, std::integral_constant < bool, nil::crypto3::multiprecision::detail::is_signed<A>::value&& nil::crypto3::multiprecision::detail::is_integral<A>::value > ());
}
template <class A>
