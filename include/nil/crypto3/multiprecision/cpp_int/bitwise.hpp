    ...
    namespace crypto3 {
        namespace multiprecision {
            namespace backends {
                ...
                BOOST_MP_CXX14_CONSTEXPR void bitwise_op(CppInt1& result, const CppInt2& o, Op op, const boost::mpl::true_&)
                ...
                template<class CppInt1, class CppInt2, class Op>
                BOOST_MP_CXX14_CONSTEXPR void bitwise_op(CppInt1& result, const CppInt2& o, Op op, const boost::mpl::false_&)
                    BOOST_MP_NOEXCEPT_IF((is_non_throwing_cpp_int<CppInt1>::value)) {
                    //
                ...
                struct bit_and {
                    BOOST_MP_CXX14_CONSTEXPR limb_type operator()(limb_type a, limb_type b) const BOOST_NOEXCEPT {
                        return a & b;
                    }
                };
                struct bit_or {
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if_c<
                    ...
                    type
                    eval_bitwise_and(cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& result,
                                     const cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>& o)
                    ...
                    bitwise_op(
                        ...
                        boost::mpl::bool_ <
                                std::numeric_limits<number<
                                    cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>>>::is_signed ||
                            std::numeric_limits<number<
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if_c<
                    ...
                    !is_trivial_cpp_int<cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>>::value>::
                    type
                    eval_bitwise_or(cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& result,
                                    const cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>& o)
                        BOOST_MP_NOEXCEPT_IF((is_non_throwing_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1,
                                                                                      Checked1, Allocator1>>::value)) {
                    bitwise_op(
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if_c<
                    ...
                    !is_trivial_cpp_int<cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>>::value>::
                    type
                    eval_bitwise_xor(cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& result,
                                     const cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>& o)
                        BOOST_MP_NOEXCEPT_IF((is_non_throwing_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1,
                                                                                      Checked1, Allocator1>>::value)) {
                    bitwise_op(
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if_c<
                    ...
                    !is_trivial_cpp_int<cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>>::value>::
                    type
                    eval_complement(cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& result,
                                    const cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>& o)
                        BOOST_MP_NOEXCEPT_IF((is_non_throwing_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1,
                                                                                      Checked1, Allocator1>>::value)) {
                    BOOST_STATIC_ASSERT_MSG(
                        ((Checked1 != checked) || (Checked2 != checked)),
                ...
                inline BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if_c<!is_trivial_cpp_int<
                    ...
                    eval_left_shift(cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& result,
                                    double_limb_type s)
                        BOOST_MP_NOEXCEPT_IF((is_non_throwing_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1,
                                                                                      Checked1, Allocator1>>::value)) {
                    is_valid_bitwise_op(
                ...
                inline BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if_c<!is_trivial_cpp_int<
                    ...
                    eval_right_shift(
                        ...
                        BOOST_MP_NOEXCEPT_IF(
                            (is_non_throwing_cpp_int<cpp_int_backend<MinBits1, MaxBits1, unsigned_magnitude, Checked1,
                                                                     Allocator1>>::value)) {
                    ...
                    eval_right_shift(
                        ...
                        BOOST_MP_NOEXCEPT_IF(
                            (is_non_throwing_cpp_int<
                                cpp_int_backend<MinBits1, MaxBits1, signed_magnitude, Checked1, Allocator1>>::value)) {
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if<
                    is_trivial_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>>>::type
                    eval_left_shift(cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& result, T s)
                        BOOST_MP_NOEXCEPT_IF((is_non_throwing_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1,
                                                                                      Checked1, Allocator1>>::value)) {
                    is_valid_bitwise_op(
                        result,
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if<
                    is_trivial_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>>>::type
                    eval_right_shift(cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& result, T s)
                        BOOST_MP_NOEXCEPT_IF((is_non_throwing_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1,
                                                                                      Checked1, Allocator1>>::value)) {
