...
struct gmp_float_imp
{
   ...
   gmp_float_imp& operator=(boost::long_long_type i)
   {
      if (m_data[0]._mp_d == 0)
         mpf_init2(m_data, multiprecision::detail::digits10_2_2(digits10 ? digits10 : (unsigned)get_default_precision()));
      bool neg = i < 0;
      *this    = static_cast<boost::ulong_long_type>(nil::crypto3::multiprecision::detail::unsigned_abs(i));
      if (neg)
   ...
   std::string str(std::streamsize digits, std::ios_base::fmtflags f) const
   {
      ...
      nil::crypto3::multiprecision::detail::format_float_string(result, e, org_digits, f, mpf_sgn(m_data) == 0);
      return result;
   }
   ~gmp_float_imp() noexcept
   {
   ...
   template <class V>
   typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<V>::value, int>::type compare(V v) const
   {
...
inline typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<T>::value, bool>::type eval_eq(const gmp_float<digits10>& a, const T& b) noexcept
{
   return a.compare(b) == 0;
}
template <unsigned digits10, class T>
inline typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<T>::value, bool>::type eval_lt(const gmp_float<digits10>& a, const T& b) noexcept
{
   return a.compare(b) < 0;
}
template <unsigned digits10, class T>
inline typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<T>::value, bool>::type eval_gt(const gmp_float<digits10>& a, const T& b) noexcept
{
   return a.compare(b) > 0;
}
...
template <class T>
inline typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<T>::value, bool>::type eval_eq(const gmp_int& a, const T& b)
{
   return a.compare(b) == 0;
}
template <class T>
inline typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<T>::value, bool>::type eval_lt(const gmp_int& a, const T& b)
{
   return a.compare(b) < 0;
}
template <class T>
inline typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<T>::value, bool>::type eval_gt(const gmp_int& a, const T& b)
{
   return a.compare(b) > 0;
}
...
template <class I>
inline typename std::enable_if<(nil::crypto3::multiprecision::detail::is_unsigned<I>::value && (sizeof(I) <= sizeof(unsigned long)))>::type eval_gcd(gmp_int& result, const gmp_int& a, const I b)
{
   mpz_gcd_ui(result.data(), a.data(), b);
}
template <class I>
inline typename std::enable_if<(nil::crypto3::multiprecision::detail::is_unsigned<I>::value && (sizeof(I) <= sizeof(unsigned long)))>::type eval_lcm(gmp_int& result, const gmp_int& a, const I b)
{
   mpz_lcm_ui(result.data(), a.data(), b);
}
template <class I>
inline typename std::enable_if<(nil::crypto3::multiprecision::detail::is_signed<I>::value && nil::crypto3::multiprecision::detail::is_integral<I>::value && (sizeof(I) <= sizeof(long)))>::type eval_gcd(gmp_int& result, const gmp_int& a, const I b)
{
   mpz_gcd_ui(result.data(), a.data(), nil::crypto3::multiprecision::detail::unsigned_abs(b));
}
template <class I>
inline typename std::enable_if<nil::crypto3::multiprecision::detail::is_signed<I>::value && nil::crypto3::multiprecision::detail::is_integral<I>::value && ((sizeof(I) <= sizeof(long)))>::type eval_lcm(gmp_int& result, const gmp_int& a, const I b)
{
...
inline typename std::enable_if<nil::crypto3::multiprecision::detail::is_unsigned<Integer>::value, Integer>::type eval_integer_modulus(const gmp_int& x, Integer val)
{
...
template <class Integer>
inline typename std::enable_if<nil::crypto3::multiprecision::detail::is_signed<Integer>::value && nil::crypto3::multiprecision::detail::is_integral<Integer>::value, Integer>::type eval_integer_modulus(const gmp_int& x, Integer val)
{
...
inline typename std::enable_if<
    nil::crypto3::multiprecision::detail::is_unsigned<Integer>::value && (sizeof(Integer) <= sizeof(unsigned long))>::type
eval_powm(gmp_int& result, const gmp_int& base, Integer p, const gmp_int& m)
{
   mpz_powm_ui(result.data(), base.data(), p, m.data());
}
template <class Integer>
inline typename std::enable_if<nil::crypto3::multiprecision::detail::is_signed<Integer>::value && nil::crypto3::multiprecision::detail::is_integral<Integer>::value && (sizeof(Integer) <= sizeof(unsigned long))>::type
eval_powm(gmp_int& result, const gmp_int& base, Integer p, const gmp_int& m)
{
   if (p < 0)
   {
...
#endif
{
   return nil::crypto3::multiprecision::detail::digits10_2_2(nil::crypto3::multiprecision::mpf_float::default_precision());
}
template <>
inline int digits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, nil::crypto3::multiprecision::et_off> >()
#ifdef BOOST_MATH_NOEXCEPT
    noexcept
#endif
{
...
template <>
inline nil::crypto3::multiprecision::mpf_float
max_value<nil::crypto3::multiprecision::mpf_float>()
{
...
template <>
inline nil::crypto3::multiprecision::mpf_float
min_value<nil::crypto3::multiprecision::mpf_float>()
{
   nil::crypto3::multiprecision::mpf_float result(0.5);
...
template <>
inline nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, nil::crypto3::multiprecision::et_off>
max_value<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, nil::crypto3::multiprecision::et_off> >()
{
   nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, nil::crypto3::multiprecision::et_off> result(0.5);
   mpf_mul_2exp(result.backend().data(), result.backend().data(), (std::numeric_limits<mp_exp_t>::max)() / 64 + 1);
   return result;
}
...
template <>
inline nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, nil::crypto3::multiprecision::et_off>
min_value<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, nil::crypto3::multiprecision::et_off> >()
{
   nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, nil::crypto3::multiprecision::et_off> result(0.5);
   mpf_div_2exp(result.backend().data(), result.backend().data(), (std::numeric_limits<mp_exp_t>::max)() / 64 + 1);
   return result;
...
template <>
inline int digits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<nil::crypto3::multiprecision::mpf_float::backend_type> > >()
#ifdef BOOST_MATH_NOEXCEPT
    noexcept
#endif
{
   return nil::crypto3::multiprecision::detail::digits10_2_2(nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<nil::crypto3::multiprecision::mpf_float::backend_type> >::default_precision());
}
template <>
inline int digits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<nil::crypto3::multiprecision::gmp_float<0> >, nil::crypto3::multiprecision::et_off> >()
#ifdef BOOST_MATH_NOEXCEPT
    noexcept
#endif
{
...
template <>
inline nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<nil::crypto3::multiprecision::mpf_float::backend_type> >
max_value<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<nil::crypto3::multiprecision::mpf_float::backend_type> > >()
{
...
template <>
inline nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<nil::crypto3::multiprecision::mpf_float::backend_type> >
min_value<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<nil::crypto3::multiprecision::mpf_float::backend_type> > >()
{
   return min_value<nil::crypto3::multiprecision::mpf_float>().backend();
}

template <>
inline nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<nil::crypto3::multiprecision::gmp_float<0> >, nil::crypto3::multiprecision::et_off>
max_value<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<nil::crypto3::multiprecision::gmp_float<0> >, nil::crypto3::multiprecision::et_off> >()
{
   return max_value<nil::crypto3::multiprecision::mpf_float>().backend();
}
...
template <>
inline nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<nil::crypto3::multiprecision::gmp_float<0> >, nil::crypto3::multiprecision::et_off>
min_value<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<nil::crypto3::multiprecision::gmp_float<0> >, nil::crypto3::multiprecision::et_off> >()
{
   return min_value<nil::crypto3::multiprecision::mpf_float>().backend();
}
...
class numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >
{
   using number_type = nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates>;
...
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::digits;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::digits10;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::max_digits10;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_signed;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_integer;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_exact;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::radix;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr long numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::min_exponent;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr long numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::min_exponent10;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr long numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::max_exponent;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr long numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::max_exponent10;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_infinity;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_quiet_NaN;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_signaling_NaN;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_denorm_style numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_denorm;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_denorm_loss;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_iec559;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_bounded;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_modulo;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::traps;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::tinyness_before;
template <unsigned Digits10, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_round_style numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::round_style;

template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >
{
   using number_type = nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates>;
...
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::digits;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::digits10;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::max_digits10;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_signed;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_integer;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_exact;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::radix;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::min_exponent;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::min_exponent10;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::max_exponent;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::max_exponent10;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_infinity;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_quiet_NaN;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_signaling_NaN;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_denorm_style numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_denorm;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_denorm_loss;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_iec559;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_bounded;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_modulo;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::traps;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::tinyness_before;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_round_style numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_float<0>, ExpressionTemplates> >::round_style;

template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >
{
   using number_type = nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates>;
...
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::digits;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::digits10;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::max_digits10;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::is_signed;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::is_integer;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::is_exact;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::radix;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::min_exponent;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::min_exponent10;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::max_exponent;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::max_exponent10;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::has_infinity;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::has_quiet_NaN;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::has_signaling_NaN;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_denorm_style numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::has_denorm;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::has_denorm_loss;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::is_iec559;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::is_bounded;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::is_modulo;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::traps;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::tinyness_before;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_round_style numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_int, ExpressionTemplates> >::round_style;

template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >
{
   using number_type = nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates>;
...
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::digits;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::digits10;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::max_digits10;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::is_signed;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::is_integer;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::is_exact;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::radix;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::min_exponent;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::min_exponent10;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::max_exponent;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::max_exponent10;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::has_infinity;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::has_quiet_NaN;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::has_signaling_NaN;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_denorm_style numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::has_denorm;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::has_denorm_loss;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::is_iec559;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::is_bounded;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::is_modulo;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::traps;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::tinyness_before;
template <nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_round_style numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::gmp_rational, ExpressionTemplates> >::round_style;
