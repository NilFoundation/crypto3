...
inline typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<T>::value, bool>::type eval_eq(const complex_adaptor<Backend>& a, const T& b) noexcept
{
...
inline typename std::enable_if<!nil::crypto3::multiprecision::detail::is_complex<Result>::value>::type eval_convert_to(Result* result, const complex_adaptor<Backend>& val)
{
...
template <class Backend>
struct number_category<complex_adaptor<Backend> > : public std::integral_constant<int, nil::crypto3::multiprecision::number_kind_complex>
{};
