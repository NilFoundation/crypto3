...
#pragma warning(disable : 4702)    // Unreachable code (reachability depends on template params)
                ...
                template<unsigned MinBits = 0, unsigned MaxBits = 0,
                         ...
                         class Allocator = typename boost::mpl::if_c<MinBits && (MinBits == MaxBits), void,
                                                                     std::allocator<limb_type>>::type>
            ...
            namespace backends {
                ...
                struct max_precision<cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>> {
                    static const unsigned value = boost::is_void<Allocator>::value ?
                                                      boost::static_unsigned_max<MinBits, MaxBits>::value :
                ...
                struct min_precision<cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>> {
                    static const unsigned value =
                        (boost::is_void<Allocator>::value ? boost::static_unsigned_max<MinBits, MaxBits>::value :
                                                            MinBits);
                };
                //
                ...
                struct is_trivial_cpp_int<cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>> {
                    ...
                    static const bool value = boost::is_void<Allocator>::value &&
                                              (max_precision<self>::value <= (sizeof(double_limb_type) * CHAR_BIT) -
                                                                                 (SignType == signed_packed ? 1 : 0));
                };
            ...
            struct is_unsigned_number<backends::cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>>
                : public boost::mpl::bool_<(SignType == unsigned_magnitude) || (SignType == unsigned_packed)> { };
            ...
            namespace backends {
                ...
                template<unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType, cpp_int_check_type Checked,
                         class Allocator, unsigned MinBits2, unsigned MaxBits2, cpp_integer_type SignType2,
                ...
                struct is_implicit_cpp_int_conversion<
                    ...
                    static const bool value = (is_signed_number<t2>::value || !is_signed_number<t1>::value) &&
                ...
                //
                template<class T>
                struct is_non_throwing_cpp_int : public boost::mpl::false_ { };
                ...
                namespace detail {
                    ...
                    inline BOOST_MP_CXX14_CONSTEXPR void verify_new_size(unsigned /*new_size*/, unsigned /*min_size*/,
                                                                         const boost::mpl::int_<unchecked>&) {
                    }

                    template<class U>
                    inline BOOST_MP_CXX14_CONSTEXPR void verify_limb_mask(bool b, U limb, U mask,
                                                                          const boost::mpl::int_<checked>&) {
...
#endif
                    typedef boost::mpl::int_<Checked> checked_type;

                    //
                    // Interface invariants:
                    //
                    BOOST_STATIC_ASSERT(!boost::is_void<Allocator>::value);
                ...
                public:
                    ...
                    BOOST_STATIC_CONSTANT(unsigned, internal_limb_count = MinBits ?
                                                                              (MinBits / limb_bits +
                ...
                private:
                    union data_type {
                        ...
                        BOOST_CONSTEXPR data_type(signed_limb_type i) BOOST_NOEXCEPT
                            : first(i < 0 ?
                        ...
                        BOOST_CONSTEXPR data_type(signed_double_limb_type i) BOOST_NOEXCEPT
                ...
                public:
                    ...
                    // Direct construction:
                    //
                    BOOST_MP_FORCEINLINE BOOST_CONSTEXPR cpp_int_base(limb_type i) BOOST_NOEXCEPT : m_data(i),
                                                                                                    m_limbs(1),
                                                                                                    m_sign(false),
                                                                                                    m_internal(true),
                                                                                                    m_alias(false) {
                    ...
                    explicit BOOST_CONSTEXPR cpp_int_base(const limb_type* data, unsigned offset,
                                                          unsigned len) BOOST_NOEXCEPT
                    ...
                    void resize(unsigned new_size, unsigned min_size) {
                        static const unsigned max_limbs = MaxBits / (CHAR_BIT * sizeof(limb_type)) +
                    ...
                    BOOST_MP_FORCEINLINE BOOST_CONSTEXPR cpp_int_base() BOOST_NOEXCEPT : m_data(),
                                                                                         m_limbs(1),
                                                                                         m_sign(false),
                                                                                         m_internal(true),
                                                                                         m_alias(false) {
                ...
                struct cpp_int_base<MinBits, MaxBits, unsigned_magnitude, Checked, Allocator, false>
                    ...
                    //
                    BOOST_STATIC_ASSERT_MSG(((sizeof(Allocator) == 0) && !boost::is_void<Allocator>::value),
                ...
                struct cpp_int_base<MinBits, MinBits, signed_magnitude, Checked, void, false> {
                    ...
                    BOOST_STATIC_ASSERT_MSG(MinBits > sizeof(double_limb_type) * CHAR_BIT,
                                            "Template parameter MinBits is inconsistent with the parameter trivial - "
                                            "did you mistakingly try to override the trivial parameter?");
                ...
                public:
                    ...
                    BOOST_STATIC_CONSTANT(limb_type, upper_limb_mask = (MinBits % limb_bits) ?
                                                                           (limb_type(1) << (MinBits % limb_bits)) - 1 :
                                                                           (~limb_type(0)));
                    BOOST_STATIC_ASSERT_MSG(internal_limb_count >= 2,
                ...
                public:
                    ...
                    // Direct construction:
                    //
                    BOOST_MP_FORCEINLINE BOOST_CONSTEXPR cpp_int_base(limb_type i) BOOST_NOEXCEPT : m_wrapper(i),
                                                                                                    m_limbs(1),
                                                                                                    m_sign(false) {
                    }
                    BOOST_MP_FORCEINLINE BOOST_CONSTEXPR cpp_int_base(signed_limb_type i) BOOST_NOEXCEPT
                        : m_wrapper(limb_type(i < 0 ? static_cast<limb_type>(-static_cast<signed_double_limb_type>(i)) :
                                                      i)),
                          m_limbs(1),
                          m_sign(i < 0) {
                    }
                    ...
                    // Helper functions for getting at our internal data, and manipulating storage:
                    //
                    BOOST_MP_FORCEINLINE BOOST_CONSTEXPR unsigned size() const BOOST_NOEXCEPT {
                        return m_limbs;
                    }
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR limb_pointer limbs() BOOST_NOEXCEPT {
                    ...
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR void normalize()
                        BOOST_MP_NOEXCEPT_IF((Checked == unchecked)) {
                        limb_pointer p = limbs();
                    ...
                    BOOST_MP_FORCEINLINE BOOST_CONSTEXPR cpp_int_base() BOOST_NOEXCEPT : m_wrapper(limb_type(0u)),
                                                                                         m_limbs(1),
                                                                                         m_sign(false) {
                    }
                ...
                public:
                    ...
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR cpp_int_base(signed_limb_type i)
                        BOOST_MP_NOEXCEPT_IF((Checked == unchecked)) :
                        m_wrapper(
                    ...
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR cpp_int_base(signed_double_limb_type i)
                        BOOST_MP_NOEXCEPT_IF((Checked == unchecked)) :
                    ...
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR void sign(bool b)
                        BOOST_MP_NOEXCEPT_IF((Checked == unchecked)) {
                        if (b)
                            negate();
                    }
                ...
                private:
                    void check_negate(const boost::mpl::int_<checked>&) {
                        BOOST_THROW_EXCEPTION(std::range_error("Attempt to negate an unsigned number."));
                    }
                    BOOST_MP_CXX14_CONSTEXPR void check_negate(const boost::mpl::int_<unchecked>&) {
                    }
                ...
                protected:
                    ...
                    BOOST_STATIC_CONSTANT(local_limb_type,
                                          limb_mask = (MinBits < limb_bits) ?
                                                          local_limb_type((local_limb_type(~local_limb_type(0))) >>
                                                                          (limb_bits - MinBits)) :
                ...
                protected:
                    ...
                    BOOST_MP_CXX14_CONSTEXPR
                        typename boost::disable_if_c<!boost::is_integral<T>::value ||
                                                     (std::numeric_limits<T>::is_specialized &&
                                                      (std::numeric_limits<T>::digits <= (int)MinBits))>::type
                        check_in_range(T val, const boost::mpl::int_<checked>&) {
                        typedef
                            typename boost::common_type<typename boost::make_unsigned<T>::type, local_limb_type>::type
                                common_type;
                    ...
                    BOOST_MP_CXX14_CONSTEXPR
                        ...
                        check_in_range(T val, const boost::mpl::int_<checked>&) {
                        using std::abs;
                        typedef typename boost::common_type<T, local_limb_type>::type common_type;
                    ...
                    BOOST_MP_CXX14_CONSTEXPR void check_in_range(T, const boost::mpl::int_<C>&) BOOST_NOEXCEPT {
                    }

                    template<class T>
                    BOOST_MP_CXX14_CONSTEXPR void check_in_range(T val)
                        BOOST_MP_NOEXCEPT_IF(noexcept(std::declval<cpp_int_base>().check_in_range(std::declval<T>(),
                                                                                                  checked_type()))) {
                ...
                public:
                    ...
                    BOOST_MP_FORCEINLINE BOOST_CONSTEXPR
                        cpp_int_base(SI i,
                            ...
                            BOOST_MP_NOEXCEPT_IF(
                                noexcept(std::declval<cpp_int_base>().check_in_range(std::declval<SI>()))) :
                        m_data(i < 0 ? static_cast<local_limb_type>(
                                           static_cast<typename boost::make_unsigned<SI>::type>(
                                               nil::crypto3::multiprecision::detail::unsigned_abs(i)) &
                                           limb_mask) :
                    ...
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR cpp_int_base(
                        SI i,
                        typename boost::enable_if_c<boost::is_signed<SI>::value && (Checked == checked)>::type const* =
                            0)
                        BOOST_MP_NOEXCEPT_IF(
                            noexcept(std::declval<cpp_int_base>().check_in_range(std::declval<SI>()))) :
                        m_data(i < 0 ? (static_cast<local_limb_type>(
                    ...
                    template<class UI>
                    BOOST_MP_FORCEINLINE BOOST_CONSTEXPR cpp_int_base(
                        UI i,
                        typename boost::enable_if_c<boost::is_unsigned<UI>::value &&
                                                    (Checked == unchecked)>::type const* = 0) BOOST_NOEXCEPT
                    ...
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                        cpp_int_base(UI i,
                            ...
                            BOOST_MP_NOEXCEPT_IF(
                                noexcept(std::declval<cpp_int_base>().check_in_range(std::declval<UI>()))) :
                        m_data(static_cast<local_limb_type>(i) & limb_mask),
                        m_sign(false) {
                        check_in_range(i);
                    }
                    template<class F>
                    BOOST_MP_FORCEINLINE BOOST_CONSTEXPR cpp_int_base(
                        F i, typename boost::enable_if_c<boost::is_floating_point<F>::value &&
                                                         (Checked == unchecked)>::type const* = 0) BOOST_NOEXCEPT
                    ...
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                        cpp_int_base(F i,
                                     typename boost::enable_if_c<boost::is_floating_point<F>::value &&
                                                                 (Checked == checked)>::type const* = 0) :
                        m_data(static_cast<local_limb_type>(std::fabs(i)) & limb_mask),
                        m_sign(i < 0) {
                        check_in_range(i);
                    ...
                    BOOST_CONSTEXPR cpp_int_base(const cpp_int_base& a,
                    ...
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR bool sign() const BOOST_NOEXCEPT {
                        return m_sign;
                    }
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR void sign(bool b) BOOST_NOEXCEPT {
                        m_sign = b;
                ...
                protected:
                    ...
                    BOOST_MP_CXX14_CONSTEXPR
                        typename boost::disable_if_c<std::numeric_limits<T>::is_specialized &&
                                                     (std::numeric_limits<T>::digits <= (int)MinBits)>::type
                        check_in_range(T val, const boost::mpl::int_<checked>&, const boost::false_type&) {
                        typedef typename boost::common_type<T, local_limb_type>::type common_type;
                    ...
                    template<class T>
                    BOOST_MP_CXX14_CONSTEXPR void check_in_range(T val, const boost::mpl::int_<checked>&,
                    ...
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR void
                        check_in_range(T, const boost::mpl::int_<C>&,
                                       const boost::integral_constant<bool, B>&) BOOST_NOEXCEPT {
                    }

                    template<class T>
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR void check_in_range(T val) BOOST_MP_NOEXCEPT_IF(
                        noexcept(std::declval<cpp_int_base>().check_in_range(std::declval<T>(),
                                                                             checked_type(),
                                                                             boost::is_signed<T>()))) {
                        check_in_range(val, checked_type(), boost::is_signed<T>());
                    }
                ...
                public:
                    ...
                    template<class SI>
                    BOOST_MP_FORCEINLINE BOOST_CONSTEXPR cpp_int_base(
                        SI i, typename boost::enable_if_c<boost::is_signed<SI>::value &&
                                                          (Checked == unchecked)>::type const* = 0) BOOST_NOEXCEPT
                    ...
                    template<class F>
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                        cpp_int_base(F i, typename boost::enable_if<boost::is_floating_point<F>>::type const* = 0)
                            BOOST_MP_NOEXCEPT_IF((Checked == unchecked)) :
                        m_data(static_cast<local_limb_type>(std::fabs(i)) & limb_mask) {
                        check_in_range(i);
                        if (i < 0)
                ...
                struct is_allowed_cpp_int_base_conversion
                    : public boost::mpl::if_c<
                          boost::is_same<Arg, limb_type>::value || boost::is_same<Arg, signed_limb_type>::value
#if BOOST_ENDIAN_LITTLE_BYTE && !defined(BOOST_MP_TEST_NO_LE)
                              || boost::is_same<Arg, double_limb_type>::value ||
                              boost::is_same<Arg, signed_double_limb_type>::value
#endif
#if defined(BOOST_MP_USER_DEFINED_LITERALS)
                              || literals::detail::is_value_pack<Arg>::value
#endif
                              || (is_trivial_cpp_int<Base>::value && boost::is_arithmetic<Arg>::value),
                          boost::mpl::true_, boost::mpl::false_>::type {
                };
                //
                ...
                struct cpp_int_backend
                    ...
                    typedef cpp_int_base<min_precision<self_type>::value, max_precision<self_type>::value, SignType,
                                         Checked, Allocator, is_trivial_cpp_int<self_type>::value>
                        base_type;
                    typedef boost::mpl::bool_<is_trivial_cpp_int<self_type>::value> trivial_tag;

                public:
                    typedef typename boost::mpl::if_<
                        trivial_tag,
                        boost::mpl::list<signed char, short, int, long, boost::long_long_type, signed_double_limb_type>,
                        boost::mpl::list<signed_limb_type, signed_double_limb_type>>::type signed_types;
                    typedef typename boost::mpl::if_<
                        trivial_tag,
                        boost::mpl::list<unsigned char, unsigned short, unsigned, unsigned long, boost::ulong_long_type,
                                         double_limb_type>,
                        boost::mpl::list<limb_type, double_limb_type>>::type unsigned_types;
                    typedef typename boost::mpl::if_<trivial_tag, boost::mpl::list<float, double, long double>,
                                                     boost::mpl::list<long double>>::type float_types;
                    typedef boost::mpl::int_<Checked> checked_type;

                    BOOST_MP_FORCEINLINE BOOST_CONSTEXPR cpp_int_backend() BOOST_NOEXCEPT {
                    }
                    BOOST_MP_FORCEINLINE BOOST_CONSTEXPR cpp_int_backend(const cpp_int_backend& o)
                    ...
                    //
                    template<class Arg>
                    BOOST_MP_FORCEINLINE BOOST_CONSTEXPR cpp_int_backend(
                        Arg i, typename boost::enable_if_c<
                                   is_allowed_cpp_int_base_conversion<Arg, base_type>::value>::type const* = 0)
                    ...
                    //
                    explicit BOOST_CONSTEXPR cpp_int_backend(limb_type* data, unsigned offset,
                                                             unsigned len) BOOST_NOEXCEPT
                    ...
                    explicit BOOST_CONSTEXPR cpp_int_backend(typename base_type::scoped_shared_storage& data,
                                                             unsigned len) BOOST_NOEXCEPT : base_type(data, len) {
                    }
                ...
                private:
                    ...
                    BOOST_MP_CXX14_CONSTEXPR void
                        ...
                        // std::memcpy(this->limbs(), other.limbs(), (std::min)(other.size(), this->size()) *
                        // sizeof(this->limbs()[0]));
                ...
                public:
                    ...
                    BOOST_MP_CXX14_CONSTEXPR cpp_int_backend(
                        ...
                        base_type() {
                        do_assign(other,
                                  boost::mpl::bool_<is_trivial_cpp_int<self_type>::value>(),
                                  boost::mpl::bool_<is_trivial_cpp_int<
                    ...
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR cpp_int_backend& operator=(const cpp_int_backend& o)
                        BOOST_MP_NOEXCEPT_IF(
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR cpp_int_backend& operator=(cpp_int_backend&& o)
                        BOOST_MP_NOEXCEPT_IF(noexcept(std::declval<base_type&>() = std::declval<base_type>())) {
                        *static_cast<base_type*>(this) = static_cast<base_type&&>(o);
                        return *this;
                    }
#endif
                private:
                    template<class A>
                    BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if<boost::is_unsigned<A>>::type
                        do_assign_arithmetic(A val, const boost::mpl::true_&) BOOST_MP_NOEXCEPT_IF(
                    ...
                    template<class A>
                    BOOST_MP_CXX14_CONSTEXPR typename boost::disable_if_c<boost::is_unsigned<A>::value ||
                                                                          !boost::is_integral<A>::value>::type
                        do_assign_arithmetic(A val, const boost::mpl::true_&)
                            BOOST_MP_NOEXCEPT_IF(noexcept(std::declval<cpp_int_backend>().check_in_range(
                                std::declval<A>())) && noexcept(std::declval<cpp_int_backend>().sign(true))) {
                        this->check_in_range(val);
                    ...
                    template<class A>
                    BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if_c<!boost::is_integral<A>::value>::type
                        do_assign_arithmetic(A val, const boost::mpl::true_&) {
                        this->check_in_range(val);
                        *this->limbs() = (val < 0) ? static_cast<typename self_type::local_limb_type>(
                    ...
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR void
                        do_assign_arithmetic(limb_type i, const boost::mpl::false_&) BOOST_NOEXCEPT {
                        this->resize(1, 1);
                        *this->limbs() = i;
                        this->sign(false);
                    }
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR void do_assign_arithmetic(signed_limb_type i,
                        ...
                        BOOST_MP_NOEXCEPT_IF(noexcept(std::declval<cpp_int_backend>().sign(true))) {
                        this->resize(1, 1);
                        *this->limbs() = static_cast<limb_type>(nil::crypto3::multiprecision::detail::unsigned_abs(i));
                        this->sign(i < 0);
                    }
                    BOOST_MP_CXX14_CONSTEXPR void do_assign_arithmetic(double_limb_type i,
                                                                       const boost::mpl::false_&) BOOST_NOEXCEPT {
                    ...
                    BOOST_MP_CXX14_CONSTEXPR void do_assign_arithmetic(long double a, const boost::mpl::false_&) {
                        ...
                        if (a < 0) {
                            do_assign_arithmetic(-a, boost::mpl::false_());
                            this->sign(true);
                            return;
                        }
                ...
                public:
                    ...
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if_c<
                        ...
                        operator=(Arithmetic val)
                            BOOST_MP_NOEXCEPT_IF(noexcept(std::declval<cpp_int_backend>().do_assign_arithmetic(
                ...
                private:
                    void do_assign_string(const char* s, const boost::mpl::true_&) {
                        ...
                        *this = 0;
                        ...
                        if (n) {
                            ...
                            while (*s) {
                                ...
                                *this->limbs() = detail::checked_multiply(
                                    *this->limbs(), static_cast<typename base_type::local_limb_type>(radix),
                                    checked_type());
                                *this->limbs() = detail::checked_add(
                    ...
                    void do_assign_string(const char* s, const boost::mpl::false_&) {
                        using default_ops::eval_add;
                ...
                private:
                    std::string do_get_trivial_string(std::ios_base::fmtflags f, const boost::mpl::false_&) const {
                        typedef typename boost::mpl::if_c<sizeof(typename base_type::local_limb_type) == 1, unsigned,
                                                          typename base_type::local_limb_type>::type io_type;
                    ...
                    std::string do_get_trivial_string(std::ios_base::fmtflags f, const boost::mpl::true_&) const {
                    ...
                    std::string do_get_string(std::ios_base::fmtflags f, const boost::mpl::true_&) const {
#ifdef BOOST_MP_NO_DOUBLE_LIMB_TYPE_IO
                        return do_get_trivial_string(
                            f, boost::mpl::bool_<
                                   boost::is_same<typename base_type::local_limb_type, double_limb_type>::value>());
#else
                        return do_get_trivial_string(f, boost::mpl::bool_<false>());
#endif
                    }
                    std::string do_get_string(std::ios_base::fmtflags f, const boost::mpl::false_&) const {
                ...
                private:
                    ...
                    void construct_from_container(const Container& c, const boost::mpl::false_&) {
                        //
                ...
                public:
                    ...
                    BOOST_MP_CXX14_CONSTEXPR int
                        compare_imp(const cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>& o,
                                    const boost::mpl::false_&, const boost::mpl::false_&) const BOOST_NOEXCEPT {
                        if (this->sign() != o.sign())
                    ...
                    BOOST_MP_CXX14_CONSTEXPR int
                        compare_imp(const cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>& o,
                                    const boost::mpl::false_&, const boost::mpl::true_&) const {
                    ...
                    BOOST_MP_CXX14_CONSTEXPR int
                        compare_imp(const cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>& o,
                                    const boost::mpl::true_&, const boost::mpl::true_&) const BOOST_NOEXCEPT {
                        if (this->sign()) {
                            if (o.sign()) {
                    ...
                    template<unsigned MinBits2, unsigned MaxBits2, cpp_integer_type SignType2,
                             cpp_int_check_type Checked2, class Allocator2>
                    BOOST_MP_CXX14_CONSTEXPR int
                        compare(const cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>& o) const
                        BOOST_NOEXCEPT {
                        typedef boost::mpl::bool_<
                            is_trivial_cpp_int<cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>>::value>
                            t1;
                        typedef boost::mpl::bool_<is_trivial_cpp_int<
                            cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>>::value>
                            t2;
                    ...
                    template<unsigned MinBits2, unsigned MaxBits2, cpp_integer_type SignType2,
                             cpp_int_check_type Checked2, class Allocator2>
                    BOOST_MP_CXX14_CONSTEXPR int
                        compare_unsigned(const cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>& o)
                    ...
                    template<class Arithmetic>
                    BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                        typename boost::enable_if<boost::is_arithmetic<Arithmetic>, int>::type
            ...
            namespace default_ops {
                ...
                struct double_precision_type<
                    ...
                    typedef typename boost::mpl::if_c<
                        ...
                        backends::cpp_int_backend<(boost::is_void<Allocator>::value ?
                                                       2 * backends::max_precision<backends::cpp_int_backend<
            ...
            namespace detail {
                ...
                template<unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType, cpp_int_check_type Checked,
                         class Allocator, unsigned MinBits2, unsigned MaxBits2, cpp_integer_type SignType2,
                         cpp_int_check_type Checked2, class Allocator2>
                struct is_explicitly_convertible<cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>,
                                                 cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>>
                    : public boost::mpl::true_ { };
