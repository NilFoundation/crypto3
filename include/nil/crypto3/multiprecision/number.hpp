...
#pragma warning(disable : 4127 4714 6326)
            ...
            public:
                ...
                BOOST_MP_FORCEINLINE BOOST_CONSTEXPR number(const number& e)
                    BOOST_MP_NOEXCEPT_IF(noexcept(Backend(std::declval<Backend const&>()))) :
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number(
                    ...
                    typename boost::enable_if_c<
                        (boost::is_arithmetic<V>::value || boost::is_same<std::string, V>::value ||
                         boost::is_convertible<V, const char*>::value) &&
                        !boost::is_convertible<typename detail::canonical<V, Backend>::type, Backend>::value &&
                ...
                BOOST_MP_FORCEINLINE BOOST_CONSTEXPR
                    number(const V& v,
                        ...
                        BOOST_MP_NOEXCEPT_IF(
                            noexcept(Backend(std::declval<typename detail::canonical<V, Backend>::type const&>())))
#endif
                    :
                    m_backend(canonical_value(v)) {
                }
                template<class V>
                BOOST_MP_FORCEINLINE BOOST_CONSTEXPR
                    number(const V& v, unsigned digits10,
                           typename boost::enable_if_c<
                               (boost::is_arithmetic<V>::value || boost::is_same<std::string, V>::value ||
                                boost::is_convertible<V, const char*>::value) &&
                               !detail::is_restricted_conversion<typename detail::canonical<V, Backend>::type,
                ...
                explicit BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number(
                    const V& v, typename boost::enable_if_c<
                                    (boost::is_arithmetic<V>::value || boost::is_same<std::string, V>::value ||
                                     boost::is_convertible<V, const char*>::value) &&
                ...
                template<class V>
                explicit BOOST_MP_FORCEINLINE BOOST_CONSTEXPR number(
                    const V& v,
                    typename boost::enable_if_c<
                        detail::is_explicitly_convertible<typename detail::canonical<V, Backend>::type,
                                                          Backend>::value &&
                        (detail::is_restricted_conversion<typename detail::canonical<V, Backend>::type,
                                                          Backend>::value ||
                         !boost::is_convertible<typename detail::canonical<V, Backend>::type, Backend>::value)>::type* =
                        0)
                    BOOST_MP_NOEXCEPT_IF(
                        noexcept(Backend(std::declval<typename detail::canonical<V, Backend>::type const&>()))) :
                    m_backend(canonical_value(v)) {
                ...
                template<class V>
                explicit BOOST_MP_FORCEINLINE BOOST_CONSTEXPR
                    number(const V& v, unsigned digits10,
                           typename boost::enable_if_c<
                               (boost::is_arithmetic<V>::value || boost::is_same<std::string, V>::value ||
                                boost::is_convertible<V, const char*>::value) &&
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number(
                    ...
                    typename boost::enable_if_c<(boost::is_convertible<Other, Backend>::value &&
                                                 !detail::is_restricted_conversion<Other, Backend>::value)>::type* = 0)
                ...
                explicit BOOST_MP_CXX14_CONSTEXPR number(
                    const number<Other, ET>& val,
                    typename boost::enable_if_c<(!detail::is_explicitly_convertible<Other, Backend>::value)>::type* =
                        0) {
                    //
                ...
                explicit BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                    number(const number<Other, ET>& val,
                           typename boost::enable_if_c<(detail::is_explicitly_convertible<Other, Backend>::value &&
                                                        (detail::is_restricted_conversion<Other, Backend>::value ||
                                                         !boost::is_convertible<Other, Backend>::value))>::type* = 0)
                        BOOST_MP_NOEXCEPT_IF(noexcept(Backend(std::declval<Other const&>()))) :
                    m_backend(val.backend()) {
                }
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number(
                    ...
                    typename boost::enable_if_c<
                        (boost::is_convertible<V, value_type>::value && boost::is_convertible<U, value_type>::value &&
                         !boost::is_same<typename component_type<self_type>::type, self_type>::value)>::type* = 0) {
                ...
                BOOST_MP_FORCEINLINE explicit BOOST_MP_CXX14_CONSTEXPR number(
                    const V& v1, const U& v2,
                    typename boost::enable_if_c<
                        (boost::is_constructible<value_type, V>::value ||
                         boost::is_convertible<V, std::string>::value) &&
                        (boost::is_constructible<value_type, U>::value ||
                         boost::is_convertible<U, std::string>::value) &&
                        !boost::is_same<typename component_type<self_type>::type, self_type>::value &&
                        !boost::is_same<V, self_type>::value &&
                        !(boost::is_convertible<V, value_type>::value &&
                          boost::is_convertible<U, value_type>::value)>::type* =
                        0)    //(boost::is_constructible<value_type, V>::value || boost::is_convertible<V,
                              // std::string>::value)
                              //&& (boost::is_constructible<value_type, U>::value || boost::is_convertible<U,
                              // std::string>::value) && !boost::is_same<typename component_type<self_type>::type,
                              // self_type>::value && !boost::is_same<V, self_type>::value && !(boost::is_convertible<V,
                              // value_type>::value && boost::is_convertible<U, value_type>::value)>::type* = 0)
                {
                    using default_ops::assign_components;
                    detail::scoped_default_precision<number<Backend, ExpressionTemplates>> precision_guard(v1, v2);
                    assign_components(m_backend, canonical_value(detail::evaluate_if_expression(v1)),
                ...
                template<class V, class U>
                BOOST_MP_FORCEINLINE explicit BOOST_MP_CXX14_CONSTEXPR
                    number(const V& v1, const U& v2, unsigned digits10,
                           typename boost::enable_if_c<
                               ((boost::is_constructible<value_type, V>::value ||
                                ...
                                !boost::is_same<typename component_type<self_type>::type, self_type>::value) &&
                               !(boost::is_convertible<V, value_type>::value &&
                                 boost::is_convertible<U, value_type>::value)>::type* = 0) :
                    m_backend(canonical_value(detail::evaluate_if_expression(v1)),
                              canonical_value(detail::evaluate_if_expression(v2)), digits10) {
                }
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                    number(const number<Other, ET>& v1, const number<Other, ET>& v2,
                           typename boost::enable_if_c<boost::is_convertible<Other, Backend>::value>::type* = 0) {
                    using default_ops::assign_components;
                    detail::scoped_default_precision<number<Backend, ExpressionTemplates>> precision_guard(v1, v2);
                ...
                BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if_c<
                    boost::is_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type,
                                          self_type>::value,
                    number&>::type
                    operator=(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4>& e) {
                    typedef boost::mpl::bool_<boost::is_same<
                        number, typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type>::value>
                        tag_type;
                ...
                template<class V>
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                    typename boost::enable_if_c<boost::is_convertible<V, self_type>::value,
                                                number<Backend, ExpressionTemplates>&>::type
                    operator=(const V& v) BOOST_MP_NOEXCEPT_IF(
                        noexcept(std::declval<Backend&>() =
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number<Backend, ExpressionTemplates>&
                    assign(const V& v, unsigned digits10) BOOST_MP_NOEXCEPT_IF(
                        noexcept(std::declval<Backend&>() =
                                     std::declval<const typename detail::canonical<V, Backend>::type&>())) {
                    number t(v, digits10);
                    return *this = t;
                ...
                template<class Other, expression_template_option ET>
                BOOST_MP_CXX14_CONSTEXPR typename boost::disable_if<
                    nil::crypto3::multiprecision::detail::is_explicitly_convertible<Other, Backend>,
                    number<Backend, ExpressionTemplates>&>::type
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number& operator=(number&& r)
                    BOOST_MP_NOEXCEPT_IF(noexcept(std::declval<Backend&>() = std::declval<Backend>())) {
                    m_backend = static_cast<Backend&&>(r.m_backend);
                    return *this;
                }
#endif
                ...
                template<class V>
                BOOST_MP_CXX14_CONSTEXPR typename boost::enable_if_c<boost::is_convertible<V, self_type>::value,
                                                                     number<Backend, ExpressionTemplates>&>::type
                    operator-=(const V& v) {
                ...
                BOOST_MP_CXX14_CONSTEXPR number& operator%=(const self_type& e) {
                    BOOST_STATIC_ASSERT_MSG(number_category<Backend>::value == number_kind_integer ||
                ...
                template<class V>
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                    typename boost::enable_if_c<boost::is_integral<V>::value, number&>::type
                    operator<<=(V val) {
                    BOOST_STATIC_ASSERT_MSG(number_category<Backend>::value == number_kind_integer ||
                                                number_category<Backend>::value == number_kind_modular,
                                            "The left-shift operation is only valid for integer and modular types");
                    detail::check_shift_range(val, boost::mpl::bool_<(sizeof(V) > sizeof(std::size_t))>(),
                                              boost::mpl::bool_<boost::is_signed<V>::value>());
                ...
                // swap:
                //
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR void swap(self_type& other)
                    BOOST_MP_NOEXCEPT_IF(noexcept(std::declval<Backend>().swap(std::declval<Backend&>()))) {
    ...
    (defined(BOOST_INTEL) && (BOOST_INTEL <= 1500))
                ...
                // an arithmetic type:
                //
                template<class T, typename boost::enable_if_c<boost::is_same<T, bool>::value, int>::type = 0>
                explicit operator T() const {
                    using default_ops::eval_is_zero;
                    return !eval_is_zero(backend());
                }
                template<class T, typename boost::disable_if_c<
                                      boost::is_same<T, bool>::value || boost::is_void<T>::value, int>::type = 0>
                explicit operator T() const {
                ...
                template<class T, class = typename boost::disable_if_c<
                                      boost::is_constructible<T, self_type const&>::value ||
                                          ...
                                          (!boost::is_arithmetic<T>::value && !boost::is_complex<T>::value),
                                      T>::type>
#endif
                ...
                template<class V>
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                    typename boost::enable_if_c<boost::is_arithmetic<V>::value &&
      ...
      BOOST_WORKAROUND(BOOST_GCC, < 50000))
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR Backend const&& backend() const&& BOOST_NOEXCEPT {
                ...
                typename scalar_result_from_possible_complex<number<Backend, ExpressionTemplates>>::type real() const {
                    ...
                    typename scalar_result_from_possible_complex<
                        nil::crypto3::multiprecision::number<Backend, ExpressionTemplates>>::type result;
                    eval_real(result.backend(), backend());
                    return result;
                }
                BOOST_MP_CXX14_CONSTEXPR
                typename scalar_result_from_possible_complex<number<Backend, ExpressionTemplates>>::type imag() const {
                ...
                inline BOOST_MP_CXX14_CONSTEXPR
                    typename boost::enable_if_c<boost::is_convertible<T, self_type>::value, self_type&>::type
                    real(const T& val) {
                ...
                template<class T>
                inline BOOST_MP_CXX14_CONSTEXPR
                    typename boost::enable_if_c<boost::is_convertible<T, self_type>::value &&
            ...
            private:
                ...
                BOOST_MP_CXX14_CONSTEXPR void do_assign(const Exp& e, const detail::bitwise_and&) {
                    ...
                    //
                    BOOST_STATIC_ASSERT_MSG(number_category<Backend>::value == number_kind_integer,
                                            "Bitwise operations are only valid for integer types");
                ...
                BOOST_MP_CXX14_CONSTEXPR void do_assign(const Exp& e, const detail::shift_left&) {
                    ...
                    BOOST_STATIC_ASSERT_MSG(right_arity::value == 0,
                    ...
                    BOOST_STATIC_ASSERT_MSG(boost::is_integral<right_value_type>::value,
                                            "The left shift operator requires an integer value for the shift operand.");
                ...
                BOOST_MP_CXX14_CONSTEXPR void do_assign_right_shift(const Exp& e, const Val& val,
                    ...
                    detail::check_shift_range(val, boost::mpl::bool_<(sizeof(Val) > sizeof(std::size_t))>(),
                                              boost::mpl::bool_<boost::is_signed<Val>::value>());
                ...
                template<class Exp>
                BOOST_MP_CXX14_CONSTEXPR void do_assign_function(const Exp& e, const boost::mpl::int_<1>&) {
                    e.left().value()(&m_backend);
                }
                template<class Exp>
                BOOST_MP_CXX14_CONSTEXPR void do_assign_function(const Exp& e, const boost::mpl::int_<2>&) {
                    typedef typename Exp::right_type right_type;
                ...
                template<class Exp>
                BOOST_MP_CXX14_CONSTEXPR void do_assign_function(const Exp& e, const boost::mpl::int_<3>&) {
                ...
                template<class Exp>
                BOOST_MP_CXX14_CONSTEXPR void do_assign_function(const Exp& e, const boost::mpl::int_<4>&) {
                ...
                template<class Exp>
                BOOST_MP_CXX14_CONSTEXPR
                    typename boost::disable_if_c<nil::crypto3::multiprecision::number_category<self_type>::value ==
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR bool
                    contains_self(const Exp& e, boost::mpl::int_<0> const&) const BOOST_NOEXCEPT {
                    return is_realy_self(e.value());
                }
                template<class Exp>
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR bool
                    contains_self(const Exp& e, boost::mpl::int_<1> const&) const BOOST_NOEXCEPT {
                    typedef typename Exp::left_type child_type;
                    return contains_self(e.left(), typename child_type::arity());
                }
                template<class Exp>
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR bool
                    contains_self(const Exp& e, boost::mpl::int_<2> const&) const BOOST_NOEXCEPT {
                ...
                template<class Exp>
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR bool
                    contains_self(const Exp& e, boost::mpl::int_<3> const&) const BOOST_NOEXCEPT {
                    typedef typename Exp::left_type child0_type;
                ...
                template<class Exp>
                BOOST_MP_FORCEINLINE BOOST_CONSTEXPR bool is_self(const Exp& e,
                                                                  boost::mpl::int_<0> const&) const BOOST_NOEXCEPT {
                    return is_realy_self(e.value());
                }
                template<class Exp, int v>
                BOOST_MP_FORCEINLINE BOOST_CONSTEXPR bool is_self(const Exp&,
                                                                  boost::mpl::int_<v> const&) const BOOST_NOEXCEPT {
                    return false;
                }

                template<class Val>
                BOOST_MP_FORCEINLINE BOOST_CONSTEXPR bool is_realy_self(const Val&) const BOOST_NOEXCEPT {
                    return false;
                }
                BOOST_MP_FORCEINLINE BOOST_CONSTEXPR bool is_realy_self(const self_type& v) const BOOST_NOEXCEPT {
                    return &v == this;
                }

                static BOOST_MP_FORCEINLINE BOOST_CONSTEXPR const Backend&
                    function_arg_value(const self_type& v) BOOST_NOEXCEPT {
                    return v.backend();
                }
                template<class Other, expression_template_option ET2>
                static BOOST_MP_FORCEINLINE BOOST_CONSTEXPR const Other&
                    function_arg_value(const number<Other, ET2>& v) BOOST_NOEXCEPT {
                    return v.backend();
                }
                template<class V>
                static BOOST_MP_FORCEINLINE BOOST_CONSTEXPR const V& function_arg_value(const V& v) BOOST_NOEXCEPT {
                    return v;
                }
                template<class A1, class A2, class A3, class A4>
                static BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR const A1&
                    function_arg_value(const detail::expression<detail::terminal, A1, A2, A3, A4>& exp) BOOST_NOEXCEPT {
                    return exp.value();
                }
                template<class A2, class A3, class A4>
                static BOOST_MP_FORCEINLINE BOOST_CONSTEXPR const Backend& function_arg_value(
                    const detail::expression<detail::terminal, number<Backend>, A2, A3, A4>& exp) BOOST_NOEXCEPT {
            ...
            public:
                ...
                template<class B2, expression_template_option ET>
                static BOOST_MP_FORCEINLINE BOOST_CONSTEXPR const B2&
                    canonical_value(const number<B2, ET>& v) BOOST_NOEXCEPT {
                    return v.backend();
                }
                template<class V>
                static BOOST_MP_FORCEINLINE BOOST_CONSTEXPR
                    typename boost::disable_if<boost::is_same<typename detail::canonical<V, Backend>::type, V>,
                ...
                template<class V>
                static BOOST_MP_FORCEINLINE BOOST_CONSTEXPR
                    typename boost::enable_if_c<boost::is_same<typename detail::canonical<V, Backend>::type, V>::value,
                                                const V&>::type
                    canonical_value(const V& v) BOOST_NOEXCEPT {
                    return v;
                }
            ...
            template<class Backend, expression_template_option ExpressionTemplates>
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR void swap(number<Backend, ExpressionTemplates>& a,
                                                                    number<Backend, ExpressionTemplates>& b)
                BOOST_MP_NOEXCEPT_IF(noexcept(std::declval<number<Backend, ExpressionTemplates>&>() =
