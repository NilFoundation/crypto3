...
class number
{
 ...
 public:
   ...
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number(const V& v, typename std::enable_if<
                                                                        (nil::crypto3::multiprecision::detail::is_arithmetic<V>::value || std::is_same<std::string, V>::value || std::is_convertible<V, const char*>::value) && !std::is_convertible<typename detail::canonical<V, Backend>::type, Backend>::value && !detail::is_restricted_conversion<typename detail::canonical<V, Backend>::type, Backend>::value
   ...
   {}
   template <class V>
   BOOST_MP_FORCEINLINE constexpr number(const V& v, unsigned digits10, typename std::enable_if<(nil::crypto3::multiprecision::detail::is_arithmetic<V>::value || std::is_same<std::string, V>::value || std::is_convertible<V, const char*>::value) && !detail::is_restricted_conversion<typename detail::canonical<V, Backend>::type, Backend>::value && (nil::crypto3::multiprecision::number_category<Backend>::value != nil::crypto3::multiprecision::number_kind_complex) && (nil::crypto3::multiprecision::number_category<Backend>::value != nil::crypto3::multiprecision::number_kind_rational)
#ifdef BOOST_HAS_FLOAT128
                                                                                                && !std::is_same<V, __float128>::value
#endif
                                                                                                >::type* = 0)
   ...
   explicit BOOST_MP_FORCEINLINE constexpr number(const V& v, typename std::enable_if<
       ...
       : m_backend(canonical_value(v)) {}
   template <class V>
   explicit BOOST_MP_FORCEINLINE constexpr number(const V& v, unsigned digits10, typename std::enable_if<(nil::crypto3::multiprecision::detail::is_arithmetic<V>::value || std::is_same<std::string, V>::value || std::is_convertible<V, const char*>::value) && detail::is_restricted_conversion<typename detail::canonical<V, Backend>::type, Backend>::value && (nil::crypto3::multiprecision::number_category<Backend>::value != nil::crypto3::multiprecision::number_kind_complex) && (nil::crypto3::multiprecision::number_category<Backend>::value != nil::crypto3::multiprecision::number_kind_rational)>::type* = 0)
       : m_backend(canonical_value(v), digits10) {}
   ...
   BOOST_MP_FORCEINLINE explicit BOOST_MP_CXX14_CONSTEXPR number(const V& v1, const U& v2, unsigned digits10,
                                                                 typename std::enable_if<((std::is_constructible<value_type, V>::value || std::is_convertible<V, std::string>::value) && (std::is_constructible<value_type, U>::value || std::is_convertible<U, std::string>::value) && !std::is_same<typename component_type<self_type>::type, self_type>::value) && !(std::is_convertible<V, value_type>::value && std::is_convertible<U, value_type>::value)>::type* = 0)
       : m_backend(canonical_value(detail::evaluate_if_expression(v1)), canonical_value(detail::evaluate_if_expression(v2)), digits10) {}
   ...
   BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<std::is_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value, number&>::type operator=(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4>& e)
   {
      ...
      if (precision_guard.precision() != nil::crypto3::multiprecision::detail::current_precision_of(*this))
      {
         number t(e);
   ...
   template <class Other, expression_template_option ET>
   BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<!nil::crypto3::multiprecision::detail::is_explicitly_convertible<Other, Backend>::value, number<Backend, ExpressionTemplates>&>::type
   ...
   explicit BOOST_MP_CXX14_CONSTEXPR number(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4>& e,
                                            typename std::enable_if<!std::is_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value && nil::crypto3::multiprecision::detail::is_explicitly_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value>::type* = 0)
   {
      //
   ...
   BOOST_MP_CXX14_CONSTEXPR number& operator%=(const self_type& e)
   {
      static_assert(number_category<Backend>::value == number_kind_integer || number_category<Backend>::value == number_kind_modular, "The modulus operation is only valid for integer and modular types");
      detail::scoped_default_precision<number<Backend, ExpressionTemplates> > precision_guard(*this, e);
      //
      // If the current precision of *this differs from that of expression e, then we
      // create a temporary (which will have the correct precision thanks to precision_guard)
   ...
   template <class V>
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_integral<V>::value, number&>::type operator<<=(V val)
   {
      static_assert(number_category<Backend>::value == number_kind_integer || number_category<Backend>::value == number_kind_modular, "The left-shift operation is only valid for integer and modular types");
      detail::check_shift_range(val, std::integral_constant<bool, (sizeof(V) > sizeof(std::size_t))>(), std::integral_constant < bool, nil::crypto3::multiprecision::detail::is_signed<V>::value&& nil::crypto3::multiprecision::detail::is_integral<V>::value > ());
   ...
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_integral<V>::value, number&>::type operator>>=(V val)
   {
      static_assert(number_category<Backend>::value == number_kind_integer || number_category<Backend>::value == number_kind_modular, "The right-shift operation is only valid for integer and modular types");
      detail::check_shift_range(val, std::integral_constant<bool, (sizeof(V) > sizeof(std::size_t))>(), std::integral_constant < bool, nil::crypto3::multiprecision::detail::is_signed<V>::value&& nil::crypto3::multiprecision::detail::is_integral<V>::value > ());
   ...
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number& operator&=(const self_type& e)
   {
      static_assert(number_category<Backend>::value == number_kind_integer || number_category<Backend>::value == number_kind_modular, "The bitwise & operation is only valid for integer and modular types");
 ...
 public:
   ...
   template <class T>
#else
   template <class T, class = typename std::enable_if<!(std::is_constructible<T, self_type const&>::value || !std::is_default_constructible<T>::value || (!nil::crypto3::multiprecision::detail::is_arithmetic<T>::value && !nil::crypto3::multiprecision::detail::is_complex<T>::value)), T>::type>
#endif
   ...
   template <class V>
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<V>::value && (number_category<Backend>::value != number_kind_complex && number_category<Backend>::value != number_kind_modular), int>::type compare(const V& o) const
   {
      using default_ops::eval_get_sign;
      if (o == 0)
         return eval_get_sign(m_backend);
 ...
 private:
   ...
   BOOST_MP_CXX14_CONSTEXPR void do_assign(const Exp& e, const detail::bitwise_and&)
   {
      ...
      // This operation is only valid for integer backends:
      //
      static_assert(number_category<Backend>::value == number_kind_integer || number_category<Backend>::value == number_kind_modular, "Bitwise operations are only valid for integer and modular types");
   ...
   BOOST_MP_CXX14_CONSTEXPR void do_assign(const Exp& e, const detail::shift_left&)
   {
      ...
      static_assert(nil::crypto3::multiprecision::detail::is_integral<right_value_type>::value, "The left shift operator requires an integer value for the shift operand.");
   ...
   BOOST_MP_CXX14_CONSTEXPR void do_assign_right_shift(const Exp& e, const Val& val, const detail::terminal&)
   {
      ...
      detail::check_shift_range(val, std::integral_constant<bool, (sizeof(Val) > sizeof(std::size_t))>(), std::integral_constant < bool, nil::crypto3::multiprecision::detail::is_signed<Val>::value&& nil::crypto3::multiprecision::detail::is_integral<Val>::value > ());
   ...
   //
   template <class Exp>
   BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<!(nil::crypto3::multiprecision::number_category<self_type>::value == nil::crypto3::multiprecision::number_kind_integer || sizeof(Exp) == 1)>::type
...
inline std::istream& operator>>(std::istream& is, rational<nil::crypto3::multiprecision::number<Backend, ExpressionTemplates> >& r)
{
   std::string                                          s1;
...
inline BOOST_MP_CXX14_CONSTEXPR nil::crypto3::multiprecision::number<T, ExpressionTemplates> numerator(const rational<nil::crypto3::multiprecision::number<T, ExpressionTemplates> >& a)
{
   return a.numerator();
}

template <class T, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR nil::crypto3::multiprecision::number<T, ExpressionTemplates> denominator(const rational<nil::crypto3::multiprecision::number<T, ExpressionTemplates> >& a)
{
   return a.denominator();
}

template <class T, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR std::size_t hash_value(const rational<nil::crypto3::multiprecision::number<T, ExpressionTemplates> >& val)
{
...
{
   BOOST_MP_CXX14_CONSTEXPR std::size_t operator()(const nil::crypto3::multiprecision::number<Backend, ExpressionTemplates>& val) const { return hash_value(val); }
};
template <class Backend, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
struct hash<boost::rational<nil::crypto3::multiprecision::number<Backend, ExpressionTemplates> > >
{
   BOOST_MP_CXX14_CONSTEXPR std::size_t operator()(const boost::rational<nil::crypto3::multiprecision::number<Backend, ExpressionTemplates> >& val) const
   {
      std::size_t result = hash_value(val.numerator());
      boost::hash_combine(result, hash_value(val.denominator()));
      return result;
