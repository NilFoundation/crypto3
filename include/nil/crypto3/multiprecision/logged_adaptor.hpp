...
struct logged_adaptor
{
 ...
 public:
   ...
   template <class T>
   typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<T>::value || std::is_convertible<T, Backend>::value, logged_adaptor&>::type operator=(const T& i)
   {
...
class numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::backends::logged_adaptor<Backend>, ExpressionTemplates> >
    : public std::numeric_limits<nil::crypto3::multiprecision::number<Backend, ExpressionTemplates> >
{
   ...
   using number_type = nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::backends::logged_adaptor<Backend>, ExpressionTemplates>;
...
struct precision<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::logged_adaptor<Backend>, ExpressionTemplates>, Policy>
