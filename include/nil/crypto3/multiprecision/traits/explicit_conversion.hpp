        ...
        namespace multiprecision {
            namespace detail {
                ...
                struct has_generic_interconversion {
                    typedef typename boost::conditional<
                        ...
                        typename boost::conditional<
                            ...
                            typename boost::conditional<number_category<T>::value == number_kind_integer ||
                            ...
                            typename boost::conditional<
                                ...
                                typename boost::conditional<number_category<T>::value == number_kind_rational ||
                                                                number_category<T>::value == number_kind_rational,
                                                            boost::true_type, boost::false_type>::type,
                                typename boost::conditional<number_category<T>::value == number_kind_floating_point,
                                                            boost::true_type, boost::false_type>::type>::type>::type,
                ...
                struct is_explicitly_convertible_imp {
                    ...
                    static boost::type_traits::yes_type selector(dummy_size<sizeof(new T1(boost::declval<
                    ...
                    template<typename S1, typename T1>
                    static boost::type_traits::no_type selector(...);

                    static const bool value = sizeof(selector<S, T>(0)) == sizeof(boost::type_traits::yes_type);
                ...
                template<class Backend1, expression_template_option ExpressionTemplates1, class Backend2,
                         expression_template_option ExpressionTemplates2>
                struct is_explicitly_convertible<number<Backend1, ExpressionTemplates1>,
