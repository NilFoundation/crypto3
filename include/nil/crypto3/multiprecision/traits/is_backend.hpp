        ...
        namespace multiprecision {
            namespace detail {
                ...
                struct other_backend {
                    typedef typename boost::conditional<boost::is_same<number<Backend>, number<Backend, et_on>>::value,
                                                        number<Backend, et_off>, number<Backend, et_on>>::type type;
                };

                template<class B, class V>
                struct number_from_backend {
                    typedef typename boost::conditional<boost::is_convertible<V, number<B>>::value, number<B>,
                ...
                struct is_first_backend_imp<true, T, U> {
                    static const bool value =
                        boost::is_convertible<U, number<T, et_on>>::value || boost::is_convertible<U, number<T, et_off>>::value;
                };
                ...
                struct is_second_backend_imp<true, T, U> {
                    static const bool value =
                        (boost::is_convertible<T, number<U, et_on>>::value || boost::is_convertible<T, number<U, et_off>>::value) &&
