...
typename boost::enable_if_c<!is_trivial_cpp_int<Backend>::value,
                            limb_type>::type constexpr
custom_get_limb_value(const Backend&    b,
                      const std::size_t i)
{
   return b.limbs()[i];
}
...
typename boost::enable_if_c<
    ...
    internal_limb_type>::type constexpr
...
typename boost::enable_if_c<
    is_trivial_cpp_int<Backend>::value &&
    sizeof(typename trivial_limb_type<max_precision<Backend>::value>::type) >=
        sizeof(internal_limb_type)>::type constexpr
custom_set_limb_value(Backend&           b,
                      const std::size_t  i,
