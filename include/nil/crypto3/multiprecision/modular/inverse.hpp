    ...
    namespace crypto3 {
        namespace multiprecision {
            namespace backends {
                ...
                template <typename Backend>
                inline typename boost::mpl::front<typename Backend::unsigned_types>::type bigint_add2_nc(
                    typename boost::mpl::front<typename Backend::unsigned_types>::type x[], size_t x_size,
                    const typename boost::mpl::front<typename Backend::unsigned_types>::type y[], size_t y_size)
                {
                   typedef typename boost::mpl::front<typename Backend::unsigned_types>::type ui_type;
                ...
                template <typename Backend>
                inline typename boost::mpl::front<typename Backend::unsigned_types>::type bigint_cnd_sub(
                    typename boost::mpl::front<typename Backend::unsigned_types>::type cnd,
                    typename boost::mpl::front<typename Backend::unsigned_types>::type x[], size_t x_size,
                    const typename boost::mpl::front<typename Backend::unsigned_types>::type y[], size_t y_size)
                {
                   BOOST_ASSERT_MSG(x_size >= y_size, "Expected sizes");
                ...
                template <typename Backend>
                inline typename boost::mpl::front<typename Backend::unsigned_types>::type bigint_cnd_add(
                    typename boost::mpl::front<typename Backend::unsigned_types>::type       cnd,
