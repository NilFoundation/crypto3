...
class numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::concepts::number_backend_float_architype, ExpressionTemplates> > : public std::numeric_limits<long double>
{
   using base_type   = std::numeric_limits<long double>;
   using number_type = nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::concepts::number_backend_float_architype, ExpressionTemplates>;
