...
struct debug_adaptor
{
 ...
 public:
   ...
   template <class T>
   typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<T>::value || std::is_convertible<T, Backend>::value, debug_adaptor&>::type operator=(const T& i)
   {
      m_value = i;
      update_view();
      return *this;
...
class numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::backends::debug_adaptor<Backend>, ExpressionTemplates> >
    : public std::numeric_limits<nil::crypto3::multiprecision::number<Backend, ExpressionTemplates> >
{
   ...
   using number_type = nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::backends::debug_adaptor<Backend>, ExpressionTemplates>;
...
struct precision<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::debug_adaptor<Backend>, ExpressionTemplates>, Policy>
