...
struct rational_adaptor
{
   ...
   explicit rational_adaptor(const U& u,
                             typename std::enable_if<
                                 nil::crypto3::multiprecision::detail::is_explicitly_convertible<U, IntBackend>::value && !std::is_convertible<U, IntBackend>::value>::type* = 0)
       : m_value(IntBackend(u)) {}
   template <class U>
   typename std::enable_if<(nil::crypto3::multiprecision::detail::is_explicitly_convertible<U, IntBackend>::value && !nil::crypto3::multiprecision::detail::is_arithmetic<U>::value), rational_adaptor&>::type operator=(const U& u)
   {
      m_value = IntBackend(u);
      return *this;
   }
   ...
   template <class Int>
   typename std::enable_if<nil::crypto3::multiprecision::detail::is_integral<Int>::value, rational_adaptor&>::type operator=(Int i)
   {
      m_value = i;
      return *this;
   }
   ...
   typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<Arithmatic>::value && !std::is_floating_point<Arithmatic>::value, int>::type compare(Arithmatic i) const
   {
...
class numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> > : public std::numeric_limits<nil::crypto3::multiprecision::number<IntBackend, ExpressionTemplates> >
{
   using base_type   = std::numeric_limits<nil::crypto3::multiprecision::number<IntBackend> >;
   using number_type = nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::rational_adaptor<IntBackend> >;
...
template <class IntBackend, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> >::is_integer;
template <class IntBackend, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<nil::crypto3::multiprecision::number<nil::crypto3::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> >::is_exact;
