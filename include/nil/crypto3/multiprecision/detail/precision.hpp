...
inline constexpr unsigned current_precision_of_last_chance_imp(const nil::crypto3::multiprecision::number<B, ET>&, const std::integral_constant<bool, false>&)
{
   return std::numeric_limits<nil::crypto3::multiprecision::number<B, ET> >::digits10;
}
template <class B, nil::crypto3::multiprecision::expression_template_option ET>
inline BOOST_MP_CXX14_CONSTEXPR unsigned current_precision_of_last_chance_imp(const nil::crypto3::multiprecision::number<B, ET>& val, const std::integral_constant<bool, true>&)
{
   //
...
template <class B, nil::crypto3::multiprecision::expression_template_option ET>
inline BOOST_MP_CXX14_CONSTEXPR unsigned current_precision_of_imp(const nil::crypto3::multiprecision::number<B, ET>& n, const std::integral_constant<bool, true>&)
{
   return n.precision();
}
template <class B, nil::crypto3::multiprecision::expression_template_option ET>
inline constexpr unsigned current_precision_of_imp(const nil::crypto3::multiprecision::number<B, ET>& val, const std::integral_constant<bool, false>&)
{
   return current_precision_of_last_chance_imp(val,
                                               ...
                                               std::numeric_limits<nil::crypto3::multiprecision::number<B, ET> >::is_specialized&&
                                                       std::numeric_limits<nil::crypto3::multiprecision::number<B, ET> >::is_integer&& std::numeric_limits<nil::crypto3::multiprecision::number<B, ET> >::is_exact &&
...
{
   return current_precision_of_imp(n, nil::crypto3::multiprecision::detail::is_variable_precision<nil::crypto3::multiprecision::number<B, ET> >());
}
...
{
   maybe_promote_precision(obj, std::integral_constant<bool, nil::crypto3::multiprecision::detail::is_variable_precision<T>::value>());
}
