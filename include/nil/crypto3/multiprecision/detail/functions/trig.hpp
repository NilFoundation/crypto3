...
{
   typedef typename nil::crypto3::multiprecision::detail::canonical<boost::int32_t, T>::type  si_type;
   typedef typename nil::crypto3::multiprecision::detail::canonical<boost::uint32_t, T>::type ui_type;
   ...
   const int series_limit =
       nil::crypto3::multiprecision::detail::digits2<number<T, et_on> >::value() < 100
           ? 100
...
template <class T, unsigned N, bool b = nil::crypto3::multiprecision::detail::is_variable_precision<nil::crypto3::multiprecision::number<T> >::value>
...
void reduce_n_half_pi(T& arg, const T& n, bool go_down)
{
   ...
   //
   typedef typename nil::crypto3::multiprecision::detail::transcendental_reduction_type<T>::type reduction_type;
   //
...
void eval_asin(T& result, const T& x)
{
   ...
   typedef typename nil::crypto3::multiprecision::detail::canonical<long double, T>::type guess_type;
#else
...
inline typename boost::enable_if<boost::is_arithmetic<A>, void>::type eval_atan2(T& result, const T& x, const A& a)
{
...
template <class T, class A>
inline typename boost::enable_if<boost::is_arithmetic<A>, void>::type eval_atan2(T& result, const A& x, const T& a)
{
   typedef typename nil::crypto3::multiprecision::detail::canonical<A, T>::type          canonical_type;
   typedef typename boost::mpl::if_<boost::is_same<A, canonical_type>, T, canonical_type>::type cast_type;
   cast_type                                                                      c;
