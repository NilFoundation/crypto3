...
template <typename T, typename U>
inline typename std::enable_if<nil::crypto3::multiprecision::detail::is_integral<U>::value>::type eval_pow(T& result, const T& t, const U& p)
{
...
inline void eval_pow(T& result, const T& x, const T& a)
{
   ...
   typename nil::crypto3::multiprecision::detail::canonical<std::intmax_t, T>::type max_an =
       std::numeric_limits<typename nil::crypto3::multiprecision::detail::canonical<std::intmax_t, T>::type>::is_specialized ? (std::numeric_limits<typename nil::crypto3::multiprecision::detail::canonical<std::intmax_t, T>::type>::max)() : static_cast<typename nil::crypto3::multiprecision::detail::canonical<std::intmax_t, T>::type>(1) << (sizeof(typename nil::crypto3::multiprecision::detail::canonical<std::intmax_t, T>::type) * CHAR_BIT - 2);
   typename nil::crypto3::multiprecision::detail::canonical<std::intmax_t, T>::type min_an =
       std::numeric_limits<typename nil::crypto3::multiprecision::detail::canonical<std::intmax_t, T>::type>::is_specialized ? (std::numeric_limits<typename nil::crypto3::multiprecision::detail::canonical<std::intmax_t, T>::type>::min)() : -min_an;
...
#else
inline typename std::enable_if<is_compatible_arithmetic_type<A, number<T> >::value && !nil::crypto3::multiprecision::detail::is_integral<A>::value, void>::type
#endif
