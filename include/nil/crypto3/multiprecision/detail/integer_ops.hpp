...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_integral<Integer>::value && (number_category<Backend>::value == number_kind_integer), Integer>::type
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_integral<Integer>::value && (number_category<typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::value == number_kind_integer), Integer>::type
...
template <class Backend, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<number_category<Backend>::value == number_kind_integer || number_category<Backend>::value == number_kind_modular, unsigned>::type
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<number_category<typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::value == number_kind_integer || number_category<typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::value == number_kind_modular, unsigned>::type
...
template <class Backend, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<number_category<Backend>::value == number_kind_integer || number_category<Backend>::value == number_kind_modular, bool>::type
...
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<number_category<typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::value == number_kind_integer || number_category<typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::value == number_kind_modular, bool>::type
...
template <class Backend, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<number_category<Backend>::value == number_kind_integer || number_category<Backend>::value == number_kind_modular, number<Backend, ExpressionTemplates>&>::type
...
BOOST_MP_CXX14_CONSTEXPR void eval_powm(Backend& result, const Backend& a, const Backend& p, const Backend& c)
{
   ...
   using ui_type     = typename nil::crypto3::multiprecision::detail::canonical<unsigned char, double_type>::type;
...
BOOST_MP_CXX14_CONSTEXPR void eval_powm(Backend& result, const Backend& a, const Backend& p, Integer c)
{
   using double_type = typename double_precision_type<Backend>::type;
   using ui_type     = typename nil::crypto3::multiprecision::detail::canonical<unsigned char, double_type>::type;
   using i1_type     = typename nil::crypto3::multiprecision::detail::canonical<Integer, double_type>::type;
...
template <class Backend, class Integer>
BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_unsigned<Integer>::value>::type eval_powm(Backend& result, const Backend& a, Integer b, const Backend& c)
{
   using double_type = typename double_precision_type<Backend>::type;
   using ui_type     = typename nil::crypto3::multiprecision::detail::canonical<unsigned char, double_type>::type;
...
template <class Backend, class Integer>
BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_signed<Integer>::value && nil::crypto3::multiprecision::detail::is_integral<Integer>::value>::type eval_powm(Backend& result, const Backend& a, Integer b, const Backend& c)
{
   if (b < 0)
   {
      BOOST_THROW_EXCEPTION(std::runtime_error("powm requires a positive exponent."));
   }
   eval_powm(result, a, static_cast<typename nil::crypto3::multiprecision::detail::make_unsigned<Integer>::type>(b), c);
}

template <class Backend, class Integer1, class Integer2>
BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_unsigned<Integer1>::value>::type eval_powm(Backend& result, const Backend& a, Integer1 b, Integer2 c)
{
   using double_type = typename double_precision_type<Backend>::type;
   using ui_type     = typename nil::crypto3::multiprecision::detail::canonical<unsigned char, double_type>::type;
   using i1_type     = typename nil::crypto3::multiprecision::detail::canonical<Integer1, double_type>::type;
...
template <class Backend, class Integer1, class Integer2>
BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_signed<Integer1>::value && nil::crypto3::multiprecision::detail::is_integral<Integer1>::value>::type eval_powm(Backend& result, const Backend& a, Integer1 b, Integer2 c)
{
   if (b < 0)
   {
      BOOST_THROW_EXCEPTION(std::runtime_error("powm requires a positive exponent."));
   }
   eval_powm(result, a, static_cast<typename nil::crypto3::multiprecision::detail::make_unsigned<Integer1>::type>(b), c);
}
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<
    (number_category<T>::value == number_kind_integer) &&
        ...
        (is_number<U>::value || is_number_expression<U>::value || nil::crypto3::multiprecision::detail::is_integral<U>::value) &&
        (is_number<V>::value || is_number_expression<V>::value || nil::crypto3::multiprecision::detail::is_integral<V>::value),
