...
template <class To, class From>
constexpr void generic_interconvert(To& to, const From& from, const std::integral_constant<int, number_kind_integer>& /*to_type*/, const std::integral_constant<int, number_kind_modular>& /*from_type*/);
...
struct calculate_next_larger_type
{
   ...
   using list_type = typename std::conditional<
       nil::crypto3::multiprecision::detail::is_signed<R>::value && nil::crypto3::multiprecision::detail::is_integral<R>::value,
       typename B::signed_types,
       typename std::conditional<
           nil::crypto3::multiprecision::detail::is_unsigned<R>::value,
   ...
   static constexpr int index_of_type = nil::crypto3::multiprecision::detail::find_index_of_large_enough_type < list_type, start == INT_MAX ? 0 : start + 1, std::numeric_limits<R>::digits > ::value;
   using type                         = typename nil::crypto3::multiprecision::detail::dereference_tuple<index_of_type, list_type, terminal<R> >::type;
};

template <class R, class T>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_integral<R>::value, bool>::type check_in_range(const T& t)
{
   // Can t fit in an R?
...
template <class R, class B>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_integral<R>::value>::type eval_convert_to(R* result, const B& backend)
{
   using next_type = typename calculate_next_larger_type<R, B>::type;
   next_type n     = next_type();
   eval_convert_to(&n, backend);
   BOOST_IF_CONSTEXPR(!nil::crypto3::multiprecision::detail::is_unsigned<R>::value && std::numeric_limits<R>::is_specialized && std::numeric_limits<R>::is_bounded)
   {
   ...
   BOOST_CATCH(const boost::bad_lexical_cast&)
   {
      if (eval_get_sign(backend) < 0)
      {
         ...
         *result                                                             = (std::numeric_limits<R>::max)(); // we should never get here, exception above will be raised.
         else BOOST_IF_CONSTEXPR(std::numeric_limits<R>::is_integer)* result = (std::numeric_limits<R>::min)();
...
{
   using tag_type = std::integral_constant<bool, nil::crypto3::multiprecision::detail::is_unsigned<R>::value && number_category<B>::value == number_kind_integer>;
...
inline BOOST_MP_CXX14_CONSTEXPR void eval_convert_to(terminal<number<B1, et> >* result, const B2& backend)
{
   ...
   //
   nil::crypto3::multiprecision::detail::generic_interconvert(result->value.backend(), backend, number_category<B1>(), number_category<B2>());
}
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<A>::value, void>::type eval_fmod(T& result, const T& x, const A& a)
{
...
template <class T, class A>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<A>::value, void>::type eval_fmod(T& result, const A& x, const T& a)
{
   using canonical_type = typename nil::crypto3::multiprecision::detail::canonical<A, T>::type;
   using cast_type      = typename std::conditional<std::is_same<A, canonical_type>::value, T, canonical_type>::type;
   cast_type c;
...
template <class T, class A>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<A>::value, void>::type eval_remquo(T& result, const T& x, const A& a, int* pi)
{
   using canonical_type = typename nil::crypto3::multiprecision::detail::canonical<A, T>::type;
   using cast_type      = typename std::conditional<std::is_same<A, canonical_type>::value, T, canonical_type>::type;
...
template <class T, class A>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<A>::value, void>::type eval_remquo(T& result, const A& x, const T& a, int* pi)
{
   using canonical_type = typename nil::crypto3::multiprecision::detail::canonical<A, T>::type;
   using cast_type      = typename std::conditional<std::is_same<A, canonical_type>::value, T, canonical_type>::type;
   cast_type c          = cast_type();
...
template <class T, class A>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<A>::value>::type eval_fdim(T& result, const T& a, const A& b)
{
   using ui_type               = typename nil::crypto3::multiprecision::detail::canonical<unsigned, T>::type;
...
template <class T, class A>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<A>::value>::type eval_fdim(T& result, const A& a, const T& b)
{
   using ui_type               = typename nil::crypto3::multiprecision::detail::canonical<unsigned, T>::type;
   using arithmetic_type       = typename nil::crypto3::multiprecision::detail::canonical<A, T>::type;
   const ui_type   zero        = 0u;
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_integral<Arithmetic>::value>::type eval_gcd(T& result, const T& a, const Arithmetic& b)
{
...
template <class T, class Arithmetic>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_integral<Arithmetic>::value>::type eval_gcd(T& result, const Arithmetic& a, const T& b)
{
   eval_gcd(result, b, a);
}
template <class T, class Arithmetic>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_integral<Arithmetic>::value>::type eval_lcm(T& result, const T& a, const Arithmetic& b)
{
   using si_type = typename nil::crypto3::multiprecision::detail::canonical<Arithmetic, T>::type;
...
template <class T, class Arithmetic>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_integral<Arithmetic>::value>::type eval_lcm(T& result, const Arithmetic& a, const T& b)
{
   eval_lcm(result, b, a);
}
...
{
   return is_arg_nan(val, std::integral_constant<bool, nil::crypto3::multiprecision::detail::is_backend<T>::value>(), std::is_floating_point<T>());
}
...
{
   return (nil::crypto3::multiprecision::signbit)(a) != (nil::crypto3::multiprecision::signbit)(b) ? (nil::crypto3::multiprecision::changesign)(a) : a;
}
...
BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<Scalar>::value, typename complex_result_from_scalar<number<Backend, ExpressionTemplates> >::type>::type
...
BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_arithmetic<Scalar>::value,
                                                 typename complex_result_from_scalar<typename detail::expression<tag, A1, A2, A3, A4>::result_type>::type>::type
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<nil::crypto3::multiprecision::detail::is_integral<I>::value, number<B, ET>&>::type
...
inline BOOST_MP_CXX14_CONSTEXPR int itrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(boost::math::isfinite)(v))
      return boost::math::policies::raise_rounding_error("nil::crypto3::multiprecision::itrunc<%1%>(%1%)", 0, number_type(v), 0, pol);
...
inline BOOST_MP_CXX14_CONSTEXPR int itrunc(const number<Backend, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(boost::math::isfinite)(v))
      return boost::math::policies::raise_rounding_error("nil::crypto3::multiprecision::itrunc<%1%>(%1%)", 0, v, 0, pol);
   return r.template convert_to<int>();
}
template <class Backend, expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR long ltrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(boost::math::isfinite)(v))
      return boost::math::policies::raise_rounding_error("nil::crypto3::multiprecision::ltrunc<%1%>(%1%)", 0, number_type(v), 0L, pol);
...
inline BOOST_MP_CXX14_CONSTEXPR long ltrunc(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(boost::math::isfinite)(v))
      return boost::math::policies::raise_rounding_error("nil::crypto3::multiprecision::ltrunc<%1%>(%1%)", 0, v, 0L, pol);
   return r.template convert_to<long>();
}
template <class T, expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR boost::long_long_type lltrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<boost::long_long_type>::max)()) || r < (std::numeric_limits<boost::long_long_type>::min)() || !(boost::math::isfinite)(v))
      return boost::math::policies::raise_rounding_error("nil::crypto3::multiprecision::lltrunc<%1%>(%1%)", 0, number_type(v), 0LL, pol);
...
inline BOOST_MP_CXX14_CONSTEXPR boost::long_long_type lltrunc(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r(trunc(v, pol));
   if ((r > (std::numeric_limits<boost::long_long_type>::max)()) || r < (std::numeric_limits<boost::long_long_type>::min)() || !(boost::math::isfinite)(v))
      return boost::math::policies::raise_rounding_error("nil::crypto3::multiprecision::lltrunc<%1%>(%1%)", 0, v, 0LL, pol);
   return r.template convert_to<boost::long_long_type>();
}
template <class T, expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR int iround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(boost::math::isfinite)(v))
      return boost::math::policies::raise_rounding_error("nil::crypto3::multiprecision::iround<%1%>(%1%)", 0, number_type(v), 0, pol);
   return r.template convert_to<int>();
}
template <class tag, class A1, class A2, class A3, class A4>
...
inline BOOST_MP_CXX14_CONSTEXPR int iround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(boost::math::isfinite)(v))
      return boost::math::policies::raise_rounding_error("nil::crypto3::multiprecision::iround<%1%>(%1%)", 0, v, 0, pol);
   return r.template convert_to<int>();
}
template <class T, expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR long lround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   number_type r(round(v, pol));
   if ((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(boost::math::isfinite)(v))
      return boost::math::policies::raise_rounding_error("nil::crypto3::multiprecision::lround<%1%>(%1%)", 0, number_type(v), 0L, pol);
   return r.template convert_to<long>();
}
template <class tag, class A1, class A2, class A3, class A4>
...
inline BOOST_MP_CXX14_CONSTEXPR long lround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r(round(v, pol));
   if ((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(boost::math::isfinite)(v))
      return boost::math::policies::raise_rounding_error("nil::crypto3::multiprecision::lround<%1%>(%1%)", 0, v, 0L, pol);
   return r.template convert_to<long>();
}
template <class T, expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR boost::long_long_type llround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   number_type r(round(v, pol));
   if ((r > (std::numeric_limits<boost::long_long_type>::max)()) || r < (std::numeric_limits<boost::long_long_type>::min)() || !(boost::math::isfinite)(v))
      return boost::math::policies::raise_rounding_error("nil::crypto3::multiprecision::iround<%1%>(%1%)", 0, number_type(v), 0LL, pol);
   return r.template convert_to<boost::long_long_type>();
}
template <class tag, class A1, class A2, class A3, class A4>
...
inline BOOST_MP_CXX14_CONSTEXPR boost::long_long_type llround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r(round(v, pol));
   if ((r > (std::numeric_limits<boost::long_long_type>::max)()) || r < (std::numeric_limits<boost::long_long_type>::min)() || !(boost::math::isfinite)(v))
      return boost::math::policies::raise_rounding_error("nil::crypto3::multiprecision::iround<%1%>(%1%)", 0, v, 0LL, pol);
   return r.template convert_to<boost::long_long_type>();
}
template <class T, expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<
    (number_category<number<Backend, et_on> >::value == number_kind_floating_point) &&
        (is_number<U>::value || is_number_expression<U>::value || nil::crypto3::multiprecision::detail::is_arithmetic<U>::value) &&
        (is_number<V>::value || is_number_expression<V>::value || nil::crypto3::multiprecision::detail::is_arithmetic<V>::value),
...
inline nil::crypto3::multiprecision::number<Backend, ExpressionTemplates> sinc_pi(const nil::crypto3::multiprecision::number<Backend, ExpressionTemplates>& x)
{
   nil::crypto3::multiprecision::detail::scoped_default_precision<nil::crypto3::multiprecision::number<Backend, ExpressionTemplates> > precision_guard(x);
...
inline nil::crypto3::multiprecision::number<Backend, ExpressionTemplates> sinc_pi(const nil::crypto3::multiprecision::number<Backend, ExpressionTemplates>& x, const Policy&)
{
   nil::crypto3::multiprecision::detail::scoped_default_precision<nil::crypto3::multiprecision::number<Backend, ExpressionTemplates> > precision_guard(x);
   return std::move(detail::sinc_pi_imp(x));
}
...
template <class Backend, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates>
inline nil::crypto3::multiprecision::number<Backend, ExpressionTemplates> sinhc_pi(const nil::crypto3::multiprecision::number<Backend, ExpressionTemplates>& x)
{
   nil::crypto3::multiprecision::detail::scoped_default_precision<nil::crypto3::multiprecision::number<Backend, ExpressionTemplates> > precision_guard(x);
...
template <class Backend, nil::crypto3::multiprecision::expression_template_option ExpressionTemplates, class Policy>
inline nil::crypto3::multiprecision::number<Backend, ExpressionTemplates> sinhc_pi(const nil::crypto3::multiprecision::number<Backend, ExpressionTemplates>& x, const Policy&)
{
   nil::crypto3::multiprecision::detail::scoped_default_precision<nil::crypto3::multiprecision::number<Backend, ExpressionTemplates> > precision_guard(x);
