...
#if defined(BOOST_NO_CXX11_RVALUE_REFERENCES) || defined(BOOST_NO_CXX11_TEMPLATE_ALIASES) ||              \
    defined(BOOST_NO_CXX11_HDR_ARRAY) || defined(BOOST_NO_CXX11_ALLOCATOR) ||                             \
    defined(BOOST_NO_CXX11_UNIFIED_INITIALIZATION_SYNTAX) || defined(BOOST_NO_CXX11_CONSTEXPR) ||         \
    defined(BOOST_MP_NO_CXX11_EXPLICIT_CONVERSION_OPERATORS) || defined(BOOST_NO_CXX11_REF_QUALIFIERS) || \
    defined(BOOST_NO_CXX11_HDR_FUNCTIONAL) || defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES) ||               \
    defined(BOOST_NO_CXX11_USER_DEFINED_LITERALS) || defined(BOOST_NO_CXX11_THREAD_LOCAL) ||              \
    defined(BOOST_NO_CXX11_DECLTYPE) || defined(BOOST_NO_CXX11_STATIC_ASSERT) ||                          \
    defined(BOOST_NO_CXX11_DEFAULTED_FUNCTIONS) || defined(BOOST_NO_CXX11_NOEXCEPT) ||                    \
...
#pragma message( \
    "CAUTION: Compiling Boost.Multiprecision in non-C++11 or later conformance modes is now deprecated and will be removed from March 2021.")
...
#define BOOST_MP_FORCEINLINE inline
    ...
    (defined(__clang_major__) && (__clang_major__ == 3) && (__clang_minor__ < 5))
...
namespace nil {
    namespace crypto3 {
        namespace multiprecision {
            ...
            struct is_number<number<Backend, ExpressionTemplates>> : public boost::mpl::true_ { };

            template<class T>
            struct is_et_number : public boost::mpl::false_ { };

            template<class Backend>
            struct is_et_number<number<Backend, et_on>> : public boost::mpl::true_ { };

            template<class T>
            struct is_no_et_number : public boost::mpl::false_ { };

            template<class Backend>
            struct is_no_et_number<number<Backend, et_off>> : public boost::mpl::true_ { };
            ...
            template<class T>
            struct is_number_expression : public boost::mpl::false_ { };

            template<class tag, class Arg1, class Arg2, class Arg3, class Arg4>
            struct is_number_expression<detail::expression<tag, Arg1, Arg2, Arg3, Arg4>> : public boost::mpl::true_ { };

            template<class T, class Num>
            struct is_compatible_arithmetic_type
                : public boost::mpl::bool_<boost::is_convertible<T, Num>::value && !boost::is_same<T, Num>::value &&
            ...
            namespace detail {
                ...
                template<class T>
                BOOST_CONSTEXPR
                    typename boost::enable_if_c<(boost::is_signed<T>::value || boost::is_floating_point<T>::value),
                                                T>::type
                    abs(T t) BOOST_NOEXCEPT {
                ...
                template<class T>
                BOOST_CONSTEXPR typename boost::enable_if_c<(boost::is_unsigned<T>::value), T>::type
                    abs(T t) BOOST_NOEXCEPT {
                    return t;
                }
...
#define BOOST_MP_USING_ABS using nil::crypto3::multiprecision::detail::abs;
                ...
                BOOST_CONSTEXPR
                    typename boost::enable_if_c<(boost::is_signed<T>::value || boost::is_floating_point<T>::value),
                                                typename boost::make_unsigned<T>::type>::type
                    unsigned_abs(T t) BOOST_NOEXCEPT {
                    // This strange expression avoids a hardware trap in the corner case
                    // that val is the most negative value permitted in boost::long_long_type.
                    // See https://svn.boost.org/trac/boost/ticket/9740.
                    return t < 0 ? static_cast<typename boost::make_unsigned<T>::type>(1u) +
                                       static_cast<typename boost::make_unsigned<T>::type>(-(t + 1)) :
...
#define BOOST_MP_MOVE(x) x
                ...
                template<class T>
                struct bits_of {
                    BOOST_STATIC_ASSERT(boost::is_integral<T>::value || boost::is_enum<T>::value ||
                                        std::numeric_limits<T>::is_specialized);
                    static const unsigned value = std::numeric_limits<T>::is_specialized ?
                                                      std::numeric_limits<T>::digits :
                                                      sizeof(T) * CHAR_BIT - (boost::is_signed<T>::value ? 1 : 0);
                };
...
#define BOOST_MP_BITS_OF_FLOAT128_DEFINED
                ...
                struct has_enough_bits {
                    template<class T>
                    struct type : public boost::mpl::bool_<bits_of<T>::value >= b> { };
                };

                template<class Val, class Backend, class Tag>
                struct canonical_imp {
                    typedef typename boost::remove_cv<typename boost::decay<const Val>::type>::type type;
                };
                ...
                struct canonical_imp<number<B, et_on>, Backend, boost::mpl::int_<3>> {
                    typedef B type;
                };
                template<class B, class Backend>
                struct canonical_imp<number<B, et_off>, Backend, boost::mpl::int_<3>> {
                    typedef B type;
                };
#endif

                template<class Val, class Backend>
                struct canonical_imp<Val, Backend, boost::mpl::int_<0>> {
                    typedef typename has_enough_bits<bits_of<Val>::value>::template type<boost::mpl::_> pred_type;
                    typedef typename boost::mpl::find_if<typename Backend::signed_types, pred_type>::type iter_type;
                    typedef typename boost::mpl::end<typename Backend::signed_types>::type end_type;
                    typedef typename boost::mpl::eval_if<boost::is_same<iter_type, end_type>, boost::mpl::identity<Val>,
                                                         boost::mpl::deref<iter_type>>::type type;
                };
                template<class Val, class Backend>
                struct canonical_imp<Val, Backend, boost::mpl::int_<1>> {
                    typedef typename has_enough_bits<bits_of<Val>::value>::template type<boost::mpl::_> pred_type;
                    typedef typename boost::mpl::find_if<typename Backend::unsigned_types, pred_type>::type iter_type;
                    typedef typename boost::mpl::end<typename Backend::unsigned_types>::type end_type;
                    typedef typename boost::mpl::eval_if<boost::is_same<iter_type, end_type>, boost::mpl::identity<Val>,
                                                         boost::mpl::deref<iter_type>>::type type;
                };
                template<class Val, class Backend>
                struct canonical_imp<Val, Backend, boost::mpl::int_<2>> {
                    typedef typename has_enough_bits<bits_of<Val>::value>::template type<boost::mpl::_> pred_type;
                    typedef typename boost::mpl::find_if<typename Backend::float_types, pred_type>::type iter_type;
                    typedef typename boost::mpl::end<typename Backend::float_types>::type end_type;
                    typedef typename boost::mpl::eval_if<boost::is_same<iter_type, end_type>, boost::mpl::identity<Val>,
                                                         boost::mpl::deref<iter_type>>::type type;
                };
                template<class Val, class Backend>
                struct canonical_imp<Val, Backend, boost::mpl::int_<3>> {
                ...
                struct canonical {
                    typedef typename boost::mpl::if_<
                        boost::is_signed<Val>, boost::mpl::int_<0>,
                        typename boost::mpl::if_<
                            boost::is_unsigned<Val>, boost::mpl::int_<1>,
                            typename boost::mpl::if_<
                                boost::is_floating_point<Val>, boost::mpl::int_<2>,
                                typename boost::mpl::if_<boost::mpl::or_<boost::is_convertible<Val, const char*>,
                                                                         boost::is_same<Val, std::string>>,
                                                         boost::mpl::int_<3>, boost::mpl::int_<4>>::type>::type>::
                            type>::type tag_type;
                ...
                struct combine_expression {
                    ...
                    typedef typename boost::mpl::if_c<(sizeof(T1() + T2()) == sizeof(T1)), T1, T2>::type type;
#else
                ...
                struct combine_expression<number<T1, ExpressionTemplates1>, number<T2, ExpressionTemplates2>> {
                    typedef typename boost::mpl::if_c<boost::is_convertible<number<T2, ExpressionTemplates2>,
                ...
                struct expression<tag, Arg1, void, void, void> {
                    typedef boost::mpl::int_<1> arity;
                    ...
                    BOOST_MP_CXX14_CONSTEXPR const Arg1& left_ref() const BOOST_NOEXCEPT {
                        return arg;
                    }
    ...
    (defined(BOOST_INTEL) && (BOOST_INTEL <= 1500))
                    ...
                    // an arithmetic type:
                    //
                    template<class T, typename boost::enable_if<boost::is_same<T, bool>, int>::type = 0>
                    ...
                    template<class T,
                             typename boost::disable_if_c<
                                 boost::is_same<T, bool>::value || boost::is_void<T>::value || is_number<T>::value, int>::type = 0>
                    explicit operator T() const {
...
#ifndef __SUNPRO_CC
                             ,
                             typename boost::disable_if_c<is_number<T>::value ||
                                                              boost::is_constructible<T const&, result_type>::value ||
                                                              !boost::is_constructible<T, result_type>::value,
                                                          int>::type = 0
#endif
                             >
                ...
                struct expression<terminal, Arg1, void, void, void> {
                    typedef boost::mpl::int_<0> arity;
    ...
    (defined(BOOST_INTEL) && (BOOST_INTEL <= 1500))
                ...
                struct expression<tag, Arg1, Arg2, void, void> {
                    typedef boost::mpl::int_<2> arity;
                    typedef typename arg_type<Arg1>::type left_type;
                    ...
                    BOOST_MP_CXX14_CONSTEXPR const Arg2& right_ref() const BOOST_NOEXCEPT {
                        return arg2;
                    }
    ...
    (defined(BOOST_INTEL) && (BOOST_INTEL <= 1500))
                    ...
                    static const BOOST_MP_CXX14_CONSTEXPR unsigned depth =
                ...
                struct expression<tag, Arg1, Arg2, Arg3, void> {
                    typedef boost::mpl::int_<3> arity;
                    typedef typename arg_type<Arg1>::type left_type;
                    ...
                    BOOST_MP_CXX14_CONSTEXPR const Arg2& middle_ref() const BOOST_NOEXCEPT {
                        return arg2;
                    }
                    BOOST_MP_CXX14_CONSTEXPR const Arg3& right_ref() const BOOST_NOEXCEPT {
                        return arg3;
                    }
    ...
    (defined(BOOST_INTEL) && (BOOST_INTEL <= 1500))
                    ...
                    static const unsigned depth = left_depth > right_depth ?
                ...
                template<class tag, class Arg1, class Arg2, class Arg3, class Arg4>
                struct expression {
                    typedef boost::mpl::int_<4> arity;
                    typedef typename arg_type<Arg1>::type left_type;
                    ...
                    BOOST_MP_CXX14_CONSTEXPR const Arg2& left_middle_ref() const BOOST_NOEXCEPT {
                        return arg2;
                    }
                    BOOST_MP_CXX14_CONSTEXPR const Arg3& right_middle_ref() const BOOST_NOEXCEPT {
                        return arg3;
                    }
                    BOOST_MP_CXX14_CONSTEXPR const Arg4& right_ref() const BOOST_NOEXCEPT {
                        return arg4;
                    }
    ...
    (defined(BOOST_INTEL) && (BOOST_INTEL <= 1500))
                ...
                struct digits2 {
                    ...
                    static const long m_value = std::numeric_limits<T>::radix == 10 ?
                                                    (((std::numeric_limits<T>::digits + 1) * 1000L) / 301L) :
                                                    std::numeric_limits<T>::digits;
                    static inline BOOST_CONSTEXPR long value() BOOST_NOEXCEPT {
                        return m_value;
                    }
                };
...
#define BOOST_MP_MIN_EXPONENT_DIGITS 2
                ...
                template<class V>
                BOOST_MP_CXX14_CONSTEXPR void check_shift_range(V val, const boost::mpl::true_&,
                ...
                template<class V>
                BOOST_MP_CXX14_CONSTEXPR void check_shift_range(V val, const boost::mpl::false_&,
                                                                const boost::mpl::true_&) {
                    if (val < 0)
                        BOOST_THROW_EXCEPTION(std::out_of_range("Can not shift by a negative value."));
                }
                ...
                template<class V>
                BOOST_MP_CXX14_CONSTEXPR void check_shift_range(V, const boost::mpl::false_&,
            ...
            struct number_category_base : public boost::mpl::int_<number_kind_unknown> { };
            template<class Num>
            struct number_category_base<Num, true, false>
                : public boost::mpl::int_<std::numeric_limits<Num>::is_integer ?
                                              number_kind_integer :
                                              (std::numeric_limits<Num>::max_exponent ? number_kind_floating_point :
                                                                                        number_kind_unknown)> { };
            template<class Num>
            struct number_category
                : public number_category_base<Num, boost::is_class<Num>::value || boost::is_arithmetic<Num>::value,
...
//
            ...
            template<>
            struct number_category<boost::int128_type> : public boost::mpl::int_<number_kind_integer> { };
            template<>
            struct number_category<boost::uint128_type> : public boost::mpl::int_<number_kind_integer> { };
#endif
#ifdef BOOST_HAS_FLOAT128
            template<>
            struct number_category<__float128> : public boost::mpl::int_<number_kind_floating_point> { };
#endif
            ...
            struct scalar_result_from_possible_complex {
                typedef typename boost::mpl::if_c<number_category<T>::value == number_kind_complex,
            ...
            template<class T>
            struct is_unsigned_number : public boost::mpl::false_ { };
            template<class Backend, expression_template_option ExpressionTemplates>
            struct is_unsigned_number<number<Backend, ExpressionTemplates>> : public is_unsigned_number<Backend> { };
            template<class T>
            struct is_signed_number : public boost::mpl::bool_<!is_unsigned_number<T>::value> { };
            template<class T>
            struct is_interval_number : public boost::mpl::false_ { };
            template<class Backend, expression_template_option ExpressionTemplates>
    ...
    namespace math {
        namespace tools {
            ...
            struct is_complex_type<nil::crypto3::multiprecision::number<B, ET>>
                : public boost::mpl::bool_<nil::crypto3::multiprecision::number_category<B>::value ==
