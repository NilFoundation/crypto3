...
namespace nil {
    namespace crypto3 {
        namespace block {
            ...
            public:
                typedef typename detail::isomorphic_encrypter_mode<kasumi> stream_encrypter_type;
                typedef typename detail::isomorphic_decrypter_mode<kasumi> stream_decrypter_type;
