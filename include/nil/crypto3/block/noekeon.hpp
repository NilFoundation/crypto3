...
namespace nil {
    namespace crypto3 {
        namespace block {
            ...
            public:
                typedef typename detail::isomorphic_encrypter_mode<noekeon> stream_encrypter_type;
                typedef typename detail::isomorphic_decrypter_mode<noekeon> stream_decrypter_type;
