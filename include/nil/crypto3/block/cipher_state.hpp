...
#ifndef CRYPTO3_CIPHER_STATE_HPP
#define CRYPTO3_CIPHER_STATE_HPP
...
namespace nil {
    namespace crypto3 {
        namespace block {
             ...
             */
            template<typename Mode, typename Endian, std::size_t ValueBits, std::size_t LengthBits>
            struct cipher_state : public concept_container<Mode, cipher_state_preprocessor<Mode, Endian, ValueBits,
                                                                                           LengthBits>> {
