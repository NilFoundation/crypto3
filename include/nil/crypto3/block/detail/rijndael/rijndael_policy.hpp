        ...
        namespace block {
            namespace detail {
                ...
                struct basic_rijndael_policy : rijndael_functions<32, BlockBits> {
                    ...
                    alignas(64) constexpr static const round_constants_type round_constants = {
                ...
                template<std::size_t KeyBits, std::size_t BlockBits>
                alignas(64) constexpr typename basic_rijndael_policy<KeyBits, BlockBits>::round_constants_type const
                    basic_rijndael_policy<KeyBits, BlockBits>::round_constants;

                template<std::size_t KeyBits, std::size_t BlockBits>
                alignas(64) constexpr typename basic_rijndael_policy<KeyBits, BlockBits>::constants_type const
