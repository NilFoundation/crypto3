        ...
        namespace block {
            namespace detail {
                ...
                struct cast_functions<128, KeyBits> : public basic_cast_policy<128, KeyBits> {
                    ...
                    constexpr static const std::size_t rotation_key_schedule_size = policy_type::rotation_key_schedule_size;
...
*/
                    ...
                    static inline void schedule_key(const key_type &key, key_schedule_type &key_schedule,
                        ...
                        static const byte_type key_rot[32] = {
                                0x13, 0x04, 0x15, 0x06, 0x17, 0x08, 0x19, 0x0A, 0x1B, 0x0C, 0x1D, 0x0E, 0x1F, 0x10,
                                0x01, 0x12, 0x03, 0x14, 0x05, 0x16, 0x07, 0x18, 0x09, 0x1A, 0x0B, 0x1C, 0x0D, 0x1E,
                                0x0F, 0x00, 0x11, 0x02
                        };
