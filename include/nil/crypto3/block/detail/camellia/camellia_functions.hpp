                ...
                struct camellia_functions : public basic_camellia_policy<KeyBits> {
                    ...
                    inline uint64_t f(uint64_t v, uint64_t K) {
                        ...
                        return basic_camellia_policy<KeyBits>::sbox1[policy_type::template extract_uint_t<CHAR_BIT>(
                                   x, 0)] ^
                               basic_camellia_policy<KeyBits>::sbox2[policy_type::template extract_uint_t<CHAR_BIT>(
                                   x, 1)] ^
                               basic_camellia_policy<KeyBits>::sbox3[policy_type::template extract_uint_t<CHAR_BIT>(
                                   x, 2)] ^
                               basic_camellia_policy<KeyBits>::sbox4[policy_type::template extract_uint_t<CHAR_BIT>(
                                   x, 3)] ^
                               basic_camellia_policy<KeyBits>::sbox5[policy_type::template extract_uint_t<CHAR_BIT>(
                                   x, 4)] ^
                               basic_camellia_policy<KeyBits>::sbox6[policy_type::template extract_uint_t<CHAR_BIT>(
                                   x, 5)] ^
                               basic_camellia_policy<KeyBits>::sbox7[policy_type::template extract_uint_t<CHAR_BIT>(
                                   x, 6)] ^
