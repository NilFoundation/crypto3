        ...
        namespace block {
            namespace detail {
                ...
                struct streebog_policy : public basic_functions<64> {
                    ...
                    constexpr static const std::size_t key_schedule_bits = KeyBits;
                    constexpr static const std::size_t key_schedule_words = KeyBits / word_bits;
                    ...
                    typedef std::array<word_type, rounds * substitutions_amount> round_constants_type;
