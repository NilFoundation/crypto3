...
namespace nil {
    namespace crypto3 {
        namespace block {
            ...
            public:
                typedef typename detail::isomorphic_encryption_mode<sm4> stream_encrypter_type;
                typedef typename detail::isomorphic_decryption_mode<sm4> stream_decrypter_type;
                ...
                struct stream_cipher {
                    ...
                    typedef block_stream_processor<Mode<sm4, Padding>, StateAccumulator, params_type> type;
                };
