...
namespace nil {
    namespace crypto3 {
        namespace block {
            ...
            public:
                typedef typename detail::isomorphic_encrypter_mode<des> stream_encrypter_type;
                typedef typename detail::isomorphic_decrypter_mode<des> stream_decrypter_type;
