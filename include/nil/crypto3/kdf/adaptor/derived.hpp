...
namespace nil {
    namespace crypto3 {
        namespace detail {
            ...
            struct derived_range : public boost::iterator_range<
            ...
            public:
                ...
                derived_range(transform_fn_type f, R &r) : base(transform_iter_t(boost::begin(r), f),
            ...
            template<class SinglePassRange, class UnaryFunction>
            inline derived_range<UnaryFunction, const SinglePassRange> operator|(const SinglePassRange &r,
                                                                                 const encode_holder<
                                                                                         UnaryFunction> &f) {
