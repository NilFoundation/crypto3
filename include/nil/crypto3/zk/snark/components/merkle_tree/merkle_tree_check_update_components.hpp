    ...
    namespace crypto3 {
        namespace zk {
            namespace snark {
                ...
                template<typename FieldType, typename Hash>
                std::size_t merkle_tree_check_update_components<FieldType, Hash>::expected_constraints(const std::size_t tree_depth) {
                ...
                void test_merkle_tree_check_update_gadget() {
                    ...
                    merkle_tree_check_update_components<FieldType, Hash> mls(
                        pb, tree_depth, address_bits_va, prev_leaf_digest, prev_root_digest, prev_path_var,
                        next_leaf_digest, next_root_digest, next_path_var, variable<FieldType>(0));
