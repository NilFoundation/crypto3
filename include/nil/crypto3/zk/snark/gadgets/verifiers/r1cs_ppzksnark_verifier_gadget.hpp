    ...
    namespace crypto3 {
        namespace zk {
            namespace snark {
                ...
                class r1cs_ppzksnark_proof_variable : public gadget<typename CurveType::scalar_field_type> {
                public:
                ...
                template<typename CurveType>
                class r1cs_ppzksnark_verification_key_variable : public gadget<typename CurveType::scalar_field_type> {
                public:
                    typedef typename CurveType::scalar_field_type FieldType;
                ...
                template<typename CurveType>
                class r1cs_ppzksnark_verifier_process_vk_gadget : public gadget<typename CurveType::scalar_field_type> {
                public:
                    typedef typename CurveType::scalar_field_type FieldType;
                ...
                template<typename CurveType>
                class r1cs_ppzksnark_online_verifier_gadget : public gadget<typename CurveType::scalar_field_type> {
                public:
                    typedef typename CurveType::scalar_field_type FieldType;
                ...
                template<typename CurveType>
                class r1cs_ppzksnark_verifier_gadget : public gadget<typename CurveType::scalar_field_type> {
                public:
                    typedef typename CurveType::scalar_field_type FieldType;
