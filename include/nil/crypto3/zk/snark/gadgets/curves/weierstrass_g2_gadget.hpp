        ...
        namespace zk {
            namespace snark {
                ...
                public:
                    ...
                    G2_checker_gadget(protoboard<FieldType> &pb, const G2_variable<CurveType> &Q);
                    void generate_r1cs_constraints();
                    void generate_r1cs_witness();
                };

                template<typename CurveType>
                G2_variable<CurveType>::G2_variable(protoboard<FieldType> &pb) : gadget<FieldType>(pb) {
                ...
                template<typename CurveType>
                G2_checker_gadget<CurveType>::G2_checker_gadget(protoboard<FieldType> &pb, const G2_variable<CurveType> &Q) :
