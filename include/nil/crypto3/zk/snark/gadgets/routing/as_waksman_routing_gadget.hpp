    ...
    namespace crypto3 {
        namespace zk {
            namespace snark {
                ...
                class as_waksman_routing_gadget : public gadget<FieldType> {
                private:
                    /*
                    ...
                    */
                    ...
                    /*
                      ...
                      connection).
                    */
                    std::vector<std::map<std::size_t, pb_variable<FieldType>>> asw_switch_bits;
                ...
                public:
                    ...
                    as_waksman_routing_gadget(protoboard<FieldType> &pb,
                                              const std::size_t num_packets,
                                              const std::vector<pb_variable_array<FieldType>> &routing_input_bits,
                                              const std::vector<pb_variable_array<FieldType>> &routing_output_bits);
                ...
                template<typename FieldType>
                as_waksman_routing_gadget<FieldType>::as_waksman_routing_gadget(
                ...
                template<typename FieldType>
                void as_waksman_routing_gadget<FieldType>::generate_r1cs_constraints() {
                    /* packing/unpacking */
                    for (std::size_t packet_idx = 0; packet_idx < num_packets; ++packet_idx) {
                ...
                template<typename FieldType>
                void as_waksman_routing_gadget<FieldType>::generate_r1cs_witness(
                ...
                void test_as_waksman_routing_gadget(const std::size_t num_packets, const std::size_t packet_size) {
                    ...
                    as_waksman_routing_gadget<FieldType> r(pb, num_packets, randbits, outbits);
