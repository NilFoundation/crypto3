...
#include <nil/crypto3/zk/snark/gadgets/cpu_checkers/tinyram/components/consistency_enforcer_gadget.hpp>
#include <nil/crypto3/zk/snark/gadgets/cpu_checkers/tinyram/components/memory_masking_gadget.hpp>
    ...
    namespace crypto3 {
        namespace zk {
            namespace snark {
                ...
                class tinyram_cpu_checker : public tinyram_standard_gadget<FieldType> {
                private:
                    ...
                    std::vector<word_variable_gadget<FieldType>> prev_registers;
                    std::vector<word_variable_gadget<FieldType>> next_registers;
                    pb_variable<FieldType> prev_flag;
                    pb_variable<FieldType> next_flag;
                    pb_variable<FieldType> prev_tape1_exhausted;
                    pb_variable<FieldType> next_tape1_exhausted;

                    std::shared_ptr<word_variable_gadget<FieldType>> prev_pc_addr_as_word_variable;
                    std::shared_ptr<word_variable_gadget<FieldType>> desval;
                    std::shared_ptr<word_variable_gadget<FieldType>> arg1val;
                    std::shared_ptr<word_variable_gadget<FieldType>> arg2val;

                    std::shared_ptr<argument_decoder_gadget<FieldType>> decode_arguments;
                    pb_variable_array<FieldType> opcode_indicators;
                    std::shared_ptr<ALU_gadget<FieldType>> ALU;

                    std::shared_ptr<doubleword_variable_gadget<FieldType>> ls_prev_val_as_doubleword_variable;
                    std::shared_ptr<doubleword_variable_gadget<FieldType>> ls_next_val_as_doubleword_variable;
                    std::shared_ptr<dual_variable_gadget<FieldType>> memory_subaddress;
                    pb_variable<FieldType> memory_subcontents;
                    pb_linear_combination<FieldType> memory_access_is_word;
                    pb_linear_combination<FieldType> memory_access_is_byte;
                    std::shared_ptr<memory_masking_gadget<FieldType>> check_memory;

                    std::shared_ptr<word_variable_gadget<FieldType>> next_pc_addr_as_word_variable;
                    std::shared_ptr<consistency_enforcer_gadget<FieldType>> consistency_enforcer;

                    pb_variable_array<FieldType> instruction_results;
                    pb_variable_array<FieldType> instruction_flags;

                    pb_variable<FieldType> read_not1;
                ...
                public:
                    ...
                    tinyram_cpu_checker(tinyram_protoboard<FieldType> &pb,
                                        pb_variable_array<FieldType> &prev_pc_addr,
                                        pb_variable_array<FieldType> &prev_pc_val,
                                        pb_variable_array<FieldType> &prev_state,
                                        pb_variable_array<FieldType> &ls_addr,
                ...
                template<typename FieldType>
                tinyram_cpu_checker<FieldType>::tinyram_cpu_checker(tinyram_protoboard<FieldType> &pb,
                                                                    pb_variable_array<FieldType> &prev_pc_addr,
                                                                    pb_variable_array<FieldType> &prev_pc_val,
                                                                    pb_variable_array<FieldType> &prev_state,
                                                                    pb_variable_array<FieldType> &ls_addr,
                    ...
                    for (std::size_t i = 0; i < pb.ap.k; ++i) {
                        ...
                        next_registers.emplace_back(word_variable_gadget<FieldType>(
                            pb,
                    ...
                    /* decode arguments */
                    prev_pc_addr_as_word_variable.reset(new word_variable_gadget<FieldType>(pb, prev_pc_addr));
                    desval.reset(new word_variable_gadget<FieldType>(pb));
                    arg1val.reset(new word_variable_gadget<FieldType>(pb));
                    arg2val.reset(new word_variable_gadget<FieldType>(pb));

                    decode_arguments.reset(new argument_decoder_gadget<FieldType>(
                    ...
                    ALU.reset(new ALU_gadget<FieldType>(pb, opcode_indicators, *prev_pc_addr_as_word_variable, *desval,
                    ...
                    ls_prev_val_as_doubleword_variable.reset(
                        new doubleword_variable_gadget<FieldType>(pb, ls_prev_val));
                    ls_next_val_as_doubleword_variable.reset(
                        new doubleword_variable_gadget<FieldType>(pb, ls_next_val));
                    memory_subaddress.reset(new dual_variable_gadget<FieldType>(
                        pb,
                    ...
                    check_memory.reset(new memory_masking_gadget<FieldType>(pb,
                    ...
                    next_pc_addr_as_word_variable.reset(new word_variable_gadget<FieldType>(pb, next_pc_addr));

                    consistency_enforcer.reset(new consistency_enforcer_gadget<FieldType>(
