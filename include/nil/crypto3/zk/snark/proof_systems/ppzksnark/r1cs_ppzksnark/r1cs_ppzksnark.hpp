        ...
        namespace zk {
            namespace snark {
                ...
                public:
                    ...
                    std::size_t size_in_bits() const {
                        return A_query.size_in_bits() + B_query.size_in_bits() + C_query.size_in_bits() +
                               H_query.size() * CurveType::g1_type::element_size + 
                               K_query.size() * CurveType::g1_type::element_size;
                    }
                ...
                public:
                    ...
                    std::size_t size_in_bits() const {
                        return (2 * CurveType::g1_type::element_size + encoded_IC_query.size_in_bits() +
                                5 * CurveType::g2_type::element_size);
                    }
                ...
                r1cs_ppzksnark_keypair<CurveType> r1cs_ppzksnark_generator(const r1cs_ppzksnark_constraint_system<CurveType> &cs) {
                    ...
                    knowledge_commitment_vector<typename CurveType::g1_type, typename CurveType::g1_type> A_query =
                        kc_batch_exp(typename CurveType::scalar_field_type::element_size, g1_window, g1_window, g1_table, g1_table, rA,
                                     rA * alphaA, At, chunks);

                    knowledge_commitment_vector<typename CurveType::g2_type, typename CurveType::g1_type> B_query =
                        kc_batch_exp(typename CurveType::scalar_field_type::element_size, g2_window, g1_window, g2_table, g1_table, rB,
                                     rB * alphaB, Bt, chunks);

                    knowledge_commitment_vector<typename CurveType::g1_type, typename CurveType::g1_type> C_query =
                        kc_batch_exp(typename CurveType::scalar_field_type::element_size, g1_window, g1_window, g1_table, g1_table, rC,
                                     rC * alphaC, Ct, chunks);

                    typename CurveType::g1_vector H_query =
                        batch_exp(typename CurveType::scalar_field_type::element_size, g1_window, g1_table, Ht);
#ifdef USE_MIXED_ADDITION
                    algebra::batch_to_special<typename CurveType::g1_type>(H_query);
#endif

                    typename CurveType::g1_vector K_query =
                        batch_exp(typename CurveType::scalar_field_type::element_size, g1_window, g1_table, Kt);
#ifdef USE_MIXED_ADDITION
                    ...
                    typename CurveType::g1_vector encoded_IC_values =
                        batch_exp(typename CurveType::scalar_field_type::element_size, g1_window, g1_table, multiplied_IC_coefficients);
