    ...
    namespace crypto3 {
        namespace zk {
            namespace snark {
                ...
                class r1cs_ppzksnark_proving_key {
                public:
                    knowledge_commitment_vector<algebra::G1<CurveType>, algebra::G1<CurveType>> A_query;
                    knowledge_commitment_vector<algebra::G2<CurveType>, algebra::G1<CurveType>> B_query;
                    knowledge_commitment_vector<algebra::G1<CurveType>, algebra::G1<CurveType>> C_query;
                    algebra::G1_vector<CurveType> H_query;
                    algebra::G1_vector<CurveType> K_query;
                ...
                class r1cs_ppzksnark_verification_key {
                public:
                    algebra::G2<CurveType> alphaA_g2;
                    algebra::G1<CurveType> alphaB_g1;
                    algebra::G2<CurveType> alphaC_g2;
                    algebra::G2<CurveType> gamma_g2;
                    algebra::G1<CurveType> gamma_beta_g1;
                    algebra::G2<CurveType> gamma_beta_g2;
                    algebra::G2<CurveType> rC_Z_g2;

                    accumulation_vector<algebra::G1<CurveType>> encoded_IC_query;

                    r1cs_ppzksnark_verification_key() = default;
                    r1cs_ppzksnark_verification_key(const algebra::G2<CurveType> &alphaA_g2,
                                                    const algebra::G1<CurveType> &alphaB_g1,
                                                    const algebra::G2<CurveType> &alphaC_g2,
                                                    const algebra::G2<CurveType> &gamma_g2,
                                                    const algebra::G1<CurveType> &gamma_beta_g1,
                                                    const algebra::G2<CurveType> &gamma_beta_g2,
                                                    const algebra::G2<CurveType> &rC_Z_g2,
                                                    const accumulation_vector<algebra::G1<CurveType>> &eIC) :
                        alphaA_g2(alphaA_g2),
                    ...
                    std::size_t size_in_bits() const {
                        return (2 * algebra::G1<CurveType>::size_in_bits() + encoded_IC_query.size_in_bits() +
                                5 * algebra::G2<CurveType>::size_in_bits());
                    }
                ...
                class r1cs_ppzksnark_proof {
                public:
                    knowledge_commitment<algebra::G1<CurveType>, algebra::G1<CurveType>> g_A;
                    knowledge_commitment<algebra::G2<CurveType>, algebra::G1<CurveType>> g_B;
                    knowledge_commitment<algebra::G1<CurveType>, algebra::G1<CurveType>> g_C;
                    algebra::G1<CurveType> g_H;
                    algebra::G1<CurveType> g_K;

                    r1cs_ppzksnark_proof() {
                        // invalid proof with valid curve points
                        this->g_A.g = algebra::G1<CurveType>::one();
                        this->g_A.h = algebra::G1<CurveType>::one();
                        this->g_B.g = algebra::G2<CurveType>::one();
                        this->g_B.h = algebra::G1<CurveType>::one();
                        this->g_C.g = algebra::G1<CurveType>::one();
                        this->g_C.h = algebra::G1<CurveType>::one();
                        this->g_H = algebra::G1<CurveType>::one();
                        this->g_K = algebra::G1<CurveType>::one();
                    }
                    r1cs_ppzksnark_proof(knowledge_commitment<algebra::G1<CurveType>, algebra::G1<CurveType>> &&g_A,
                                         knowledge_commitment<algebra::G2<CurveType>, algebra::G1<CurveType>> &&g_B,
                                         knowledge_commitment<algebra::G1<CurveType>, algebra::G1<CurveType>> &&g_C,
                                         algebra::G1<CurveType> &&g_H,
                                         algebra::G1<CurveType> &&g_K) :
                ...
                r1cs_ppzksnark_verification_key<CurveType>
                    ...
                    result.alphaA_g2 = typename CurveType::scalar_field_type::random_element() * algebra::G2<CurveType>::one();
                    result.alphaB_g1 = typename CurveType::scalar_field_type::random_element() * algebra::G1<CurveType>::one();
                    result.alphaC_g2 = typename CurveType::scalar_field_type::random_element() * algebra::G2<CurveType>::one();
                    result.gamma_g2 = typename CurveType::scalar_field_type::random_element() * algebra::G2<CurveType>::one();
                    result.gamma_beta_g1 = typename CurveType::scalar_field_type::random_element() * algebra::G1<CurveType>::one();
                    result.gamma_beta_g2 = typename CurveType::scalar_field_type::random_element() * algebra::G2<CurveType>::one();
                    result.rC_Z_g2 = typename CurveType::scalar_field_type::random_element() * algebra::G2<CurveType>::one();

                    algebra::G1<CurveType> base = typename CurveType::scalar_field_type::random_element() * algebra::G1<CurveType>::one();
                    ...
                    result.encoded_IC_query = accumulation_vector<algebra::G1<CurveType>>(std::move(base), std::move(v));
                ...
                r1cs_ppzksnark_keypair<CurveType> r1cs_ppzksnark_generator(const r1cs_ppzksnark_constraint_system<CurveType> &cs) {
                    ...
                    std::size_t g1_window = algebra::get_exp_window_size<algebra::G1<CurveType>>(g1_exp_count);
                    std::size_t g2_window = algebra::get_exp_window_size<algebra::G2<CurveType>>(g2_exp_count);
                    ...
                    algebra::window_table<algebra::G1<CurveType>> g1_table =
                        get_window_table(typename CurveType::scalar_field_type::size_in_bits(), g1_window, algebra::G1<CurveType>::one());

                    algebra::window_table<algebra::G2<CurveType>> g2_table =
                        get_window_table(typename CurveType::scalar_field_type::size_in_bits(), g2_window, algebra::G2<CurveType>::one());
                    ...
                    algebra::batch_to_special<algebra::G1<CurveType>>(H_query);
#endif

                    algebra::G1_vector<CurveType> K_query =
                        batch_exp(typename CurveType::scalar_field_type::size_in_bits(), g1_window, g1_table, Kt);
#ifdef USE_MIXED_ADDITION
                    algebra::batch_to_special<algebra::G1<CurveType>>(K_query);
#endif

                    algebra::G2<CurveType> alphaA_g2 = alphaA * algebra::G2<CurveType>::one();
                    algebra::G1<CurveType> alphaB_g1 = alphaB * algebra::G1<CurveType>::one();
                    algebra::G2<CurveType> alphaC_g2 = alphaC * algebra::G2<CurveType>::one();
                    algebra::G2<CurveType> gamma_g2 = gamma * algebra::G2<CurveType>::one();
                    algebra::G1<CurveType> gamma_beta_g1 = (gamma * beta) * algebra::G1<CurveType>::one();
                    algebra::G2<CurveType> gamma_beta_g2 = (gamma * beta) * algebra::G2<CurveType>::one();
                    algebra::G2<CurveType> rC_Z_g2 = (rC * qap_inst.Zt) * algebra::G2<CurveType>::one();

                    algebra::G1<CurveType> encoded_IC_base = (rA * IC_coefficients[0]) * algebra::G1<CurveType>::one();
                    ...
                    algebra::G1_vector<CurveType> encoded_IC_values =
                        batch_exp(typename CurveType::scalar_field_type::size_in_bits(), g1_window, g1_table, multiplied_IC_coefficients);

                    accumulation_vector<algebra::G1<CurveType>> encoded_IC_query(std::move(encoded_IC_base),
                ...
                r1cs_ppzksnark_proof<CurveType>
                    ...
                    algebra::G1<CurveType> g_H = algebra::G1<CurveType>::zero();
                    algebra::G1<CurveType> g_K = (pk.K_query[0] + qap_wit.d1 * pk.K_query[qap_wit.num_variables() + 1] +
                    ...
                    g_A = g_A + kc_multi_exp_with_mixed_addition<algebra::G1<CurveType>, algebra::G1<CurveType>, typename CurveType::scalar_field_type,
                    ...
                    g_B = g_B + kc_multi_exp_with_mixed_addition<algebra::G2<CurveType>, algebra::G1<CurveType>, typename CurveType::scalar_field_type,
                                                                 algebra::multi_exp_method_bos_coster>(
                                    pk.B_query, 1, 1 + qap_wit.num_variables(), qap_wit.coefficients_for_ABCs.begin(),
                                    qap_wit.coefficients_for_ABCs.begin() + qap_wit.num_variables(), chunks);

                    g_C = g_C + kc_multi_exp_with_mixed_addition<algebra::G1<CurveType>, algebra::G1<CurveType>, typename CurveType::scalar_field_type,
                                                                 algebra::multi_exp_method_bos_coster>(
                                    pk.C_query, 1, 1 + qap_wit.num_variables(), qap_wit.coefficients_for_ABCs.begin(),
                                    qap_wit.coefficients_for_ABCs.begin() + qap_wit.num_variables(), chunks);

                    g_H =
                        g_H + algebra::multi_exp<algebra::G1<CurveType>, typename CurveType::scalar_field_type, algebra::multi_exp_method_BDLO12>(
                                  pk.H_query.begin(), pk.H_query.begin() + qap_wit.degree() + 1,
                                  qap_wit.coefficients_for_H.begin(),
                                  qap_wit.coefficients_for_H.begin() + qap_wit.degree() + 1, chunks);

                    g_K = g_K + algebra::multi_exp_with_mixed_addition<algebra::G1<CurveType>, typename CurveType::scalar_field_type,
                                                                       algebra::multi_exp_method_bos_coster>(
                ...
                r1cs_ppzksnark_processed_verification_key<CurveType>
                    ...
                    pvk.pp_G2_one_precomp = CurveType::precompute_G2(algebra::G2<CurveType>::one());
                ...
                bool r1cs_ppzksnark_online_verifier_weak_IC(const r1cs_ppzksnark_processed_verification_key<CurveType> &pvk,
                    ...
                    const accumulation_vector<algebra::G1<CurveType>> accumulated_IC =
                        pvk.encoded_IC_query.template accumulate_chunk<typename CurveType::scalar_field_type>(primary_input.begin(),
                                                                                         primary_input.end(), 0);
                    const algebra::G1<CurveType> &acc = accumulated_IC.first;
                    ...
                    algebra::Fqk<CurveType> kc_A_1 = CurveType::miller_loop(proof_g_A_g_precomp, pvk.vk_alphaA_g2_precomp);
                    algebra::Fqk<CurveType> kc_A_2 = CurveType::miller_loop(proof_g_A_h_precomp, pvk.pp_G2_one_precomp);
                    algebra::GT<CurveType> kc_A = CurveType::final_exponentiation(kc_A_1 * kc_A_2.unitary_inverse());
                    if (kc_A != algebra::GT<CurveType>::one()) {
                        result = false;
                    }
                    ...
                    algebra::Fqk<CurveType> kc_B_1 = CurveType::miller_loop(pvk.vk_alphaB_g1_precomp, proof_g_B_g_precomp);
                    algebra::Fqk<CurveType> kc_B_2 = CurveType::miller_loop(proof_g_B_h_precomp, pvk.pp_G2_one_precomp);
                    algebra::GT<CurveType> kc_B = CurveType::final_exponentiation(kc_B_1 * kc_B_2.unitary_inverse());
                    if (kc_B != algebra::GT<CurveType>::one()) {
                        result = false;
                    }
                    ...
                    algebra::Fqk<CurveType> kc_C_1 = CurveType::miller_loop(proof_g_C_g_precomp, pvk.vk_alphaC_g2_precomp);
                    algebra::Fqk<CurveType> kc_C_2 = CurveType::miller_loop(proof_g_C_h_precomp, pvk.pp_G2_one_precomp);
                    algebra::GT<CurveType> kc_C = CurveType::final_exponentiation(kc_C_1 * kc_C_2.unitary_inverse());
                    if (kc_C != algebra::GT<CurveType>::one()) {
                        result = false;
                    }
                    ...
                    algebra::Fqk<CurveType> QAP_1 = CurveType::miller_loop(proof_g_A_g_acc_precomp, proof_g_B_g_precomp);
                    algebra::Fqk<CurveType> QAP_23 = CurveType::double_miller_loop(proof_g_H_precomp, pvk.vk_rC_Z_g2_precomp,
                                                                       proof_g_C_g_precomp, pvk.pp_G2_one_precomp);
                    algebra::GT<CurveType> QAP = CurveType::final_exponentiation(QAP_1 * QAP_23.unitary_inverse());
                    if (QAP != algebra::GT<CurveType>::one()) {
                        result = false;
                    }
                    ...
                    algebra::Fqk<CurveType> K_1 = CurveType::miller_loop(proof_g_K_precomp, pvk.vk_gamma_g2_precomp);
                    algebra::Fqk<CurveType> K_23 =
                        CurveType::double_miller_loop(proof_g_A_g_acc_C_precomp, pvk.vk_gamma_beta_g2_precomp,
                                                pvk.vk_gamma_beta_g1_precomp, proof_g_B_g_precomp);
                    algebra::GT<CurveType> K = CurveType::final_exponentiation(K_1 * K_23.unitary_inverse());
                    if (K != algebra::GT<CurveType>::one()) {
                        result = false;
                    }
                ...
                bool r1cs_ppzksnark_affine_verifier_weak_IC(const r1cs_ppzksnark_verification_key<CurveType> &vk,
                    ...
                    algebra::affine_ate_G2_precomp<CurveType> pvk_pp_G2_one_precomp =
                        CurveType::affine_ate_precompute_G2(algebra::G2<CurveType>::one());
                    ...
                    algebra::GT<CurveType> kc_A = CurveType::final_exponentiation(kc_A_miller);
                    ...
                    algebra::GT<CurveType> kc_B = CurveType::final_exponentiation(kc_B_miller);
                    if (kc_B != algebra::GT<CurveType>::one()) {
                        result = false;
                    }
                    ...
                    algebra::GT<CurveType> kc_C = CurveType::final_exponentiation(kc_C_miller);
                    if (kc_C != algebra::GT<CurveType>::one()) {
                        result = false;
                    }
                    ...
                    algebra::GT<CurveType> QAP = CurveType::final_exponentiation(QAP_miller);
                    if (QAP != algebra::GT<CurveType>::one()) {
                        result = false;
                    }
                    ...
                    algebra::GT<CurveType> K = CurveType::final_exponentiation(K_miller);
                    if (K != algebra::GT<CurveType>::one()) {
                        result = false;
                    }
