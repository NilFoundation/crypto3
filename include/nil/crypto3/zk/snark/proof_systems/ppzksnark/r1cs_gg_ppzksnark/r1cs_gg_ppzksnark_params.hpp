    ...
    namespace crypto3 {
        namespace zk {
            namespace snark {
                ...
                using r1cs_gg_ppzksnark_constraint_system = r1cs_constraint_system<algebra::Fr<ppT>>;

                template<typename ppT>
                using r1cs_gg_ppzksnark_primary_input = r1cs_primary_input<algebra::Fr<ppT>>;

                template<typename ppT>
                using r1cs_gg_ppzksnark_auxiliary_input = r1cs_auxiliary_input<algebra::Fr<ppT>>;
