        ...
        namespace zk {
            namespace snark {
                ...
                public:
                    ...
                    friend std::istream &operator>><CurveType>(std::istream &in, r1cs_ppzkadsnark_pub_auth_prms<CurveType> &pap);
                };
                ...
                public:
                    ...
                    r1cs_ppzkadsnark_sec_auth_key(CurveType::scalar_field_type::value_type &&i, r1cs_ppzkadsnark_skT<CurveType> &&skp,
                                                  r1cs_ppzkadsnark_prfKeyT<CurveType> &&S) :
                        i(std::move(i)),
                    ...
                    friend std::istream &operator>><CurveType>(std::istream &in, r1cs_ppzkadsnark_sec_auth_key<CurveType> &key);
                };
                ...
                public:
                    ...
                    friend std::istream &operator>><CurveType>(std::istream &in, r1cs_ppzkadsnark_pub_auth_key<CurveType> &key);
                };
                ...
                public:
                    ...
                    friend std::ostream &operator<<<CurveType>(std::ostream &out, const r1cs_ppzkadsnark_auth_data<CurveType> &key);
                    friend std::istream &operator>><CurveType>(std::istream &in, r1cs_ppzkadsnark_auth_data<CurveType> &key);
                };
                ...
                public:
                    ...
                    friend std::istream &operator>><CurveType>(std::istream &in, r1cs_ppzkadsnark_proving_key<CurveType> &pk);
                };
                ...
                public:
                    ...
                    friend std::istream &operator>><CurveType>(std::istream &in, r1cs_ppzkadsnark_verification_key<CurveType> &vk);

                    static r1cs_ppzkadsnark_verification_key<CurveType> dummy_verification_key(const std::size_t input_size);
                };
                ...
                public:
                    ...
                    friend std::ostream &operator<<<CurveType>(std::ostream &out, const r1cs_ppzkadsnark_proof<CurveType> &proof);
                    friend std::istream &operator>><CurveType>(std::istream &in, r1cs_ppzkadsnark_proof<CurveType> &proof);
                };
                ...
                */
                ...
                template<typename CurveType>
                bool r1cs_ppzkadsnark_auth_data<CurveType>::operator==(const r1cs_ppzkadsnark_auth_data<CurveType> &other) const {
                ...
                template<typename CurveType>
                bool r1cs_ppzkadsnark_proof<CurveType>::operator==(const r1cs_ppzkadsnark_proof<CurveType> &other) const {
                ...
                r1cs_ppzkadsnark_verification_key<CurveType>
                    ...
                    result.alphaA_g2 = random_element<CurveType::scalar_field_type>() * CurveType::g2_type::one();
                    result.alphaB_g1 = random_element<CurveType::scalar_field_type>() * CurveType::g1_type::one();
                    result.alphaC_g2 = random_element<CurveType::scalar_field_type>() * CurveType::g2_type::one();
                    result.gamma_g2 = random_element<CurveType::scalar_field_type>() * CurveType::g2_type::one();
                    result.gamma_beta_g1 =
                        random_element<CurveType::scalar_field_type>() * CurveType::g1_type::one();
                    result.gamma_beta_g2 =
                        random_element<CurveType::scalar_field_type>() * CurveType::g2_type::one();
                    result.rC_Z_g2 = random_element<CurveType::scalar_field_type>() * CurveType::g2_type::one();

                    result.A0 = random_element<CurveType::scalar_field_type>() * CurveType::g1_type::one();
                ...
                r1cs_ppzkadsnark_auth_keys<CurveType> r1cs_ppzkadsnark_auth_generator(void) {
                    ...
                    return r1cs_ppzkadsnark_auth_keys<CurveType>(
                        ...
                        r1cs_ppzkadsnark_sec_auth_key<CurveType>(std::move(i), std::move(sigkp.sk), std::move(prfseed)));
                }
                ...
                r1cs_ppzkadsnark_keypair<CurveType>
                    ...
                    const CurveType::scalar_field_type::value_type alphaA = random_element<CurveType::scalar_field_type::value_type>(),
                    ...
                    algebra::window_table<CurveType::g1_type> g1_table = get_window_table(
                        CurveType::scalar_field_type::value_type::size_in_bits(), g1_window, CurveType::g1_type::one());

                    algebra::window_table<CurveType::g2_type> g2_table = get_window_table(
                        CurveType::scalar_field_type::value_type::size_in_bits(), g2_window, CurveType::g2_type::one());
                    ...
                    knowledge_commitment_vector<CurveType::g2_type, CurveType::g1_type> B_query =
                        kc_batch_exp(CurveType::scalar_field_type::value_type::size_in_bits(), g2_window, g1_window, g2_table,
                    ...
                    r1cs_ppzkadsnark_proving_key<CurveType> pk = r1cs_ppzkadsnark_proving_key<CurveType>(std::move(A_query),
                                                                                             std::move(B_query),
                                                                                             std::move(C_query),
                                                                                             std::move(H_query),
                                                                                             std::move(K_query),
                ...
                bool r1cs_ppzkadsnark_online_verifier(const r1cs_ppzkadsnark_processed_verification_key<CurveType> &pvk,
                    ...
                    snark_pp<CurveType>::gt_type K = snark_pp<CurveType>::final_exponentiation(K_1 * K_23.unitary_inverse());
