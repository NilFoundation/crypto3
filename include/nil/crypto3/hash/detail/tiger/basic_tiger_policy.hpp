    ...
    namespace crypto3 {
        namespace hash {
            namespace detail {
                ...
                template<std::size_t DigestBits> constexpr const typename basic_tiger_policy<
                        DigestBits>::substitution_type basic_tiger_policy<DigestBits>::sbox1;

                template<std::size_t DigestBits> constexpr const typename basic_tiger_policy<
                        DigestBits>::substitution_type basic_tiger_policy<DigestBits>::sbox2;

                template<std::size_t DigestBits> constexpr const typename basic_tiger_policy<
                        DigestBits>::substitution_type basic_tiger_policy<DigestBits>::sbox3;

                template<std::size_t DigestBits> constexpr const typename basic_tiger_policy<
                        DigestBits>::substitution_type basic_tiger_policy<DigestBits>::sbox4;
            }
        }
    }
}
