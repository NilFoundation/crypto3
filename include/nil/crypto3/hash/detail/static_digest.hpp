...
#ifndef CRYPTO3_HASH_DIGEST_HPP
#define CRYPTO3_HASH_DIGEST_HPP
...
namespace std {
    template<std::size_t DigestBits>
    std::string to_string(const nil::crypto3::hash::static_digest<DigestBits> &d) {
        std::array<char, DigestBits / 4 + 1> cstr = nil::crypto3::hash::detail::c_str(d);
