        ...
        namespace hashes {
            namespace detail {
                ...
                struct poseidon_mds_matrix {
                    ...
                    typedef algebra::matrix<element_type, state_words, state_words> mds_matrix_type_cotila;
                    typedef algebra::vector<element_type, state_words> state_vector_type_cotila;
                    typedef algebra::vector<element_type, state_words - 1> substate_vector_type_cotila;
                    typedef algebra::matrix<element_type, state_words - 1, state_words - 1> submatrix_type_cotila;
                    ...
                    typedef std::tuple<mds_matrix_type, element_type, subvectors_collection, subvectors_collection>
                        equivalent_mds_matrix_type;
                    typedef std::tuple<mds_matrix_type_cotila, element_type, subvectors_collection_cotila,
                                       subvectors_collection_cotila>
                        equivalent_mds_matrix_type_cotila;
                    ...
                    static inline state_vector_type_cotila vect_matr_mul(const state_vector_type_cotila &A_vect,
                                                                         const mds_matrix_type_cotila &matr) {
                        typedef cotila::matrix<element_type, 1, state_words> state_vect_by_matr_type_cotila;
                    ...
                    static inline element_type inner_prod_cotila(const state_vector_type_cotila &A_vect,
                                                                 const state_vector_type_cotila &B_vect) {
                        element_type res(0);
                        for (std::size_t i = 0; i < state_words; i++) {
                    ...
                    static inline void product_with_inverse_mds_matrix_noalias(const state_vector_type &A_vector_in,
                        ...
                        // BOOST_ASSERT_MSG(&A_vector_in != &A_vector_out, "wrong using:
                        // product_with_inverse_mds_matrix_noalias"); boost::numeric::ublas::noalias(A_vector_out) =
                        // boost::numeric::ublas::prod(A_vector_in, get_inverse_mds_matrix());
                        state_vector_type_cotila A_vector_cotila;
                    ...
                    static inline void product_with_equivalent_mds_matrix_init(state_vector_type &A_vector,
                        ...
                        to_cotila(A_vector, A_vector_cotila);
                        A_vector_cotila =
                            vect_matr_mul(A_vector_cotila, std::get<M_i>(get_equivalent_mds_matrix_cotila()));
                        from_cotila(A_vector_cotila, A_vector);
                    }
                    ...
                    static inline void product_with_equivalent_mds_matrix(state_vector_type &A_vector,
                        ...
                        element_type A_0_cotila = A_vector_cotila[0];
                        ...
                        static const mds_matrix_type_cotila mds_matrix_cotila = []() {
                            ...
                            for (std::size_t i = 0; i < state_words; i++) {
                                for (std::size_t j = 0; j < state_words; j++) {
                                    mds_matrix_cotila[i][j] = element_type(i + j + Arity).get_inverse();
                                }
                            }
                    ...
                    static inline const equivalent_mds_matrix_type_cotila &get_equivalent_mds_matrix_cotila() {
                        static const equivalent_mds_matrix_type_cotila equivalent_mds_matrix_cotila = []() {
                            ...
                            mds_matrix_type_cotila M_i = cotila::identity<element_type, state_words>;
                            ...
                            return equivalent_mds_matrix_type_cotila {M_i, get_mds_matrix_cotila()[0][0], w_hat_list,
                                                                      v_list};
                        }();
                    ...
                    static inline const element_type &get_M_0_0_cotila() {
