...
// values for rotate left
                ...
                template<std::size_t DigestSize> constexpr typename basic_ripemd_policy<
                        DigestSize>::key_indexes_type const basic_ripemd_policy<DigestSize>::r1;

                template<std::size_t DigestSize> constexpr typename basic_ripemd_policy<
                        DigestSize>::key_indexes_type const basic_ripemd_policy<DigestSize>::r2;

                template<std::size_t DigestSize> constexpr typename basic_ripemd_policy<
                        DigestSize>::key_indexes_type const basic_ripemd_policy<DigestSize>::s1;

                template<std::size_t DigestSize> constexpr typename basic_ripemd_policy<
                        DigestSize>::key_indexes_type const basic_ripemd_policy<DigestSize>::s2;
                ...
                struct ripemd_policy<256> : public basic_ripemd_policy<256> {
                    ...
                    struct iv_generator {
                        state_type const &operator()() const {
                            static state_type const H0 = {{0x67452301, 0xefcdab89, 0x98badcfe, 0x10325476, 0x76543210, 0xfedcba98, 0x89abcdef, 0x01234567}};
                            return H0;
                        }
                    };
                };
                ...
                struct ripemd_policy<320> : public basic_ripemd_policy<320> {
                    ...
                    struct iv_generator {
                        state_type const &operator()() const {
                            static state_type const H0 = {{0x67452301, 0xefcdab89, 0x98badcfe, 0x10325476, 0xc3d2e1f0, 0x76543210, 0xfedcba98, 0x89abcdef, 0x01234567, 0x3c2d1e0f}};
                            return H0;
                        }
                    };
                };
