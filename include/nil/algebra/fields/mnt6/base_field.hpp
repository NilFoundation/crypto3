...
#ifndef ALGEBRA_FIELDS_MNT6_BASE_FIELD_HPP
#define ALGEBRA_FIELDS_MNT6_BASE_FIELD_HPP
    ...
    namespace algebra {
        namespace fields {
            ...
            struct mnt6_base_field<298, CHAR_BIT> : public field<298, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<params<mnt6_base_field<298, CHAR_BIT>>>
                    value_type;
