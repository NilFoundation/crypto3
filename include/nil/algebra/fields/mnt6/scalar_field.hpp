    ...
    namespace algebra {
        namespace fields {
            ...
            struct mnt6_scalar_field<298, CHAR_BIT> : public field<298, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<detail::extension_params<mnt6_scalar_field<298, CHAR_BIT>>> value_type;

                constexpr static const std::size_t arity = 1;
            };

            constexpr typename mnt6_scalar_field<298, CHAR_BIT>::modulus_type const mnt6_scalar_field<298, CHAR_BIT>::modulus;

            constexpr typename mnt6_scalar_field<298, CHAR_BIT>::generator_type const mnt6_scalar_field<298, CHAR_BIT>::mul_generator;

            template<std::size_t ModulusBits = 298, std::size_t GeneratorBits = CHAR_BIT>
            using mn6_fr = mn6_scalar_field<ModulusBits, GeneratorBits>;
