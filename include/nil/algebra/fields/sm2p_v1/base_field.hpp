...
#ifndef ALGEBRA_FIELDS_SM2P_V1_BASE_FIELD_HPP
#define ALGEBRA_FIELDS_SM2P_V1_BASE_FIELD_HPP
    ...
    namespace algebra {
        namespace fields {
            ...
            struct sm2p_v1_base_field<256, CHAR_BIT> : public field<256, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<params<sm2p_v1_base_field<256, CHAR_BIT>>>
                    value_type;
