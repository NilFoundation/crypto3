    ...
    namespace algebra {
        namespace fields {
            ...
            struct edwards_scalar_field<181, CHAR_BIT> : public field<181, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<detail::extension_params<edwards_scalar_field<181, CHAR_BIT>>> value_type;

                constexpr static const std::size_t arity = 1;
            };

            constexpr typename edwards_scalar_field<181, CHAR_BIT>::modulus_type const edwards_scalar_field<181, CHAR_BIT>::modulus;

            constexpr typename edwards_scalar_field<181, CHAR_BIT>::generator_type const edwards_scalar_field<181, CHAR_BIT>::mul_generator;
