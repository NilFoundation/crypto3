    ...
    namespace algebra {
        namespace fields {
            ...
            struct brainpool_r1_fr<160, CHAR_BIT> : public field<160, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<detail::extension_params<brainpool_r1_fr<160, CHAR_BIT>>>
                    value_type;
            ...
            template<>
            struct brainpool_r1_fr<192, CHAR_BIT> : public field<192, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<detail::extension_params<brainpool_r1_fr<192, CHAR_BIT>>>
                    value_type;
            ...
            template<>
            struct brainpool_r1_fr<224, CHAR_BIT> : public field<224, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<detail::extension_params<brainpool_r1_fr<224, CHAR_BIT>>>
                    value_type;
            ...
            template<>
            struct brainpool_r1_fr<256, CHAR_BIT> : public field<256, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<detail::extension_params<brainpool_r1_fr<256, CHAR_BIT>>>
                    value_type;
            ...
            template<>
            struct brainpool_r1_fr<320, CHAR_BIT> : public field<320, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<detail::extension_params<brainpool_r1_fr<320, CHAR_BIT>>>
                    value_type;
            ...
            template<>
            struct brainpool_r1_fr<384, CHAR_BIT> : public field<384, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<detail::extension_params<brainpool_r1_fr<384, CHAR_BIT>>>
                    value_type;
            ...
            template<>
            struct brainpool_r1_fr<512, CHAR_BIT> : public field<512, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<detail::extension_params<brainpool_r1_fr<512, CHAR_BIT>>>
                    value_type;
