...
namespace nil {
    namespace algebra {
        namespace fields {
            ...
            constexpr
                typename brainpool_r1_base_field<160, CHAR_BIT>::modulus_type const brainpool_r1_base_field<160, CHAR_BIT>::modulus;
            constexpr
                typename brainpool_r1_base_field<192, CHAR_BIT>::modulus_type const brainpool_r1_base_field<192, CHAR_BIT>::modulus;
            constexpr
                typename brainpool_r1_base_field<224, CHAR_BIT>::modulus_type const brainpool_r1_base_field<224, CHAR_BIT>::modulus;
            constexpr
                typename brainpool_r1_base_field<256, CHAR_BIT>::modulus_type const brainpool_r1_base_field<256, CHAR_BIT>::modulus;
            constexpr
                typename brainpool_r1_base_field<320, CHAR_BIT>::modulus_type const brainpool_r1_base_field<320, CHAR_BIT>::modulus;
            constexpr
                typename brainpool_r1_base_field<384, CHAR_BIT>::modulus_type const brainpool_r1_base_field<384, CHAR_BIT>::modulus;
            constexpr
                typename brainpool_r1_base_field<512, CHAR_BIT>::modulus_type const brainpool_r1_base_field<512, CHAR_BIT>::modulus;
