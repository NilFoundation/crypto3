...
namespace nil {
    namespace algebra {
        namespace fields {
            ...
            constexpr typename brainpool_r1_scalar_field<192, CHAR_BIT>::generator_type const
                brainpool_r1_scalar_field<192, CHAR_BIT>::mul_generator;
            constexpr typename brainpool_r1_scalar_field<224, CHAR_BIT>::generator_type const
                brainpool_r1_scalar_field<224, CHAR_BIT>::mul_generator;
            constexpr typename brainpool_r1_scalar_field<256, CHAR_BIT>::generator_type const
                brainpool_r1_scalar_field<256, CHAR_BIT>::mul_generator;
            constexpr typename brainpool_r1_scalar_field<320, CHAR_BIT>::generator_type const
                brainpool_r1_scalar_field<320, CHAR_BIT>::mul_generator;
            constexpr typename brainpool_r1_scalar_field<384, CHAR_BIT>::generator_type const
                brainpool_r1_scalar_field<384, CHAR_BIT>::mul_generator;
            constexpr typename brainpool_r1_scalar_field<512, CHAR_BIT>::generator_type const
                brainpool_r1_scalar_field<512, CHAR_BIT>::mul_generator;
