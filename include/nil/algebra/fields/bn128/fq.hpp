...
namespace nil {
    namespace algebra {
        namespace fields {
            ...
            struct bn128_fq : public field<ModulusBits, GeneratorBits> { };

            template<>
            struct bn128_fq<254, CHAR_BIT> : public field<254, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<detail::extension_params<bn128_fq<254, CHAR_BIT>>> value_type;
