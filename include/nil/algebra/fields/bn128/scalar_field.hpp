...
#ifndef ALGEBRA_FIELDS_BN128_SCALAR_FIELD_HPP
#define ALGEBRA_FIELDS_BN128_SCALAR_FIELD_HPP
    ...
    namespace algebra {
        namespace fields {
            ...
            struct bn128_scalar_field<254, CHAR_BIT> : public field<254, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<params<bn128_scalar_field<254, CHAR_BIT>>>
                    value_type;
