    ...
    namespace algebra {
        namespace fields {
            namespace detail {
                ...
                struct element_fp4: public element<fp4<ModulusBits, GeneratorBits>> {
                private:
                    typedef element<fp4<ModulusBits, GeneratorBits>> policy_type;
                public:
                    ...
                    inline static element_fp4 zero() const {
                        return {underlying_type::zero(), underlying_type::zero()};
                    }

                    inline static element_fp4 one() const {
                ...
                private:
                    inline static underlying_type mul_by_non_residue(const underlying_type &A){
                        return {non_residue * A.data[1], A.data[0]};
                    }
