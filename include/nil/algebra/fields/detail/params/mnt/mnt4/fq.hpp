            ...
            namespace detail {
                ...
                public:
                    ...
                    constexpr static const modulus_type q =
                        0x1DE7BDE6A39D133124ED3D82A47657764B1AE7A20CA7DA4A603C92EB569DDA19A5200000000_cppui254;
                ...
                template<std::size_t ModulusBits, std::size_t GeneratorBits>
                constexpr std::array<typename params<mnt4_fq<ModulusBits, GeneratorBits>>::modulus_type, 2> const arithmetic_params<mnt4_fq<ModulusBits, GeneratorBits>>::fp6_3over2_non_residue;

                template<std::size_t ModulusBits, std::size_t GeneratorBits>
                constexpr std::array<typename params<mnt4_fq<ModulusBits, GeneratorBits>>::modulus_type, 2> const arithmetic_params<mnt4_fq<ModulusBits, GeneratorBits>>::fp12_2over3over2_non_residue;
