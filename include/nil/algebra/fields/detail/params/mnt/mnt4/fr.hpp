    ...
    namespace algebra {
        namespace fields {
            namespace detail {
                ...
                struct arithmetic_params<mnt4_fr<ModulusBits, GeneratorBits>> : public params<mnt4_fr<ModulusBits, GeneratorBits>> {
                private:
                ...
                public:
                    ...
                    constexpr static const number_type q =
                        0x183227397098D014DC2822DB40C0AC2E9419F4243CDCB848A1F0FAC9F8000000_cppui297;
                ...
                template<std::size_t ModulusBits, std::size_t GeneratorBits>
                constexpr typename params<mnt4_fr<ModulusBits, GeneratorBits>>::number_type const arithmetic_params<mnt4_fr<ModulusBits, GeneratorBits>>::fp2_non_residue;

                template<std::size_t ModulusBits, std::size_t GeneratorBits>
                constexpr std::array<typename params<mnt4_fr<ModulusBits, GeneratorBits>>::number_type, 2> const arithmetic_params<mnt4_fr<ModulusBits, GeneratorBits>>::fp6_3over2_non_residue;

                template<std::size_t ModulusBits, std::size_t GeneratorBits>
                constexpr std::array<typename params<mnt4_fr<ModulusBits, GeneratorBits>>::number_type, 2> const arithmetic_params<mnt4_fr<ModulusBits, GeneratorBits>>::fp12_2over3over2_non_residue;
