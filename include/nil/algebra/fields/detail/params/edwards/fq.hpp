    ...
    namespace algebra {
        namespace fields {
            namespace detail {
                ...
                struct arithmetic_params<edwards_fq<ModulusBits, GeneratorBits>> : public params<edwards_fq<ModulusBits, GeneratorBits>> {
                private:
                ...
                template<std::size_t ModulusBits, std::size_t GeneratorBits>
                constexpr typename params<edwards_fq<ModulusBits, GeneratorBits>>::modulus_type const arithmetic_params<edwards_fq<ModulusBits, GeneratorBits>>::fp2_non_residue;

                template<std::size_t ModulusBits, std::size_t GeneratorBits>
                constexpr typename params<edwards_fq<ModulusBits, GeneratorBits>>::modulus_type const arithmetic_params<edwards_fq<ModulusBits, GeneratorBits>>::fp3_non_residue;
