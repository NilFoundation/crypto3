    ...
    namespace algebra {
        namespace fields {
            namespace detail {
                ...
                struct extension_params<mnt4_scalar_field<ModulusBits, GeneratorBits>>
                ...
                private:
                    ...
                    typedef extension_params<mnt4_scalar_field<ModulusBits, GeneratorBits>> element_policy_type;
