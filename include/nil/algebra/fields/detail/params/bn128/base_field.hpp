        ...
        namespace fields {
            namespace detail {
                ...
                constexpr typename params<bn128_base_field<ModulusBits, GeneratorBits>>::modulus_type const
                    extension_params<bn128_base_field<ModulusBits, GeneratorBits>>::fp2::non_residue;

                template<std::size_t ModulusBits, std::size_t GeneratorBits>
                constexpr std::array<typename params<bn128_base_field<ModulusBits, GeneratorBits>>::modulus_type,
                                     2> const
                    extension_params<bn128_base_field<ModulusBits, GeneratorBits>>::fp6_3over2::non_residue;

                template<std::size_t ModulusBits, std::size_t GeneratorBits>
                constexpr std::array<typename params<bn128_base_field<ModulusBits, GeneratorBits>>::modulus_type,
                                     2> const
                    extension_params<bn128_base_field<ModulusBits, GeneratorBits>>::fp12_2over3over2::non_residue;
