    ...
    namespace algebra {
        namespace fields {
            namespace detail {
                ...
                template<>
                struct extension_params<bls12_fq<381, CHAR_BIT>>
                    : public params<bls12_fq<381, CHAR_BIT>> {
                private:
                ...
                template<>
                struct extension_params<bls12_fq<377, CHAR_BIT>>
                    : public params<bls12_fq<377, CHAR_BIT>> {
                private:
