    ...
    namespace algebra {
        namespace fields {
            namespace detail {
                ...
                template<>
                class fp2_extension_params<fields::bn128<381, CHAR_BIT>>
                    : public params<fields::bn128<381, CHAR_BIT>> {

                    typedef params<fields::bn128<381, CHAR_BIT>> policy_type;
                ...
                template<>
                class fp6_3over2_extension_params<fields::bn128<381, CHAR_BIT>>
                    : public params<fields::bn128<381, CHAR_BIT>> {

                    typedef fields::bn128<381, CHAR_BIT> field_type;
                ...
                template<>
                class fp12_2over3over2_extension_params<fields::bn128<381, CHAR_BIT>>
                    : public params<fields::bn128<381, CHAR_BIT>> {
                ...
                template<>
                class fp2_extension_params<fields::bn128<377, CHAR_BIT>>
                    : public params<fields::bn128<377, CHAR_BIT>> {

                    typedef params<fields::bn128<377, CHAR_BIT>> policy_type;
                ...
                template<>
                class fp6_3over2_extension_params<fields::bn128<377, CHAR_BIT>>
                    : public params<fields::bn128<377, CHAR_BIT>> {

                    typedef fields::bn128<377, CHAR_BIT> field_type;
                    typedef params<field_type> policy_type;
                ...
                template<>
                class fp12_2over3over2_extension_params<fields::bn128<377, CHAR_BIT>>
                    : public params<fields::bn128<377, CHAR_BIT>> {
                ...
                constexpr typename fp2_extension_params<bn128_base_field<381, CHAR_BIT>>::modulus_type const
                    fp2_extension_params<bn128_base_field<381, CHAR_BIT>>::non_residue;
                constexpr typename fp2_extension_params<bn128_base_field<377, CHAR_BIT>>::modulus_type const
                    fp2_extension_params<bn128_base_field<377, CHAR_BIT>>::non_residue;

                constexpr std::array<typename fp6_3over2_extension_params<bn128_base_field<381, CHAR_BIT>>::modulus_type, 2> const
                    fp6_3over2_extension_params<bn128_base_field<381, CHAR_BIT>>::non_residue;
                constexpr std::array<typename fp6_3over2_extension_params<bn128_base_field<377, CHAR_BIT>>::modulus_type, 2> const
                    fp6_3over2_extension_params<bn128_base_field<377, CHAR_BIT>>::non_residue;

                constexpr std::array<typename fp12_2over3over2_extension_params<bn128_base_field<381, CHAR_BIT>>::modulus_type, 2> const
                    fp12_2over3over2_extension_params<bn128_base_field<381, CHAR_BIT>>::non_residue;
                constexpr std::array<typename fp12_2over3over2_extension_params<bn128_base_field<377, CHAR_BIT>>::modulus_type, 2> const
                    fp12_2over3over2_extension_params<bn128_base_field<377, CHAR_BIT>>::non_residue;
