        ...
        namespace fields {
            namespace detail {
                ...
                public:
                    ...
                    /*constexpr static const std::array<non_residue_type, 4> Frobenius_coeffs_c1 = {non_residue_type(0x01),
                    ...
                    constexpr static const std::array<modulus_type, 4> Frobenius_coeffs_c1 = {0x01,
