...
#ifndef ALGEBRA_FIELDS_FRP_V1_SCALAR_FIELD_HPP
#define ALGEBRA_FIELDS_FRP_V1_SCALAR_FIELD_HPP
    ...
    namespace algebra {
        namespace fields {
            ...
            struct frp_v1_scalar_field<256, CHAR_BIT> : public field<256, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<params<frp_v1_scalar_field<256, CHAR_BIT>>>
                    value_type;
