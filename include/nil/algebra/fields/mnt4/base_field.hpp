...
#ifndef ALGEBRA_FIELDS_MNT4_BASE_FIELD_HPP
#define ALGEBRA_FIELDS_MNT4_BASE_FIELD_HPP
    ...
    namespace algebra {
        namespace fields {
            ...
            struct mnt4_base_field<298, CHAR_BIT> : public field<298, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<params<mnt4_base_field<298, CHAR_BIT>>>
                    value_type;
