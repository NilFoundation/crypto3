...
#ifndef ALGEBRA_FIELDS_GIST_A_SCALAR_FIELD_HPP
#define ALGEBRA_FIELDS_GIST_A_SCALAR_FIELD_HPP
    ...
    namespace algebra {
        namespace fields {
            ...
            struct gost_A_scalar_field<256, CHAR_BIT> : public field<256, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<params<gost_A_scalar_field<256, CHAR_BIT>>>
                    value_type;
