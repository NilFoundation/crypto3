    ...
    namespace algebra {
        namespace fields {
            ...
            struct gost_A_base_field<256, CHAR_BIT> : public field<256, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<detail::extension_params<gost_A_base_field<256, CHAR_BIT>>> value_type;

                constexpr static const std::size_t arity = 1;
            };

            constexpr typename gost_A_base_field<256, CHAR_BIT>::modulus_type const gost_A_base_field<256, CHAR_BIT>::modulus;

            constexpr typename gost_A_base_field<256, CHAR_BIT>::generator_type const gost_A_base_field<256, CHAR_BIT>::mul_generator;
