...
#ifndef ALGEBRA_FIELDS_FP3_EXTENSION_HPP
#define ALGEBRA_FIELDS_FP3_EXTENSION_HPP
    ...
    namespace algebra {
        namespace fields {
            ...
            struct fp3 {
                ...
                typedef typename detail::element_fp3<detail::fp3_extension_params<policy_type>> value_type;
