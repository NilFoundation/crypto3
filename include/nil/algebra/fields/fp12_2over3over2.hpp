...
#ifndef ALGEBRA_FIELDS_FP12_2OVER3OVER2_EXTENSION_HPP
#define ALGEBRA_FIELDS_FP12_2OVER3OVER2_EXTENSION_HPP
    ...
    namespace algebra {
        namespace fields {
            ...
            struct fp12_2over3over2 {
                ...
                typedef typename detail::element_fp12_2over3over2<detail::fp12_2over3over2_extension_params<field_type>> value_type;
            ...
            template<typename BaseField>
            constexpr
                typename fp12_2over3over2<BaseField>::generator_type const fp12_2over3over2<BaseField>::mul_generator;
