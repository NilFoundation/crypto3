...
#ifndef ALGEBRA_FIELDS_ALT_BN128_BASE_FIELD_HPP
#define ALGEBRA_FIELDS_ALT_BN128_BASE_FIELD_HPP
    ...
    namespace algebra {
        namespace fields {
            ...
            struct alt_bn128_base_field<254, CHAR_BIT> : public field<254, CHAR_BIT> {
                ...
                typedef typename detail::element_fp<params<alt_bn128_base_field<254, CHAR_BIT>>>
                    value_type;
