...
#include <boost/algebra/fields/detail/fp2.hpp>

namespace nil {
    namespace algebra {
        namespace fields {
            template<typename NumberType>
            NumberType multi_exp(typename static std::array<fp2::value_type>::const_iterator vec_start,
            ...
            template<typename NumberType>
            NumberType multi_exp_subgroup(typename static std::array<fp2::value_type>::const_iterator vec_start,
                ...
                for (size_t j = 0; j < workers_amount; ++j) {
                    for (size_t k = 0; k <= c - 1; ++k) {
                        ...
                        for (size_t i = start; i <= end; ++i) {
                            ...
                            if (idx > 0) {
                                buckets[idx - 1] = (*(vec_start + i).data[0].data) * buckets[idx - 1];
                            }
                        }
