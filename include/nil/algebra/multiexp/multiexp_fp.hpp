...
NumberType multi_exp (typename static std::array<element<Field>>::const_iterator vec_start,
                      typename static std::array<NumberType>::const_iterator  scalar_start,
                      size_t num_groups, const size_t bucket_size, 
                      size_t const workers_in_subgroup, const size_t n, const size_t one)
{
...
template <typename Field, typename NumberType>
NumberType multi_exp_subgroup(typename static std::array<element<Field>>::const_iterator vec_start,
                              typename static std::array<NumberType>::const_iterator  scalar_start,
...
NumberType get_bits(typename std::vector<T>::const_iterator scalar_start,
...
template <typename NumberType>
NumberType result_aggregation(typename std::array<NumberType> &r, const size_t L, const size_t bucket_size, const size_t one)
{
