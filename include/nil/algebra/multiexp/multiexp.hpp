...
T eval_multi_exp(typename std::vector<T>::const_iterator vec_start,
                 typename std::vector<T>::const_iterator scalar_start,
                 size_t num_groups, const size_t bucket_size, 
                 const workers_in_subgroup, const size_t n, const size_t one)
{
...
template <typename T>
T get_bits(typename std::vector<T>::const_iterator scalar_start,
