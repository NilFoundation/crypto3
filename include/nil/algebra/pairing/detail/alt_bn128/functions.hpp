    ...
    namespace algebra {
        namespace pairing {
            namespace detail {
                ...
                template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
                curves::alt_bn128_gt<ModulusBits, GeneratorBits> alt_bn128_final_exponentiation_first_chunk(
                    const curves::alt_bn128_gt<ModulusBits, GeneratorBits> &elt) {
                    ...
                    */
                    ...
                    const curves::alt_bn128_gt<ModulusBits, GeneratorBits> A =
                        curves::alt_bn128_gt<ModulusBits, GeneratorBits>(elt.c0, -elt.c1);
                ...
                template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
                curves::alt_bn128_gt<ModulusBits, GeneratorBits>
                    alt_bn128_exp_by_neg_z(const curves::alt_bn128_gt<ModulusBits, GeneratorBits> &elt) {

                    curves::alt_bn128_gt<ModulusBits, GeneratorBits> result = elt.cyclotomic_exp(
                        alt_bn128_basic_policy<ModulusBits, GeneratorBits>::alt_bn128_final_exponent_z);
                ...
                template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
                curves::alt_bn128_gt<ModulusBits, GeneratorBits> alt_bn128_final_exponentiation_last_chunk(
                    const curves::alt_bn128_gt<ModulusBits, GeneratorBits> &elt) {
                    ...
                    /*
                      ...
                      R = Q * P              // = elt^(q^2 * (12*z^3 + 6*z^2 + 6*z) + q*(12*z^3 + 6*z^2 + 4*z) * (12*z^3
                      + 12*z^2 + 6*z + 1)) S = conj(elt)          // = elt^(-1) T = S * L              // = elt^(12*z^3
                      + 6*z^2 + 4*z - 1) U = T.Frobenius_map(3) // = elt^(q^3(12*z^3 + 6*z^2 + 4*z - 1)) V = U * R // =
                      elt^(q^3(12*z^3 + 6*z^2 + 4*z - 1) + q^2 * (12*z^3 + 6*z^2 + 6*z) + q*(12*z^3 + 6*z^2 + 4*z) *
                ...
                template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
                curves::alt_bn128_gt<ModulusBits, GeneratorBits>
                    alt_bn128_final_exponentiation(const curves::alt_bn128_gt<ModulusBits, GeneratorBits> &elt) {
                    /* OLD naive version:
                        curves::alt_bn128_gt<ModulusBits, GeneratorBits> result = elt^alt_bn128_final_exponent;
                    */
                    curves::alt_bn128_gt<ModulusBits, GeneratorBits> A =
                        alt_bn128_final_exponentiation_first_chunk<ModulusBits, GeneratorBits>(elt);
                    curves::alt_bn128_gt<ModulusBits, GeneratorBits> result =
                        alt_bn128_final_exponentiation_last_chunk<ModulusBits, GeneratorBits>(A);
                ...
                void doubling_step_for_flipped_miller_loop(const alt_bn128_Fq<ModulusBits, GeneratorBits> two_inv,
                    ...
                    const alt_bn128_Fq2<ModulusBits, GeneratorBits> E =
                        alt_bn128_twist_coeff_b * D;                                          // E = twist_b * D
                    ...
                    const alt_bn128_Fq2<ModulusBits, GeneratorBits> H =
                ...
                template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
                alt_bn128_ate_g1_precomp<ModulusBits, GeneratorBits>
                    alt_bn128_ate_precompute_g1(const alt_bn128_g1 &P) {
                ...
                template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
                alt_bn128_ate_g2_precomp<ModulusBits, GeneratorBits>
                    alt_bn128_ate_precompute_g2(const alt_bn128_g2 &Q) {

                    alt_bn128_g2<ModulusBits, GeneratorBits> Qcopy(Q).to_affine_coordinates();

                    alt_bn128_Fq<ModulusBits, GeneratorBits> two_inv =
                        (alt_bn128_Fq(0x02).inversed());    // could add to global params if needed
                ...
                template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
                curves::alt_bn128_gt<ModulusBits, GeneratorBits>
                    alt_bn128_ate_miller_loop(const alt_bn128_ate_g1_precomp<ModulusBits, GeneratorBits> &prec_P,
                                              const alt_bn128_ate_g2_precomp<ModulusBits, GeneratorBits> &prec_Q) {

                    curves::alt_bn128_gt<ModulusBits, GeneratorBits> f =
                        curves::alt_bn128_gt<ModulusBits, GeneratorBits>::one();
                ...
                template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
                curves::alt_bn128_gt<ModulusBits, GeneratorBits> alt_bn128_ate_double_miller_loop(
                    const alt_bn128_ate_g1_precomp<ModulusBits, GeneratorBits> &prec_P1,
                ...
                template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
                curves::alt_bn128_gt<ModulusBits, GeneratorBits>
                    alt_bn128_ate_pairing(const alt_bn128_g1 &P, const alt_bn128_g2<ModulusBits, GeneratorBits> &Q) {
                    alt_bn128_ate_g1_precomp<ModulusBits, GeneratorBits> prec_P =
                        alt_bn128_ate_precompute_g1<ModulusBits, GeneratorBits>(P);
                    alt_bn128_ate_g2_precomp<ModulusBits, GeneratorBits> prec_Q =
                        alt_bn128_ate_precompute_g2<ModulusBits, GeneratorBits>(Q);
                    curves::alt_bn128_gt<ModulusBits, GeneratorBits> result =
                        alt_bn128_ate_miller_loop<ModulusBits, GeneratorBits>(prec_P, prec_Q);
                    return result;
                }

                template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
                curves::alt_bn128_gt<ModulusBits, GeneratorBits>
                    alt_bn128_ate_reduced_pairing(const alt_bn128_g1<ModulusBits, GeneratorBits> &P,
                                                  const alt_bn128_g2<ModulusBits, GeneratorBits> &Q) {
                    const curves::alt_bn128_gt<ModulusBits, GeneratorBits> f =
                        alt_bn128_ate_pairing<ModulusBits, GeneratorBits>(P, Q);
                    const curves::alt_bn128_gt<ModulusBits, GeneratorBits> result =
                        alt_bn128_final_exponentiation<ModulusBits, GeneratorBits>(f);
                    return result;
                }
                ...
                template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
                curves::alt_bn128_gt<ModulusBits, GeneratorBits>
                    alt_bn128_miller_loop(const alt_bn128_g1_precomp &prec_P, const alt_bn128_g2_precomp &prec_Q) {
                    return alt_bn128_ate_miller_loop<ModulusBits, GeneratorBits>(prec_P, prec_Q);
                }

                template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
                curves::alt_bn128_gt<ModulusBits, GeneratorBits>
                    alt_bn128_double_miller_loop(const alt_bn128_g1_precomp &prec_P1,
                                                 const alt_bn128_g2_precomp &prec_Q1,
                                                 const alt_bn128_g1_precomp &prec_P2,
                                                 const alt_bn128_g2_precomp &prec_Q2) {
                    return alt_bn128_ate_double_miller_loop<ModulusBits, GeneratorBits>(
                        prec_P1, prec_Q1, prec_P2, prec_Q2);
                }

                template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
                curves::alt_bn128_gt<ModulusBits, GeneratorBits>
                    alt_bn128_pairing(const alt_bn128_g1 &P, const alt_bn128_g2<ModulusBits, GeneratorBits> &Q) {
                    return alt_bn128_ate_pairing<ModulusBits, GeneratorBits>(P, Q);
                }

                template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
                curves::alt_bn128_gt<ModulusBits, GeneratorBits>
                    alt_bn128_reduced_pairing(const alt_bn128_g1<ModulusBits, GeneratorBits> &P,
                                              const alt_bn128_g2<ModulusBits, GeneratorBits> &Q) {
