            ...
            namespace detail {
                ...
                public:
                    ...
                    gt exp_by_neg_z(const gt &elt) {
                        ...
                        gt result = elt.cyclotomic_exp(
                            policy_type::final_exponent_z);
                    ...
                    void doubling_step_for_flipped_miller_loop(const Fq two_inv,
                                                               g2 &current,
                                                               ate_ell_coeffs &c) {
                    ...
                    void mixed_addition_step_for_flipped_miller_loop(const g2 base,
                                                                     g2 &current,
                                                                     ate_ell_coeffs &c) {
