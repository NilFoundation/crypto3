    ...
    namespace algebra {
        namespace pairing {
            namespace detail{
                ...
                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                curves::edwards_gt<ModulusBits, GeneratorBits> edwards_final_exponentiation_last_chunk(const curves::edwards_gt<ModulusBits, GeneratorBits> &elt, const curves::edwards_gt<ModulusBits, GeneratorBits> &elt_inv) {

                    const curves::edwards_gt<ModulusBits, GeneratorBits> elt_q = elt.Frobenius_map(1);
                    
                    curves::edwards_gt<ModulusBits, GeneratorBits> w1_part = elt_q.cyclotomic_exp(basic_policy <edwards<ModulusBits, GeneratorBits>> :: final_exponent_last_chunk_w1);
                    ...
                    if (basic_policy <edwards<ModulusBits, GeneratorBits>>::final_exponent_last_chunk_is_w0_neg) {
                    	w0_part = elt_inv.cyclotomic_exp(basic_policy <edwards<ModulusBits, GeneratorBits>>::final_exponent_last_chunk_abs_of_w0);
                    } else {
                    	w0_part = elt.cyclotomic_exp(basic_policy <edwards<ModulusBits, GeneratorBits>>::final_exponent_last_chunk_abs_of_w0);
                    }
                ...
                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                curves::edwards_gt<ModulusBits, GeneratorBits> edwards_final_exponentiation_first_chunk(const curves::edwards_gt<ModulusBits, GeneratorBits> &elt, const curves::edwards_gt<ModulusBits, GeneratorBits> &elt_inv) {
                ...
                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                curves::edwards_gt<ModulusBits, GeneratorBits> edwards_final_exponentiation(const curves::edwards_gt<ModulusBits, GeneratorBits> &elt) {
                    const curves::edwards_gt<ModulusBits, GeneratorBits> elt_inv = elt.inverse();
                    const curves::edwards_gt<ModulusBits, GeneratorBits> elt_to_first_chunk = edwards_final_exponentiation_first_chunk(elt, elt_inv);
                    const curves::edwards_gt<ModulusBits, GeneratorBits> elt_inv_to_first_chunk = edwards_final_exponentiation_first_chunk(elt_inv, elt);
                    curves::edwards_gt<ModulusBits, GeneratorBits> result = edwards_final_exponentiation_last_chunk(elt_to_first_chunk, elt_inv_to_first_chunk)
                ...
                edwards_tate_g2_precomp edwards_tate_precompute_g2(const edwards_g2& Q) {
                    ...
                    result.eta = (Qcopy.Z+Qcopy.Y) * curves::edwards_gt<ModulusBits, GeneratorBits>::mul_by_non_residue(Qcopy.X).inverse(); // (Z+Y)/(nqr*X
                ...
                void doubling_step_for_miller_loop(extended_edwards_g1_projective &current,
                    ...
                    const edwards_Fq<ModulusBits, GeneratorBits> &X = current.X, &Y = current.Y, &Z = current.Z, &T = current.T;
                ...
                void full_addition_step_for_miller_loop(const extended_edwards_g1_projective &base,
                                                        ...
                                                        edwards_Fq_conic_coefficients &cc) {
                    const edwards_Fq<ModulusBits, GeneratorBits> &X1 = current.X, &Y1 = current.Y, &Z1 = current.Z, &T1 = current.T;
                    ...
                    const edwards_Fq<ModulusBits, GeneratorBits> F = (X1-Y1)*(X2+Y2)+B-A; // F    = (X1-Y1)*(X2+Y2)+B-A
                ...
                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                curves::edwards_gt<ModulusBits, GeneratorBits> edwards_tate_miller_loop(const edwards_tate_g1_precomp &prec_P,
                                          const edwards_tate_g2_precomp &prec_Q) {

                    curves::edwards_gt<ModulusBits, GeneratorBits> f = curves::edwards_gt<ModulusBits, GeneratorBits>::one();
                    ...
                    for (long i = edwards_modulus_r.max_bits()-1; i >= 0; --i) {
                        ...
                        curves::edwards_gt<ModulusBits, GeneratorBits> g_RR_at_Q = curves::edwards_gt<ModulusBits, GeneratorBits>(edwards_Fq3(cc.c_XZ, edwards_Fq(0l), edwards_Fq(0l)) + cc.c_XY * prec_Q.y0,
                                                            cc.c_ZZ * prec_Q.eta);
                        f = f.squared() * g_RR_at_Q;
                        if (bit) {
                            cc = prec_P[idx++];

                            curves::edwards_gt<ModulusBits, GeneratorBits> g_RP_at_Q = curves::edwards_gt<ModulusBits, GeneratorBits>(edwards_Fq3(cc.c_XZ, edwards_Fq(0l), edwards_Fq(0l)) + cc.c_XY * prec_Q.y0,
                                                                cc.c_ZZ * prec_Q.eta);
                            f = f * g_RP_at_Q;
                        }
                ...
                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                curves::edwards_gt<ModulusBits, GeneratorBits> edwards_tate_pairing(const edwards_g1& P, const edwards_g2 &Q) {
                ...
                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                curves::edwards_gt<ModulusBits, GeneratorBits> edwards_tate_reduced_pairing(const edwards_g1 &P, const edwards_g2 &Q) {
                ...
                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                void doubling_step_for_flipped_miller_loop(extended_edwards_g2_projective<ModulusBits, GeneratorBits> &current,
                                                           edwards_Fq3_conic_coefficients &cc) {
                    const edwards_Fq3<ModulusBits, GeneratorBits> &X = current.X, &Y = current.Y, &Z = current.Z, &T = current.T;
                    ...
                    const edwards_Fq3<ModulusBits, GeneratorBits> H = edwards_g2::mul_by_a(A); // edwards_param_twist_coeff_a is 1 * X for us
                                                   // H    = twisted_a * A
                ...
                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                void full_addition_step_for_flipped_miller_loop(const extended_edwards_g2_projective<ModulusBits, GeneratorBits> &base,
                                                                extended_edwards_g2_projective<ModulusBits, GeneratorBits> &current,
                                                                edwards_Fq3_conic_coefficients c)
                {
                    const edwards_Fq3<ModulusBits, GeneratorBits> &X1 = current.X, &Y1 = current.Y, &Z1 = current.Z, &T1 = current.T;
                    const edwards_Fq3<ModulusBits, GeneratorBits> &X2 = base.X, &Y2 =  base.Y, &Z2 = base.Z, &T2 = base.T;
                    ...
                    const edwards_Fq3<ModulusBits, GeneratorBits> F = (X1-Y1)*(X2+Y2)+B-A; // F    = (X1-Y1)*(X2+Y2)+B-A
                    // G = B + twisted_edwards_a * A
                    const edwards_Fq3<ModulusBits, GeneratorBits> G = B + edwards_g2::mul_by_a(A); // edwards_param_twist_coeff_a is 1*X for us
                ...
                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                void mixed_addition_step_for_flipped_miller_loop(const extended_edwards_g2_projective<ModulusBits, GeneratorBits> &base,
                                                                 extended_edwards_g2_projective<ModulusBits, GeneratorBits> &current,
                                                                 edwards_Fq3_conic_coefficients &cc) {
                    const edwards_Fq3<ModulusBits, GeneratorBits> &X1 = current.X, &Y1 = current.Y, &Z1 = current.Z, &T1 = current.T;
                ...
                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                curves::edwards_gt<ModulusBits, GeneratorBits> edwards_ate_miller_loop(const edwards_ate_g1_precomp<ModulusBits, GeneratorBits> &prec_P,
                    ...
                    for (long i = loop_count.max_bits()-1; i >= 0; --i) {
                        ...
                        curves::edwards_gt<ModulusBits, GeneratorBits> g_RR_at_P = curves::edwards_gt<ModulusBits, GeneratorBits>(prec_P.P_XY * cc.c_XY + prec_P.P_XZ * cc.c_XZ,
                                                            prec_P.P_ZZplusYZ * cc.c_ZZ);
                        f = f.squared() * g_RR_at_P;
                        if (bit) {
                            cc = prec_Q[idx++];
                            curves::edwards_gt<ModulusBits, GeneratorBits> g_RQ_at_P = curves::edwards_gt<ModulusBits, GeneratorBits>(prec_P.P_ZZplusYZ * cc.c_ZZ,
                ...
                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                curves::edwards_gt<ModulusBits, GeneratorBits> edwards_ate_double_miller_loop(const edwards_ate_g1_precomp<ModulusBits, GeneratorBits> &prec_P1,
                    ...
                    for (long i = loop_count.max_bits()-1; i >= 0; --i) {
                        ...
                        curves::edwards_gt<ModulusBits, GeneratorBits> g_RR_at_P1 = curves::edwards_gt<ModulusBits, GeneratorBits>(prec_P1.P_XY * cc1.c_XY + prec_P1.P_XZ * cc1.c_XZ,
                                                             prec_P1.P_ZZplusYZ * cc1.c_ZZ);

                        curves::edwards_gt<ModulusBits, GeneratorBits> g_RR_at_P2 = curves::edwards_gt<ModulusBits, GeneratorBits>(prec_P2.P_XY * cc2.c_XY + prec_P2.P_XZ * cc2.c_XZ,
                        ...
                        if (bit) {
                            ...
                            cc2 = prec_Q2[idx];
                            ++idx;
                            curves::edwards_gt<ModulusBits, GeneratorBits> g_RQ_at_P1 = curves::edwards_gt<ModulusBits, GeneratorBits>(prec_P1.P_ZZplusYZ * cc1.c_ZZ,
                                                                 prec_P1.P_XY * cc1.c_XY + prec_P1.P_XZ * cc1.c_XZ);
                            curves::edwards_gt<ModulusBits, GeneratorBits> g_RQ_at_P2 = curves::edwards_gt<ModulusBits, GeneratorBits>(prec_P2.P_ZZplusYZ * cc2.c_ZZ,
                ...
                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                curves::edwards_gt<ModulusBits, GeneratorBits> edwards_ate_pairing(const edwards_g1& P, const edwards_g2 &Q) {
                    edwards_ate_g1_precomp<ModulusBits, GeneratorBits> prec_P = edwards_ate_precompute_g1<ModulusBits, GeneratorBits>(P);
                    edwards_ate_g2_precomp<ModulusBits, GeneratorBits> prec_Q = edwards_ate_precompute_g2<ModulusBits, GeneratorBits>(Q);
                    curves::edwards_gt<ModulusBits, GeneratorBits> result = edwards_ate_miller_loop<ModulusBits, GeneratorBits>(prec_P, prec_Q);
                    return result;
                }

                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                curves::edwards_gt<ModulusBits, GeneratorBits> edwards_ate_reduced_pairing(const edwards_g1 &P, const edwards_g2 &Q) {
                    const curves::edwards_gt<ModulusBits, GeneratorBits> f = edwards_ate_pairing<ModulusBits, GeneratorBits>(P, Q);
                    const curves::edwards_gt<ModulusBits, GeneratorBits> result = edwards_final_exponentiation<ModulusBits, GeneratorBits>(f);
                ...
                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                curves::edwards_gt<ModulusBits, GeneratorBits> edwards_miller_loop(const edwards_g1_precomp<ModulusBits, GeneratorBits> &prec_P,
                                                const edwards_g2_precomp<ModulusBits, GeneratorBits> &prec_Q) {
                    return edwards_ate_miller_loop(prec_P, prec_Q);
                }

                template<std::size_t ModulusBits = 183, std::size_t GeneratorBits = CHAR_BIT>
                curves::edwards_gt<ModulusBits, GeneratorBits> edwards_double_miller_loop(const edwards_g1_precomp<ModulusBits, GeneratorBits> &prec_P1,
                    ...
                    return edwards_ate_double_miller_loop<ModulusBits, GeneratorBits>(prec_P1, prec_Q1, prec_P2, prec_Q2);
                }
