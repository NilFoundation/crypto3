        ...
        namespace pairing {
            namespace detail {
                ...
                public:
                    ...
                    using edwards_g1 = curves::detail::edwards_g1<183, CHAR_BIT>;
                    using edwards_g2 = curves::detail::edwards_g2<183, CHAR_BIT>;
                    using edwards_Fq = typename edwards_g1::underlying_field_type_value;
                    using edwards_Fq3 = typename edwards_g2::underlying_field_type_value;
                    using edwards_gt = policy_type::gt_type;
