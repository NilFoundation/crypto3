        ...
        namespace pairing {
            namespace detail {
                ...
                curves::mnt4_gt<ModulusBits, GeneratorBits>
                    mnt4_affine_ate_miller_loop(const mnt4_affine_ate_g1_precomputation &prec_P,
                ...
                bool mnt4_ate_g2_precomp::
                    ...
                    template<std::size_t ModulusBits = 298, std::size_t GeneratorBits = CHAR_BIT>
                    curves::mnt4_gt<ModulusBits, GeneratorBits>
                    mnt4_final_exponentiation_last_chunk(const curves::mnt4_gt<ModulusBits, GeneratorBits> &elt,
                                                         const curves::mnt4_gt<ModulusBits, GeneratorBits> &elt_inv) {
                ...
                template<std::size_t ModulusBits = 298, std::size_t GeneratorBits = CHAR_BIT>
                curves::mnt4_gt<ModulusBits, GeneratorBits>
                    mnt4_final_exponentiation_first_chunk(const curves::mnt4_gt<ModulusBits, GeneratorBits> &elt,
                                                          const curves::mnt4_gt<ModulusBits, GeneratorBits> &elt_inv) {
                ...
                curves::mnt4_gt<ModulusBits, GeneratorBits>
                    ...
                    curves::mnt4_gt<ModulusBits, GeneratorBits> result =
                        mnt4_final_exponentiation_last_chunk(elt_to_first_chunk, elt_inv_to_first_chunk);
                ...
                curves::mnt4_gt<ModulusBits, GeneratorBits>
                    ...
                    for (long i = NAF.size() - 1; i >= 0; --i) {
                        ...
                        if (NAF[i] != 0) {
                            ...
                            if (NAF[i] > 0) {
                                g_RQ_at_P = curves::mnt4_gt<ModulusBits, GeneratorBits>(
                ...
                template<std::size_t ModulusBits = 298, std::size_t GeneratorBits = CHAR_BIT>
                void mixed_addition_step_for_flipped_miller_loop(const mnt4_Fq2 base_X, const mnt4_Fq2 base_Y,
                ...
                template<std::size_t ModulusBits = 298, std::size_t GeneratorBits = CHAR_BIT>
                curves::mnt4_gt<ModulusBits, GeneratorBits>
                    mnt4_ate_double_miller_loop(const mnt4_ate_g1_precomp &prec_P1,
                    ...
                    for (long i = loop_count.max_bits() - 1; i >= 0; --i) {
                        ...
                        curves::mnt4_gt<ModulusBits, GeneratorBits> g_RR_at_P1 =
                            curves::mnt4_gt<ModulusBits, GeneratorBits>(
                                -dc1.c_4C - dc1.c_J * prec_P1.PX_twist + dc1.c_L, dc1.c_H * prec_P1.PY_twist);

                        curves::mnt4_gt<ModulusBits, GeneratorBits> g_RR_at_P2 =
                            curves::mnt4_gt<ModulusBits, GeneratorBits>(
                        ...
                        if (bit) {
                            ...
                            curves::mnt4_gt<ModulusBits, GeneratorBits> g_RQ_at_P1 =
                                curves::mnt4_gt<ModulusBits, GeneratorBits>(
                                    ac1.c_RZ * prec_P1.PY_twist,
                                    -(prec_Q1.QY_over_twist * ac1.c_RZ + L1_coeff1 * ac1.c_L1));
                            curves::mnt4_gt<ModulusBits, GeneratorBits> g_RQ_at_P2 =
                                curves::mnt4_gt<ModulusBits, GeneratorBits>(
                    ...
                    if (mnt4_basic_policy<ModulusBits, GeneratorBits>::ate_is_loop_count_neg) {
                        ...
                        mnt4_ate_add_coeffs ac2 = prec_Q2.add_coeffs[add_idx];
                        ++add_idx;
                        curves::mnt4_gt<ModulusBits, GeneratorBits> g_RnegR_at_P1 =
                            curves::mnt4_gt<ModulusBits, GeneratorBits>(
                                ac1.c_RZ * prec_P1.PY_twist,
                                -(prec_Q1.QY_over_twist * ac1.c_RZ + L1_coeff1 * ac1.c_L1));
                        curves::mnt4_gt<ModulusBits, GeneratorBits> g_RnegR_at_P2 =
                            curves::mnt4_gt<ModulusBits, GeneratorBits>(
                                ac2.c_RZ * prec_P2.PY_twist,
                                -(prec_Q2.QY_over_twist * ac2.c_RZ + L1_coeff2 * ac2.c_L1));
                ...
                template<std::size_t ModulusBits = 298, std::size_t GeneratorBits = CHAR_BIT>
                curves::mnt4_gt<ModulusBits, GeneratorBits> mnt4_ate_reduced_pairing(const mnt4_g1 &P,
                                                                                     const mnt4_g2 &Q) {
                ...
                template<std::size_t ModulusBits = 298, std::size_t GeneratorBits = CHAR_BIT>
                curves::mnt4_gt<ModulusBits, GeneratorBits> mnt4_pairing(const mnt4_g1 &P, const mnt4_g2 &Q) {
                    return mnt4_ate_pairing(P, Q);
                }

                template<std::size_t ModulusBits = 298, std::size_t GeneratorBits = CHAR_BIT>
                curves::mnt4_gt<ModulusBits, GeneratorBits> mnt4_reduced_pairing(const mnt4_g1 &P, const mnt4_g2 &Q) {
