    ...
    namespace algebra {
        namespace pairing {
            namespace detail {
                ...
                template<std::size_t ModulusBits = 381, std::size_t GeneratorBits = CHAR_BIT>
                bls12_gt<ModulusBits, GeneratorBits>
                    bls12_381_final_exponentiation_first_chunk(const bls12_gt<ModulusBits, GeneratorBits> &elt) {
                    ...
                    */
                    ...
                    const bls12_gt<ModulusBits, GeneratorBits> A =
                        bls12_gt<ModulusBits, GeneratorBits>(elt.c0, -elt.c1);
                ...
                template<std::size_t ModulusBits = 381, std::size_t GeneratorBits = CHAR_BIT>
                bls12_gt<ModulusBits, GeneratorBits>
                    bls12_381_exp_by_z(const bls12_gt<ModulusBits, GeneratorBits> &elt) {

                    bls12_gt<ModulusBits, GeneratorBits> result =
                        elt.cyclotomic_exp(bls12_basic_policy<ModulusBits, GeneratorBits>::final_exponent_z);
                ...
                template<std::size_t ModulusBits = 381, std::size_t GeneratorBits = CHAR_BIT>
                bls12_gt<ModulusBits, GeneratorBits>
                    bls12_381_final_exponentiation_last_chunk(const bls12_gt<ModulusBits, GeneratorBits> &elt) {
                ...
                template<std::size_t ModulusBits = 381, std::size_t GeneratorBits = CHAR_BIT>
                bls12_gt<ModulusBits, GeneratorBits>
                    bls12_381_final_exponentiation(const bls12_gt<ModulusBits, GeneratorBits> &elt) {
                    /* OLD naive version:
                ...
                void doubling_step_for_miller_loop(const bls12_381_Fq two_inv,
                    ...
                    const bls12_Fq2<ModulusBits, GeneratorBits> H =
                ...
                template<std::size_t ModulusBits = 381, std::size_t GeneratorBits = CHAR_BIT>
                bls12_gt<ModulusBits, GeneratorBits>
                    bls12_381_ate_double_miller_loop(const bls12_381_ate_g1_precomp &prec_P1,
                ...
                template<std::size_t ModulusBits = 381, std::size_t GeneratorBits = CHAR_BIT>
                bls12_gt<ModulusBits, GeneratorBits>
                    bls12_381_ate_pairing(const bls12_g1<ModulusBits, GeneratorBits> &P,
                ...
                template<std::size_t ModulusBits = 381, std::size_t GeneratorBits = CHAR_BIT>
                bls12_gt<ModulusBits, GeneratorBits>
                    bls12_381_ate_reduced_pairing(const bls12_g1<ModulusBits, GeneratorBits> &P,
                                                  const bls12_g2<ModulusBits, GeneratorBits> &Q) {
                ...
                template<std::size_t ModulusBits = 381, std::size_t GeneratorBits = CHAR_BIT>
                bls12_g1<ModulusBits, GeneratorBits>
                    _precomp bls12_381_precompute_g1(const bls12_g1<ModulusBits, GeneratorBits> &P) {
                    return bls12_381_ate_precompute_g1(P);
                }

                template<std::size_t ModulusBits = 381, std::size_t GeneratorBits = CHAR_BIT>
                bls12_g2<ModulusBits, GeneratorBits>
                    _precomp bls12_381_precompute_g2(const bls12_g2<ModulusBits, GeneratorBits> &Q) {
                    return bls12_381_ate_precompute_g2(Q);
                }

                template<std::size_t ModulusBits = 381, std::size_t GeneratorBits = CHAR_BIT>
                bls12_gt<ModulusBits, GeneratorBits>
                    bls12_381_miller_loop(const bls12_g1<ModulusBits, GeneratorBits> _precomp &prec_P,
                                          const bls12_g2<ModulusBits, GeneratorBits>
                                              _precomp &prec_Q) {
                ...
                template<std::size_t ModulusBits = 381, std::size_t GeneratorBits = CHAR_BIT>
                bls12_gt<ModulusBits, GeneratorBits>
                    bls12_381_double_miller_loop(const bls12_g1<ModulusBits, GeneratorBits> _precomp &prec_P1,
                                                 const bls12_g2<ModulusBits, GeneratorBits>
                                                     _precomp &prec_Q1,
                                                 const bls12_g1<ModulusBits, GeneratorBits>
                                                     _precomp &prec_P2,
                                                 const bls12_g2<ModulusBits, GeneratorBits>
                                                     _precomp &prec_Q2) {
                ...
                template<std::size_t ModulusBits = 381, std::size_t GeneratorBits = CHAR_BIT>
                bls12_gt<ModulusBits, GeneratorBits>
                    bls12_381_reduced_pairing(const bls12_g1<ModulusBits, GeneratorBits> &P,
                                              const bls12_g2<ModulusBits, GeneratorBits> &Q) {
