...
namespace nil {
    namespace algebra {
        namespace pairing {
            ...
            template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
            bn128_gt<ModulusBits, GeneratorBits> bn128_double_ate_miller_loop(const bn128_ate_g1_precomp<ModulusBits, GeneratorBits> &prec_P1,
                ...
                bn128_gt<ModulusBits, GeneratorBits> f;
            ...
            template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
            bn128_gt<ModulusBits, GeneratorBits> bn128_ate_miller_loop(const bn128_ate_g1_precomp<ModulusBits, GeneratorBits> &prec_P,
            ...
            template<std::size_t ModulusBits = 254, std::size_t GeneratorBits = CHAR_BIT>
            bn128_gt<ModulusBits, GeneratorBits> bn128_final_exponentiation(const bn128_gt<ModulusBits, GeneratorBits> &elt) {
            ...
            static bn128_gt<ModulusBits, GeneratorBits> final_exponentiation<bn128<ModulusBits, GeneratorBits>>(const bn128_gt<ModulusBits, GeneratorBits> &elt) {
                return bn128_final_exponentiation(elt);
            }

            template <std::size_t ModulusBits, std::size_t GeneratorBits>
            static bn128_gt<ModulusBits, GeneratorBits> miller_loop<bn128<ModulusBits, GeneratorBits>>(const bn128_ate_g1_precomp<ModulusBits, GeneratorBits> &prec_P,
                                          const bn128_ate_g2_precomp<ModulusBits, GeneratorBits> &prec_Q) {

                bn128_gt<ModulusBits, GeneratorBits> result = bn128_ate_miller_loop(prec_P, prec_Q);

                return result;
            }

            template <std::size_t ModulusBits, std::size_t GeneratorBits>
            static bn128_gt<ModulusBits, GeneratorBits> double_miller_loop<bn128<ModulusBits, GeneratorBits>>(const bn128_ate_g1_precomp<ModulusBits, GeneratorBits> &prec_P1,
                                                 const bn128_ate_g2_precomp<ModulusBits, GeneratorBits> &prec_Q1,
                                                 const bn128_ate_g1_precomp<ModulusBits, GeneratorBits> &prec_P2,
                                                 const bn128_ate_g2_precomp<ModulusBits, GeneratorBits> &prec_Q2) {

                bn128_gt<ModulusBits, GeneratorBits> result = bn128_double_ate_miller_loop(prec_P1, prec_Q1, prec_P2, prec_Q2);
