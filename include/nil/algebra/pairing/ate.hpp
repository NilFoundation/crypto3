    ...
    struct Fp6T : public mie::local::addsubmul<Fp6T<T>, mie::local::hasNegative<Fp6T<T>>> {
        ...
        */
        ...
        struct Dbl : public mie::local::addsubmul<Dbl, mie::local::hasNegative<Dbl>> {
            ...
            Dbl(const Fp6T &x) : a_(x.a_), b_(x.b_), c_(x.c_) {
            }
            Dbl(const Fp2 &a, const Fp2 &b, const Fp2 &c) : a_(a), b_(b), c_(c) {
            }
            Dbl(const Fp2Dbl &a, const Fp2Dbl &b, const Fp2Dbl &c) : a_(a), b_(b), c_(c) {
            }
            Dbl(const std::string &a0, const std::string &a1, const std::string &b0, const std::string &b1,
                const std::string &c0, const std::string &c1) :
                a_(a0, a1),
                b_(b0, b1), c_(c0, c1) {
            }

            void setDirect(const mie::Vuint &v0, const mie::Vuint &v1, const mie::Vuint &v2, const mie::Vuint &v3,
                           const mie::Vuint &v4, const mie::Vuint &v5) {
                a_.setDirect(v0, v1);
                b_.setDirect(v2, v3);
                c_.setDirect(v4, v5);
            }
