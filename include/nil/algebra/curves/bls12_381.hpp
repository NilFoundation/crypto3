    ...
    namespace algebra {
    	namespace curves {
			...
			*/
            ...
            template<>
	        struct bls12<381> : public curve_weierstrass<nil::algebra::fields::bls12_381_fq<381>> {
	        private:
	        	typedef typename curve_weierstrass<nil::algebra::fields::bls12_381_fq<381>> policy_type;
	        public:
		        typedef typename policy_type::number_type number_type;
		        typedef typename policy_type::field_type field_type;

		        constexpr static const number_type p = 0x1a0111ea397fe69a4b1ba7b6434bacd764774b84f38512bf6730d2a0f6b0f6241eabfffeb153ffffb9feffffffffaaab_cppui381;
		        constexpr static const number_type a = 0;
		        constexpr static const number_type b = 0x04;
		        constexpr static const number_type x = 0x17f1d3a73197d7942695638c4fa9ac0fc3688c4f9774b905a14e3a3f171bac586c55e83ff97a1aeffb3af00adb22c6bb_cppui381;
