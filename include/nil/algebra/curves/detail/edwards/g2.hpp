        ...
        namespace curves {
            namespace detail {
                ...
                struct edwards_g2 {
                    ...
                    edwards_g2(underlying_field_type_value X, underlying_field_type_value Y, underlying_field_type_value Z) {
                        p[0] = X;
                        p[1] = Y;
                        p[2] = Z;
                    };

                    edwards_g2(underlying_field_type_value X, underlying_field_type_value Y, underlying_field_type_value Z) : edwards_g2(X, Y, X*Y) {};
                    ...
                    edwards_g2 add(const edwards_g2 &other) const {
                        ...
                        const underlying_field_type_value I = (this->p[0] + this->p[1]) * (other.p[0] + other.p[1]) - C - D;     // I = (X1+Y1)*(X2+Y2)-C-D
                    ...
                    edwards_g2 dbl() const {
                        ...
                        if (this->is_zero()) {
                            ...
                            const underlying_field_type_value E = (this->p[0] + this->p[1]).square()-A-B;          // E = (X1+Y1)^2-A-B
                    ...
                    {
                        // should be
                        //  underlying_field_type_value(edwards_twist_mul_by_a_c0 * elt.c2, edwards_twist_mul_by_a_c1 * elt.c0, edwards_twist_mul_by_a_c2 * elt.c1)
                    ...
                    {
                        return underlying_field_type_value(edwards_twist_mul_by_d_c0 * elt.c2, edwards_twist_mul_by_d_c1 * elt.c0, edwards_twist_mul_by_d_c2 * elt.c1);
                    }
