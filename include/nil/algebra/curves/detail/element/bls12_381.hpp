        ...
        namespace curve {
            namespace detail {
                ...
                struct element_bls12_381 {
                    ...
                    element_bls12_381(const FieldT &x, const FieldT &y, const FieldT &z) {
                        p[0] = x;
                        p[1] = y;
                        p[2] = z;   
                    }
                    
                    element_bls12_381 normalize() const {
                        FieldT p_out[3];
                    ...
                    */
                    element_bls12_381 operator+(const element_bls12_381 &B) const {
                        FieldT p_out[3];

                        if (p[2].is_zero()) {
                                return element_bls12_381(B);
                            }
                            if (B.p[2].is_zero()) {
                                return element_bls12_381(*this);
                            }
                    ...
                    element_bls12_381 operator-() const {
                        return element_bls12_381({p[0], -p[1], p[2]});
                    }
                    ...
                    */
                    ...
                    element_bls12_381 operator*(const NumberType N) const {
                        return multi_exp(*this, N);
                    }

                    template<class N>
                    element_bls12_381 &operator*=(const N &y) {
                        return *this * y;
                    }

                    bool operator==(const element_bls12_381 &rhs) const {
                        normalize();
                        rhs.normalize();
                        if (is_zero()) {
                            if (rhs.is_zero())
                    ...
                    element_bls12_381 &operator+=(const element_bls12_381 &rhs) {
                        return *this + rhs;
                    }
                ...
                typedef element_bls12_381<element_fp2> Ec2;
                typedef element_bls12_381<element_fp> Ec1;
