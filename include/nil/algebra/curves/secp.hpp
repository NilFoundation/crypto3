...
namespace nil {
    namespace algebra {
        namespace curves {
            ...
            template<std::size_t PBits>
            struct secp_r1 : public curve_weierstrass<PBits> {};

            template<std::size_t PBits>
            struct secp_r2 : public curve_weierstrass<PBits> {};

            template<>
            struct secp_k1<160> : public curve_weierstrass<160> {
            ...
            template<>
            struct secp_r1<160> : public curve_weierstrass<160> {
                typedef typename curve_weierstrass<160>::number_type number_type;
            ...
            template<>
            struct secp_r2<160> : public curve_weierstrass<160> {
                typedef typename curve_weierstrass<160>::number_type number_type;
            ...
            template<>
            struct secp_k1<192> : public curve_weierstrass<192> {
            ...
            template<>
            struct secp_r1<192> : public curve_weierstrass<192> {
                typedef typename curve_weierstrass<192>::number_type number_type;
            ...
            template<>
            struct secp_k1<224> : public curve_weierstrass<224> {
                typedef typename curve_weierstrass<224>::number_type number_type;
            ...
            template<>
            struct secp_r1<224> : public curve_weierstrass<224> {
                typedef typename curve_weierstrass<224>::number_type number_type;
            ...
            template<>
            struct secp_k1<256> : public curve_weierstrass<256> {
