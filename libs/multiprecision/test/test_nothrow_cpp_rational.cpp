...
typedef boost::multiprecision::number<
    ...
    rat512_t;
typedef boost::multiprecision::number<
    boost::multiprecision::rational_adaptor<boost::multiprecision::uint512_t::backend_type>>
    urat512_t;
...
typedef boost::multiprecision::number<
    ...
    checked_rat512_t;
typedef boost::multiprecision::number<
    boost::multiprecision::rational_adaptor<boost::multiprecision::checked_uint512_t::backend_type>>
    checked_urat512_t;
