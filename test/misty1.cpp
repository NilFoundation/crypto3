...
#define BOOST_TEST_MODULE misty1_cipher_test
...
BOOST_AUTO_TEST_SUITE(misty1_encode_test_suite)

    BOOST_DATA_TEST_CASE(misty1_single_range_encode, boost::unit_test::data::make(valid_data), array_element) {
