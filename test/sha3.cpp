...
BOOST_TEST_DONT_PRINT_LOG_VALUE(sha3<224>::construction::type::digest_type)
BOOST_TEST_DONT_PRINT_LOG_VALUE(sha3<256>::construction::type::digest_type)
BOOST_TEST_DONT_PRINT_LOG_VALUE(sha3<384>::construction::type::digest_type)
BOOST_TEST_DONT_PRINT_LOG_VALUE(sha3<512>::construction::type::digest_type)
...
static const std::unordered_map<std::string, std::string> string_224_data = {
...
static const std::unordered_map<std::string, std::string> string_384_data = {
...
BOOST_DATA_TEST_CASE(sha3_224_range_hash, boost::unit_test::data::make(string_224_data), array_element) {
    std::string out = hash<sha3<224>>(array_element.first);

    BOOST_CHECK_EQUAL(out, array_element.second);
}

BOOST_DATA_TEST_CASE(sha3_256_range_hash, boost::unit_test::data::make(string_256_data), array_element) {
    std::string out = hash<sha3<256>>(array_element.first);

    BOOST_CHECK_EQUAL(out, array_element.second);
}

BOOST_DATA_TEST_CASE(sha3_384_range_hash, boost::unit_test::data::make(string_384_data), array_element) {
    std::string out = hash<sha3<384>>(array_element.first);

    BOOST_CHECK_EQUAL(out, array_element.second);
}

BOOST_DATA_TEST_CASE(sha3_512_range_hash, boost::unit_test::data::make(string_512_data), array_element) {
    std::string out = hash<sha3<512>>(array_element.first);
...
BOOST_FIXTURE_TEST_CASE(sha3_384_accumulator3, fixture<384>) {
    ...
    BOOST_CHECK_EQUAL("c64ede18dc59558ee999ee4c10e3b00566b63bd8b5417b797bcd0efa5c71db6d"
                      "3107b481933b6fe4be882e3822bd4578", std::to_string(s).data());
    ...
    BOOST_CHECK_EQUAL("1881de2ca7e41ef95dc4732b8f5f002b189cc1e42b74168ed1732649ce1dbcdd"
                      "76197a31fd55ee989f2d7050dd473e8f", std::to_string(s).data());
}
...
BOOST_FIXTURE_TEST_CASE(sha3_512_accumulator3, fixture<512>) {
    ...
    BOOST_CHECK_EQUAL("d24ce75b87c7be36e3fedbaa285f563d3efcc13663f5eb2fdd0c60033dab04e8"
                      "94d343b3971bc0c9ba30e0dde18106cbaaa955c8c3c0bf1ec3490aafcae15788", std::to_string(s).data());
    ...
    BOOST_CHECK_EQUAL("1b307700232bb68bb21801114085485d7c5f1c1e77eb143fbea9572d2845c244"
                      "8a9349de9c34c870206e76cc6aab80365139828ca190d351fc70b83bf893076a", std::to_string(s).data());
    ...
    BOOST_CHECK_EQUAL("e76dfad22084a8b1467fcf2ffa58361bec7628edf5f3fdc0e4805dc48caeeca8"
                      "1b7c13c30adf52a3659584739a2df46be589c51ca1a4a8416df6545a1ce8ba00", std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(sha3_224_preprocessor1) {
    ...
    BOOST_CHECK_EQUAL("6b4e03423667dbb73b6e15454f0eb1abd4597f9a1b078e3f5b5a6bc7",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(sha3_224_preprocessor2) {
    ...
    BOOST_CHECK_EQUAL("e642824c3f8cf24ad09234ee7d3c766fc9a3a5168d0c94ad73b46fdf",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(sha3_224_preprocessor3) {
    ...
    BOOST_CHECK_EQUAL("d69335b93325192e516a912e6d19a15cb51c6ed5c15243e7a7fd653c",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(sha3_256_preprocessor1) {
    ...
    BOOST_CHECK_EQUAL("a7ffc6f8bf1ed76651c14756a061d662f580ff4de43b49fa82d80a4b80f8434a",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(sha3_256_preprocessor2) {
    ...
    BOOST_CHECK_EQUAL("3a985da74fe225b2045c172d6bd390bd855f086e3e9d525b46bfe24511431532",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(sha3_256_preprocessor3) {
    ...
    BOOST_CHECK_EQUAL("5c8875ae474a3634ba4fd55ec85bffd661f32aca75c6d699d0cdcb6c115891c1",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(sha3_384_preprocessor1) {
    ...
    BOOST_CHECK_EQUAL("0c63a75b845e4f7d01107d852e4c2485c51a50aaaa94fc61995e71bbee983a2a"
...
BOOST_AUTO_TEST_CASE(sha3_384_preprocessor3) {
    ...
    BOOST_CHECK_EQUAL("eee9e24d78c1855337983451df97c8ad9eedf256c6334f8e948d252d5e0e7684"
...
BOOST_AUTO_TEST_CASE(sha3_512_preprocessor1) {
    ...
    BOOST_CHECK_EQUAL("a69f73cca23a9ac5c8b567dc185a756e97c982164fe25859e0d1dcc1475c80a6"
...
BOOST_AUTO_TEST_CASE(sha3_512_preprocessor3) {
    ...
    BOOST_CHECK_EQUAL("3c3a876da14034ab60627c077bb98f7e120a2a5370212dffb3385a18d4f38859"
