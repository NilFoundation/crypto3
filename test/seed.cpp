...
#define BOOST_TEST_MODULE seed_cipher_test
...
BOOST_AUTO_TEST_SUITE(seed_encode_test_suite)

    BOOST_DATA_TEST_CASE(seed_single_range_encode, boost::unit_test::data::make(valid_data), array_element) {
