...
static const byte_vector_data_t base64_valid_data = {{"Zg==",                                     {0x66}},
                                                     {"Zm8=",                                     {0x66, 0x6F}},
                                                     {"Zm9v",                                     {0x66, 0x6F, 0x6F}},
...
static const byte_vector_data_t base58_valid_data = {{
                                                                                                     ...
                                                                                                     }},
                                                     {
                                                             "16UwLL9Risc3QfPqBUvKofHmBQ7wMtjvM",    {
                                                                                                      0x00, 0x01, 0x09, 0x66, 0x77, 0x60, 0x06, 0x95, 0x3D, 0x55, 0x67, 0x43, 0x9E, 0x5E, 0x39, 0xF8, 0x6A, 0x0D, 0x27, 0x3B, 0xEE, 0xD6, 0x19, 0x67, 0xF6
                                                                                                     }},
                                                     {
                                                             "1ZiCa",                                {
                                                                                                      0x00, 0x61, 0x62, 0x63
                                                     ...
                                                     {
                                                             "11ZiCa",                               {
                                                                                                      0x00, 0x00, 0x61, 0x62, 0x63
                                                                                                     }},
                                                     {
                                                             "111ZiCa",                              {
                                                                                                      0x00, 0x00, 0x00, 0x61, 0x62, 0x63
                                                                                                     }},
                                                     {
                                                             "1111ZiCa",                             {
                                                                                                      0x00, 0x00, 0x00, 0x00, 0x61, 0x62, 0x63
                                                                                                     }}};
...
static const byte_vector_data_t base32_valid_data = {{
                                                     ...
                                                     {       "KRUGKIBRGUQGG2DBOJZS4LRO",                         {0x54, 0x68, 0x65, 0x20, 0x31, 0x35, 0x20, 0x63, 0x68, 0x61, 0x72, 0x73, 0x2E, 0x2E, 0x2E}},
                                                     {       "IFXCAVKUIYWTQIDVOVWWYORAYO6A====",                 {0x41, 0x6E, 0x20, 0x55, 0x54, 0x46, 0x2D, 0x38, 0x20, 0x75, 0x75, 0x6D, 0x6C, 0x3A, 0x20, 0xC3, 0xBC}},
                                                     {       "K5SWS4TEEBDWK4TNMFXCAMRAMJ4XIZJAORUGS3THHIQMHHZO", {0x57, 0x65, 0x69, 0x72, 0x64, 0x20, 0x47, 0x65, 0x72, 0x6D, 0x61, 0x6E, 0x20, 0x32, 0x20, 0x62, 0x79, 0x74, 0x65, 0x20, 0x74, 0x68, 0x69, 0x6E, 0x67, 0x3A, 0x20, 0xC3, 0x9F, 0x2E}},
                                                     {       "TM======",                                         {0x9B}},
                                                     {       "DRQA====",                                         {0x1C, 0x60}},
...
BOOST_AUTO_TEST_SUITE(base32_codec_test_suite)
    ...
    BOOST_DATA_TEST_CASE(base32_alias_single_range_encode, boost::unit_test::data::make(base32_valid_data),
            array_element) {
...
BOOST_AUTO_TEST_SUITE(base64_codec_test_suite)
    ...
    BOOST_DATA_TEST_CASE(base64_alias_single_range_encode, boost::unit_test::data::make(base64_valid_data),
            array_element) {
