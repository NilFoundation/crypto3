...
class fixture {
public:
    accumulator_set<ripemd<Size>> acc;
    typedef ripemd<Size> hash_t;
...
BOOST_DATA_TEST_CASE(ripemd_128_range_hash, boost::unit_test::data::make(string_128_data), array_element) {
    std::string out = hash<ripemd<128>>(array_element.first);

    BOOST_CHECK_EQUAL(out, array_element.second);
}

BOOST_DATA_TEST_CASE(ripemd_160_range_hash, boost::unit_test::data::make(string_160_data), array_element) {
    std::string out = hash<ripemd<160>>(array_element.first);

    BOOST_CHECK_EQUAL(out, array_element.second);
}

BOOST_DATA_TEST_CASE(ripemd_256_range_hash, boost::unit_test::data::make(string_256_data), array_element) {
    std::string out = hash<ripemd<256>>(array_element.first);

    BOOST_CHECK_EQUAL(out, array_element.second);
}

BOOST_DATA_TEST_CASE(ripemd_320_range_hash, boost::unit_test::data::make(string_320_data), array_element) {
    std::string out = hash<ripemd<320>>(array_element.first);

    BOOST_CHECK_EQUAL(out, array_element.second);
}

BOOST_DATA_TEST_CASE(ripemd_128_typedef_range_hash, boost::unit_test::data::make(string_128_data), array_element) {
    std::string out = hash<ripemd128>(array_element.first);

    BOOST_CHECK_EQUAL(out, array_element.second);
}

BOOST_DATA_TEST_CASE(ripemd_160_typedef_range_hash, boost::unit_test::data::make(string_160_data), array_element) {
    std::string out = hash<ripemd160>(array_element.first);

    BOOST_CHECK_EQUAL(out, array_element.second);
}

BOOST_DATA_TEST_CASE(ripemd_256_typedef_range_hash, boost::unit_test::data::make(string_256_data), array_element) {
    std::string out = hash<ripemd256>(array_element.first);

    BOOST_CHECK_EQUAL(out, array_element.second);
}

BOOST_DATA_TEST_CASE(ripemd_320_typedef_range_hash, boost::unit_test::data::make(string_320_data), array_element) {
    std::string out = hash<ripemd320>(array_element.first);
...
BOOST_AUTO_TEST_CASE(ripemd_128_shortmsg_byte1) {
    ...
    ripemd<128>::digest_type d = hash<ripemd<128>>(a);
...
BOOST_AUTO_TEST_CASE(ripemd_160_shortmsg_byte1) {
    // "a" 
    std::array<char, 1> a = {'\x61'};
    ripemd<160>::digest_type d = hash<ripemd<160>>(a);
...
BOOST_AUTO_TEST_CASE(ripemd_256_shortmsg_byte1) {
    // "a" 
    std::array<char, 1> a = {'\x61'};
    ripemd<256>::digest_type d = hash<ripemd<256>>(a);
...
BOOST_AUTO_TEST_CASE(ripemd_320_shortmsg_byte1) {
    // "a" 
    std::array<char, 1> a = {'\x61'};
    ripemd<320>::digest_type d = hash<ripemd<320>>(a);

    BOOST_CHECK_EQUAL("ce78850638f92658a5a585097579926dda667a57"
                      "16562cfcf6fbe77f63542f99b04705d6970dff5d", std::to_string(d).data());
}
...
BOOST_AUTO_TEST_CASE(ripemd_320_shortmsg_byte2) {
    ...
    BOOST_CHECK_EQUAL("de4c01b3054f8930a79d09ae738e92301e5a1708"
                      "5beffdc1b8d116713e74f82fa942d64cdbc4682d", std::to_string(d).data());
}
...
BOOST_AUTO_TEST_CASE(ripemd_320_shortmsg_byte3) {
    ...
    BOOST_CHECK_EQUAL("3a8e28502ed45d422f68844f9dd316e7b98533fa"
                      "3f2a91d29f84d425c88d6b4eff727df66a7c0197", std::to_string(d).data());
}
...
BOOST_FIXTURE_TEST_CASE(ripemd_128_accumulator3, fixture<128>) {
    ...
    ripemd<128>::construction::type::block_type m2 = {
...
BOOST_FIXTURE_TEST_CASE(ripemd_160_accumulator3, fixture<160>) {
    ...
    ripemd<160>::construction::type::block_type m2 = {
        {0x61616161, 0x61616161, 0x61616161, 0x61616161, 0x61616161, 0x00616161, 0x82934724, 
         0xa0a93453, 0x293c203d, 0x6e6f7071, 0x6f707172, 0x70717273, 0x71727374, 0x72737475, 
         0x00000000, 0x00000000}};
...
BOOST_FIXTURE_TEST_CASE(ripemd_256_accumulator3, fixture<256>) {
    ...
    ripemd<256>::construction::type::block_type m2 = {
        {0x61616161, 0x61616161, 0x61616161, 0x61616161, 0x61616161, 0x00616161, 0x82934724, 
         0xa0a93453, 0x293c203d, 0x6e6f7071, 0x6f707172, 0x70717273, 0x71727374, 0x72737475, 
         0x00000000, 0x00000000}};
...
BOOST_FIXTURE_TEST_CASE(ripemd_320_accumulator1, fixture<320>) {
    ...
    BOOST_CHECK_EQUAL("ce78850638f92658a5a585097579926dda667a57"
                      "16562cfcf6fbe77f63542f99b04705d6970dff5d", std::to_string(s).data());
}
...
BOOST_FIXTURE_TEST_CASE(ripemd_320_accumulator2, fixture<320>) {
    ...
    BOOST_CHECK_EQUAL("de4c01b3054f8930a79d09ae738e92301e5a1708"
                      "5beffdc1b8d116713e74f82fa942d64cdbc4682d", std::to_string(s).data());
}

BOOST_FIXTURE_TEST_CASE(ripemd_320_accumulator3, fixture<320>) {
    // 80 times of "a"
    ripemd<320>::block_type m1 = {
        {0x61616161, 0x61616161, 0x61616161, 0x61616161, 0x61616161, 0x61616161, 0x61616161, 
         0x61616161, 0x61616161, 0x61616161, 0x61616161, 0x61616161, 0x61616161, 0x61616161, 
         0x00010261, 0x67283609}};
    ...
    BOOST_CHECK_EQUAL("2c38e9ceaad3a53d60f0e38db6d1d4d21d711596"
                      "55185b7fa1b85f351c503cdac99f12f583a833a3", std::to_string(s).data());

    ripemd<320>::construction::type::block_type m2 = {
        {0x61616161, 0x61616161, 0x61616161, 0x61616161, 0x61616161, 0x00616161, 0x82934724, 
         0xa0a93453, 0x293c203d, 0x6e6f7071, 0x6f707172, 0x70717273, 0x71727374, 0x72737475, 
         0x00000000, 0x00000000}};
    ...
    BOOST_CHECK_EQUAL("bfe9b13c79cefa874b7deba22e653a8826f0d769"
                      "fb8cecf05c90bfe5ba3a19967ce5a7cc65c0c584", std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(ripemd_128_preprocessor1) {
    ...
    BOOST_CHECK_EQUAL("cdf26213a150dc3ecb610f18f6b38b46",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(ripemd_128_preprocessor2) {
    ...
    BOOST_CHECK_EQUAL("c14a12199c66e4ba84636b0f69144c77",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(ripemd_160_preprocessor1) {
    ...
    BOOST_CHECK_EQUAL("9c1185a5c5e9fc54612808977ee8f548b2258d31",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(ripemd_160_preprocessor2) {
    ...
    BOOST_CHECK_EQUAL("8eb208f7e05d987a9b044a8e98c6b087f15a0bfc",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(ripemd_160_preprocessor3) {
    ...
    BOOST_CHECK_EQUAL("52783243c1697bdbe16d37f97f68f08325dc1528",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(ripemd_256_preprocessor1) {
    ...
    BOOST_CHECK_EQUAL("02ba4c4e5f8ecd1877fc52d64d30e37a2d9774fb1e5d026380ae0168e3c5522d",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(ripemd_256_preprocessor2) {
    ...
    BOOST_CHECK_EQUAL("afbd6e228b9d8cbbcef5ca2d03e6dba10ac0bc7dcbe4680e1e42d2e975459b65",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(ripemd_320_preprocessor1) {
    ...
    BOOST_CHECK_EQUAL("22d65d5661536cdc75c1fdf5c6de7b41b9f27325"
