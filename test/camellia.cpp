...
#define BOOST_TEST_MODULE camellia_cipher_test
...
BOOST_AUTO_TEST_SUITE(camellia_encode_test_suite)

    BOOST_DATA_TEST_CASE(camellia_range_encrypt, boost::unit_test::data::make(valid_data), array_element) {
