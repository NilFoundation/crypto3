...
class fixture {
public:
    accumulator_set<keccak_1600<Size>> acc;
    typedef keccak_1600<Size> hash_t;
...
BOOST_AUTO_TEST_SUITE(keccak_stream_processor_filedriven_test_suite)

BOOST_DATA_TEST_CASE(keccak_224_range_hash, string_data("data_224"), array_element) {
    std::string out = hash<keccak_1600<224>>(array_element.first);
...
BOOST_AUTO_TEST_CASE(keccak_256_shortmsg_byte1) {
    // "a" 
    std::array<char, 1> a = {'\x61'};
    keccak_1600<256>::digest_type d = hash<keccak_1600<256>>(a);
...
BOOST_AUTO_TEST_CASE(keccak_384_shortmsg_byte1) {
    // "a" 
    std::array<char, 1> a = {'\x61'};
    keccak_1600<384>::digest_type d = hash<keccak_1600<384>>(a);

    BOOST_CHECK_EQUAL("85e964c0843a7ee32e6b5889d50e130e6485cffc826a30167d1dc2b3a0cc79cb"
                      "a303501a1eeaba39915f13baab5abacf", std::to_string(d).data());
}
...
BOOST_AUTO_TEST_CASE(keccak_384_shortmsg_byte2) {
    ...
    BOOST_CHECK_EQUAL("f7df1165f033337be098e7d288ad6a2f74409d7a60b49c36642218de161b1f99"
                      "f8c681e4afaf31a34db29fb763e3c28e", std::to_string(d).data());
}
...
BOOST_AUTO_TEST_CASE(keccak_384_shortmsg_byte3) {
    ...
    BOOST_CHECK_EQUAL("8a377db088c43e44040a2bfb26676704999d90527913cabff0a3484825daa54d"
                      "3061e67da7d836a0805356962af310e8", std::to_string(d).data());
}

BOOST_AUTO_TEST_CASE(keccak_512_shortmsg_byte1) {
    // "a" 
    std::array<char, 1> a = {'\x61'};
    keccak_1600<512>::digest_type d = hash<keccak_1600<512>>(a);

    BOOST_CHECK_EQUAL("9c46dbec5d03f74352cc4a4da354b4e9796887eeb66ac292617692e765dbe400"
                      "352559b16229f97b27614b51dbfbbb14613f2c10350435a8feaf53f73ba01c7c", std::to_string(d).data());
}
...
BOOST_AUTO_TEST_CASE(keccak_512_shortmsg_byte2) {
    ...
    BOOST_CHECK_EQUAL("18587dc2ea106b9a1563e32b3312421ca164c7f1f07bc922a9c83d77cea3a1e5"
                      "d0c69910739025372dc14ac9642629379540c17e2a65b19d77aa511a9d00bb96", std::to_string(d).data());
}
...
BOOST_AUTO_TEST_CASE(keccak_512_shortmsg_byte3) {
    ...
    BOOST_CHECK_EQUAL("cccc49fa63822b00004cf6c889b28a035440ffb3ef50e790599935518e2aefb0"
                      "e2f1839170797f7763a5c43b2dcf02abf579950e36358d6d04dfddc2abac7545", std::to_string(d).data());
}
...
BOOST_FIXTURE_TEST_CASE(keccak_384_accumulator, fixture<384>) {
    ...
    BOOST_CHECK_EQUAL("f7df1165f033337be098e7d288ad6a2f74409d7a60b49c36642218de161b1f99"
                      "f8c681e4afaf31a34db29fb763e3c28e", std::to_string(s).data());
}
...
BOOST_FIXTURE_TEST_CASE(keccak_512_accumulator, fixture<512>) {
    ...
    BOOST_CHECK_EQUAL("18587dc2ea106b9a1563e32b3312421ca164c7f1f07bc922a9c83d77cea3a1e5"
                      "d0c69910739025372dc14ac9642629379540c17e2a65b19d77aa511a9d00bb96", std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(keccak_224_preprocessor1) {
    ...
    BOOST_CHECK_EQUAL("f71837502ba8e10837bdd8d365adb85591895602fc552b48b7390abd",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(keccak_224_preprocessor2) {
    ...
    BOOST_CHECK_EQUAL("c30411768506ebe1c2871b1ee2e87d38df342317300a9b97a95ec6a8",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(keccak_256_preprocessor1) {
    ...
    BOOST_CHECK_EQUAL("c5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(keccak_256_preprocessor2) {
    ...
    BOOST_CHECK_EQUAL("4e03657aea45a94fc7d47ba826c8d667c0d1e6e33a64a036ec44f58fa12d6c45",
        std::to_string(s).data());
}
...
BOOST_AUTO_TEST_CASE(keccak_384_preprocessor1) {
    ...
    BOOST_CHECK_EQUAL("2c23146a63a29acf99e73b88f8c24eaa7dc60aa771780ccc006afbfa8fe2479b"
...
BOOST_AUTO_TEST_CASE(keccak_512_preprocessor1) {
    ...
    BOOST_CHECK_EQUAL("0eab42de4c3ceb9235fc91acffe746b29c29a8c366b7c60e4e67c466f36a4304"
