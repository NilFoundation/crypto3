...
static_assert(make_vector(std::complex<double>(1), std::complex<double>(2), std::complex<double>(3)) ==
                  vector {{{1., 0.}, {2., 0.}, {3., 0.}}},
...
static_assert(conj(vector {{{-1., 2.}, {1., -2.}}}) == vector {{{-1., -2.}, {1., 2.}}}, "conj");
...
static_assert(vector {1, 2, 3, 4} == concat(vector {1, 2}, vector {3, 4}), "concat");
