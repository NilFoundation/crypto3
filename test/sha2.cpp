...
//
    ...
    BOOST_AUTO_TEST_CASE(sha256_preprocessor1) {
        sha2<256>::stream_processor<8>::type h;
        sha2<256>::digest_type s = h.end_message();
    ...
    BOOST_AUTO_TEST_CASE(sha384_preprocessor1) {
        sha2<384>::stream_processor<8>::type h;
        sha2<384>::digest_type s = h.end_message();
    ...
    BOOST_AUTO_TEST_CASE(sha512_preprocessor1) {
        sha2<512>::stream_processor<8>::type h;
        sha2<512>::digest_type s = h.end_message();
    ...
    BOOST_AUTO_TEST_CASE(sha512_various_hash1) {
        sha2<512>::stream_processor<16>::type pp;
    ...
    BOOST_AUTO_TEST_CASE(sha512_various_hash2) {
        sha2<512>::stream_processor<32>::type pp;
