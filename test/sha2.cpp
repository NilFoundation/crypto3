...
class fixture {
public:
    hash_accumulator<sha2<Size>> acc;
...
//
    ...
    BOOST_FIXTURE_TEST_CASE(sha2_256_empty_accumulator, fixture<256>) {
        BOOST_CHECK_NO_THROW(hash_t::digest_type
    ...
    BOOST_FIXTURE_TEST_CASE(sha2_256_accumulator3, fixture<256>) {
        ...
        BOOST_CHECK_EQUAL("85e655d6417a17953363376a624cde5c76e09589cac5f811cc4b32c1f20e533a",
    ...
    BOOST_FIXTURE_TEST_CASE(sha2_384_accumulator1, fixture<384>) {
        ...
        BOOST_CHECK_EQUAL("38b060a751ac96384cd9327eb1b1e36a21fdb71114be0743"
    ...
    BOOST_FIXTURE_TEST_CASE(sha2_384_accumulator2, fixture<384>) {
        ...
        BOOST_CHECK_EQUAL("cb00753f45a35e8bb5a03d699ac65007272c32ab0eded163"
    ...
    BOOST_FIXTURE_TEST_CASE(sha2_384_accumulator3, fixture<384>) {
        ...
        hash_t::construction_type::block_type m1 = {{
                                                            UINT64_C(0x6162636465666768), UINT64_C(
                                                                                                  0x6263646566676869), UINT64_C(
                                                                                                                               0x636465666768696a), UINT64_C(
                                                                                                                                                            0x6465666768696a6b), UINT64_C(
                                                                                                                                                                                         0x65666768696a6b6c), UINT64_C(
                                                                                                                                                                                                                      0x666768696a6b6c6d), UINT64_C(
                                                                                                                                                                                                                                                   0x6768696a6b6c6d6e), UINT64_C(
                                                                                                                                                                                                                                                                                0x68696a6b6c6d6e6f), UINT64_C(
                                                                                                                                                                                                                                                                                                             0x696a6b6c6d6e6f70), UINT64_C(
                                                                                                                                                                                                                                                                                                                                          0x6a6b6c6d6e6f7071), UINT64_C(
                                                                                                                                                                                                                                                                                                                                                                       0x6b6c6d6e6f707172), UINT64_C(
                                                                                                                                                                                                                                                                                                                                                                                                    0x6c6d6e6f70717273), UINT64_C(
                                                                                                                                                                                                                                                                                                                                                                                                                                 0x6d6e6f7071727374), UINT64_C(
                                                                                                                                                                                                                                                                                                                                                                                                                                                              0x6e6f707172737475), UINT64_C(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           0x8000000000000000), UINT64_C(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        0x0000000000000000)
                                                    }};
        acc(m1);

        BOOST_CHECK_EQUAL("2a7f1d895fd58e0beaae96d1a673c741015a2173796c1a88"
                          "f6352ca156acaff7c662113e9ebb4d6417b61a85e2ccf0a9", (extract::hash<hash_t>(acc)));
        ...
        BOOST_CHECK_EQUAL("09330c33f71147e83d192fc782cd1b4753111b173b3b05d2"
    ...
    BOOST_FIXTURE_TEST_CASE(sha2_512_accumulator1, fixture<512>) {
        ...
        BOOST_CHECK_EQUAL("cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce"
    ...
    BOOST_FIXTURE_TEST_CASE(sha2_512_accumulator2, fixture<512>) {
        ...
        BOOST_CHECK_EQUAL("ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a"
    ...
    BOOST_FIXTURE_TEST_CASE(sha2_512_accumulator3, fixture<512>) {
        ...
        BOOST_CHECK_EQUAL("8e959b75dae313da8cf4f72814fc143f8f7779c6eb9f7fa17299aeadb6889018"
                          "501d289e4900f7e4331b99dec4b5433ac7d329eeb6dd26545e96e55b874be909", s);
    }

    BOOST_AUTO_TEST_CASE(sha256_preprocessor1) {
        hash_accumulator<sha2<256>> acc;
    ...
    BOOST_AUTO_TEST_CASE(sha384_preprocessor3) {
        ...
        BOOST_CHECK_EQUAL("9d0e1809716474cb086e834e310a4a1ced149e9c00f24852"
                          "7972cec5704c2a5b07b8b3dc38ecc4ebae97ddd87f3d8985", s);
    }

    BOOST_AUTO_TEST_CASE(sha512_preprocessor1) {
        hash_accumulator<sha2<512>> acc;
    ...
    BOOST_AUTO_TEST_CASE(sha512_preprocessor3) {
        ...
        BOOST_CHECK_EQUAL("e718483d0ce769644e2e42c7bc15b4638e1f98b13b2044285632a803afa973eb"
    ...
    BOOST_AUTO_TEST_CASE(sha512_various_hash1) {
        hash_accumulator<sha2<512>> acc;
        sha2<512>::stream_processor<hash_accumulator<sha2<512>>, 16>::type pp(acc);
        ...
        BOOST_CHECK_EQUAL("e718483d0ce769644e2e42c7bc15b4638e1f98b13b2044285632a803afa973eb"
                          "de0ff244877ea60a4cb0432ce577c31beb009c5c2c49aa2e4eadb217ad8cc09b", std::to_string(h).data());
    }

    BOOST_AUTO_TEST_CASE(sha512_various_hash2) {
        hash_accumulator<sha2<512>> acc;
        sha2<512>::stream_processor<hash_accumulator<sha2<512>>, 32>::type pp(acc);
