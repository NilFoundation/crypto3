...
BOOST_AUTO_TEST_SUITE(gost28147_encode_test_suite)

    BOOST_DATA_TEST_CASE(gost28147_single_range_encode, boost::unit_test::data::make(valid_data), array_element) {
