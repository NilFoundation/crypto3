...
#define BOOST_TEST_MODULE ctr_cipher_test
...
#include <nil/crypto3/stream/ctr.hpp>
...
BOOST_AUTO_TEST_SUITE(ctr_test_suite)

BOOST_DATA_TEST_CASE(ctr_single_range_encrypt, boost::unit_test::data::random(0, 16)
