...
BOOST_TEST_DONT_PRINT_LOG_VALUE(tiger<192>::digest_type)

template<std::size_t Size>
class fixture {
public:
    accumulator_set<tiger<Size>> acc;
    typedef tiger<Size> hash_t;
    virtual ~fixture() {
    }
};
...
BOOST_DATA_TEST_CASE(tiger_hash, string_data("data_192"), array_element) {
    std::string out = hash<tiger<192>>(array_element.first);
