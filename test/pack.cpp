...
BOOST_AUTO_TEST_CASE(block_pack_explodebb1) {
...
BOOST_AUTO_TEST_CASE(block_pack_explodebb2) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
...
BOOST_AUTO_TEST_CASE(block_pack_explodebb3) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
...
BOOST_AUTO_TEST_CASE(block_pack_explodebb4) {
...
BOOST_AUTO_TEST_CASE(block_pack_explodebb5) {
    std::array<uint16_t, 2> in = {{0x4567, 0x89AB}};
    std::array<uint8_t, 8> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodebb6) {
...
BOOST_AUTO_TEST_CASE(block_pack_explodebb7) {
...
BOOST_AUTO_TEST_CASE(block_pack_explodebb8) {
...
BOOST_AUTO_TEST_CASE(block_pack_explodelb1) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
    std::array<uint32_t, 2> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodelb2) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
    std::array<uint8_t, 8> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodelb3) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
    std::array<uint16_t, 4> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodelb4) {
    std::array<uint16_t, 2> in = {{0x4567, 0x89AB}};
    std::array<uint8_t, 4> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodelb5) {
    std::array<uint16_t, 2> in = {{0x4567, 0x89AB}};
    std::array<uint8_t, 8> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodelb6) {
    std::array<uint16_t, 1> in = {{0xEC15}};
    std::array<bool, 16> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodelb7) {
    std::array<uint16_t, 1> in = {{0xEC15}};
    std::array<bool, 16> out {};
    pack<little_octet_big_bit, 16, 1>(in, out);
    std::array<bool, 16> eout = {
...
BOOST_AUTO_TEST_CASE(block_pack_explodelb8) {
    std::array<uint8_t, 2> in = {{0xC, 0x5}};
    std::array<bool, 8> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodebl1) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
    std::array<uint32_t, 2> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodebl2) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
    std::array<uint8_t, 8> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodebl3) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
    std::array<uint16_t, 4> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodebl4) {
    std::array<uint16_t, 2> in = {{0x4567, 0x89AB}};
    std::array<uint8_t, 4> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodebl5) {
    std::array<uint16_t, 2> in = {{0x4567, 0x89AB}};
    std::array<uint8_t, 8> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodebl6) {
    std::array<uint16_t, 1> in = {{0xEC15}};
    std::array<bool, 16> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodebl7) {
    std::array<uint8_t, 2> in = {{0xC, 0x5}};
    std::array<bool, 8> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodell1) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
    std::array<uint32_t, 2> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodell2) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
    std::array<uint8_t, 8> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodell3) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
    std::array<uint16_t, 4> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodell4) {
    std::array<uint16_t, 2> in = {{0x4567, 0x89AB}};
    std::array<uint8_t, 4> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodell5) {
    std::array<uint16_t, 2> in = {{0x4567, 0x89AB}};
    std::array<uint8_t, 8> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodell6) {
    std::array<uint16_t, 1> in = {{0xEC15}};
    std::array<bool, 16> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodell7) {
    std::array<uint8_t, 2> in = {{0xC, 0x5}};
    std::array<bool, 8> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_explodell8) {
    std::array<uint16_t, 1> in = {{(31 << 10) | (17 << 5) | (4 << 0)}};
    std::array<uint8_t, 3> out {};
...
BOOST_AUTO_TEST_SUITE(block_pack_implode_test_suite)

BOOST_AUTO_TEST_CASE(block_pack_implodebb1) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
    std::array<uint32_t, 2> out {};
    pack<big_octet_big_bit, 32, 32>(in, out);
    BOOST_CHECK(in == out);
...
BOOST_AUTO_TEST_CASE(block_pack_implodebb2) {
...
BOOST_AUTO_TEST_CASE(block_pack_implodebb3) {
...
BOOST_AUTO_TEST_CASE(block_pack_implodebb4) {
...
BOOST_AUTO_TEST_CASE(block_pack_implodebb5) {
...
BOOST_AUTO_TEST_CASE(block_pack_implodebb6) {
...
BOOST_AUTO_TEST_CASE(block_pack_implodebb7) {
...
BOOST_AUTO_TEST_CASE(block_pack_implodebb8) {
...
BOOST_AUTO_TEST_CASE(block_pack_implodelb1) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
    std::array<uint32_t, 2> out {};
    pack<little_octet_big_bit, 32, 32>(in, out);
    BOOST_CHECK(in == out);
...
BOOST_AUTO_TEST_CASE(block_pack_implodelb2) {
...
BOOST_AUTO_TEST_CASE(block_pack_implodelb3) {
...
BOOST_AUTO_TEST_CASE(block_pack_implodelb4) {
...
BOOST_AUTO_TEST_CASE(block_pack_implodelb5) {
...
BOOST_AUTO_TEST_CASE(block_pack_implodelb6) {
    std::array<bool, 16> in = {
        {false, false, false, true, false, true, false, true, true, true, true, false, true, true, false, false}};
    std::array<uint16_t, 1> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_implodelb7) {
    std::array<bool, 8> in = {{true, true, false, false, false, true, false, true}};
    std::array<uint8_t, 2> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_implodebl1) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
    std::array<uint32_t, 2> out {};
    pack<big_octet_little_bit, 32, 32>(in, out);
    BOOST_CHECK(in == out);
...
BOOST_AUTO_TEST_CASE(block_pack_implodebl2) {
    std::array<uint8_t, 8> in = {{0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF}};
    std::array<uint32_t, 2> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_implodebl3) {
    std::array<uint16_t, 4> in = {{0x0123, 0x4567, 0x89AB, 0xCDEF}};
    std::array<uint32_t, 2> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_implodebl4) {
    std::array<uint8_t, 4> in = {{0x45, 0x67, 0x89, 0xAB}};
    std::array<uint16_t, 2> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_implodebl5) {
...
BOOST_AUTO_TEST_CASE(block_pack_implodebl6) {
    std::array<bool, 16> in = {
        {false, false, true, true, false, true, true, true, true, false, true, false, true, false, false, false}};
    std::array<uint16_t, 1> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_implodebl7) {
...
BOOST_AUTO_TEST_CASE(block_pack_implodell1) {
    std::array<uint32_t, 2> in = {{0x01234567, 0x89ABCDEF}};
    std::array<uint32_t, 2> out {};
    pack<little_octet_little_bit, 32, 32>(in, out);
    BOOST_CHECK(in == out);
...
BOOST_AUTO_TEST_CASE(block_pack_implodell2) {
    std::array<uint8_t, 8> in = {{0x67, 0x45, 0x23, 0x01, 0xEF, 0xCD, 0xAB, 0x89}};
    std::array<uint32_t, 2> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_implodell3) {
    std::array<uint16_t, 4> in = {{0x4567, 0x0123, 0xCDEF, 0x89AB}};
    std::array<uint32_t, 2> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_implodell4) {
    std::array<uint8_t, 4> in = {{0x67, 0x45, 0xAB, 0x89}};
    std::array<uint16_t, 2> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_implodell5) {
...
BOOST_AUTO_TEST_CASE(block_pack_implodell6) {
    std::array<bool, 16> in = {
        {true, false, true, false, true, false, false, false, false, false, true, true, false, true, true, true}};
    std::array<uint16_t, 1> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_implodell7) {
    std::array<bool, 8> in = {{false, false, true, true, true, false, true, false}};
    std::array<uint8_t, 2> out {};
...
BOOST_AUTO_TEST_CASE(block_pack_implodell8) {
...
BOOST_AUTO_TEST_SUITE(block_pack_various_test_suite)
BOOST_AUTO_TEST_CASE(block_pack_various1) {
    using namespace std;
...
BOOST_AUTO_TEST_CASE(block_pack_various2) {
    using namespace std;
    istringstream iss("-1 -2 -4 -8");
    ostringstream oss;
...
BOOST_AUTO_TEST_CASE(block_pack_various3) {
    using namespace std;
...
BOOST_AUTO_TEST_CASE(block_pack_various4) {
    using namespace std;
