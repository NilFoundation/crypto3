...
#define BOOST_TEST_MODULE sm4_cipher_test
...
BOOST_AUTO_TEST_SUITE(sm4_encode_test_suite)

    BOOST_DATA_TEST_CASE(sm4_single_range_encode, boost::unit_test::data::make(valid_data), array_element) {
