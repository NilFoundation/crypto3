...
static const std::unordered_map<std::string, std::string> string_data = {{"",                                                                                 "00000000"},
                                                                         {"a",                                                                                "e8b7be43"},
                                                                         {"abc",                                                                              "352441c2"},
...
static const std::unordered_map<std::string, std::vector<uint8_t>> byte_data = {{"",                                                                                 {0x00, 0x00, 0x00, 0x00}},
