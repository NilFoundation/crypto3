...
macro(cm_project INPUT_PROJECT_NAME)
    set(options)
    ...
    set(CMAKE_PROJECT_NAME ${INPUT_PROJECT_NAME})
    ...
    if(PARSE_WORKSPACE_NAME)
        ...
        set(CURRENT_TEST_SOURCES_DIR ${CMAKE_WORKSPACE_SOURCES_DIR}/${RELATIVE_DIR}/test)
    endif()
endmacro()
