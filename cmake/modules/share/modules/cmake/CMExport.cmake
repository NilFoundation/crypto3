    ...
    if(TARGET ${TARGET})
        ...
        if(TARGET_IMPORTED OR TARGET_ALIAS)
            ...
            if(NOT TARGET_FIND_PACKAGE_NAME)
                message(SEND_ERROR "The target ${TARGET} does not have information about find_package() call.")
            endif()
        ...
        if("${TARGET}" MATCHES "::") # this won't work if we have namespace not ending with ::
...
function(cm_auto_export)
    ...
    set(TARGET_FILE ${PACKAGE_NAME}-targets)
    if(PARSE_EXPORT)
