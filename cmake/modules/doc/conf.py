...
latex_documents = [
    (master_doc, "modules.tex", "modules Documentation", "Paul Fultz II", "manual"),
]
...
man_pages = [(master_doc, "modules", "modules Documentation", [author], 1)]
