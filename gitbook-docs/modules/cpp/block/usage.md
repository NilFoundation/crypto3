...
The easiest way to use Crypto3.Block library is to use an algorithm with explicit key initialization and implicit state usage. The following example encrypts byte sequence with AES block cipher:
