...
int main(int argc, const char *argv[]) {
    ...
    r1cs_example<algebra::Fr<default_r1cs_se_ppzksnark_pp>> example =
        generate_r1cs_example_with_field_input<algebra::Fr<default_r1cs_se_ppzksnark_pp>>(num_constraints, input_size);
