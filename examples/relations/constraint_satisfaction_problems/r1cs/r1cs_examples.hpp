    ...
    namespace crypto3 {
        namespace zk {
            namespace snark {
                 ...
                 */
                template<typename FieldType>
                r1cs_example<FieldType> generate_r1cs_example_with_field_input(const size_t num_constraints,
                 ...
                 */
                template<typename FieldType>
                r1cs_example<FieldType> generate_r1cs_example_with_binary_input(const size_t num_constraints,
                                                                             const size_t num_inputs);
