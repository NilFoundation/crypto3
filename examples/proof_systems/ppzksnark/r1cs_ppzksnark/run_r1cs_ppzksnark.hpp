    ...
    namespace crypto3 {
        namespace zk {
            namespace snark {
                ...
                bool run_r1cs_ppzksnark(const r1cs_example<algebra::Fr<ppT>> &example, const bool test_serialization);
                ...
                test_affine_verifier(const r1cs_ppzksnark_verification_key<ppT> &vk,
                    ...
                    algebra::print_header("R1CS ppzkSNARK Affine Verifier");
                ...
                template<typename ppT>
                bool run_r1cs_ppzksnark(const r1cs_example<algebra::Fr<ppT>> &example, const bool test_serialization) {
                    algebra::enter_block("Call to run_r1cs_ppzksnark");

                    algebra::print_header("R1CS ppzkSNARK Generator");
                    ...
                    if (test_serialization) {
                        ...
                        keypair.pk = algebra::reserialize<r1cs_ppzksnark_proving_key<ppT>>(keypair.pk);
                        keypair.vk = algebra::reserialize<r1cs_ppzksnark_verification_key<ppT>>(keypair.vk);
                        pvk = algebra::reserialize<r1cs_ppzksnark_processed_verification_key<ppT>>(pvk);
                        algebra::leave_block("Test serialization of keys");
                    }

                    algebra::print_header("R1CS ppzkSNARK Prover");
                    r1cs_ppzksnark_proof<ppT> proof =
                        r1cs_ppzksnark_prover<ppT>(keypair.pk, example.primary_input, example.auxiliary_input);
                    printf("\n");
                    algebra::print_indent();
                    ...
                    if (test_serialization) {
                        ...
                        proof = algebra::reserialize<r1cs_ppzksnark_proof<ppT>>(proof);
                        algebra::leave_block("Test serialization of proof");
                    }

                    algebra::print_header("R1CS ppzkSNARK Verifier");
                    ...
                    algebra::print_header("R1CS ppzkSNARK Online Verifier");
                    ...
                    algebra::leave_block("Call to run_r1cs_ppzksnark");
