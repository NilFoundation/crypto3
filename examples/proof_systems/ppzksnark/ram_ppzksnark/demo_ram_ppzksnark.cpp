...
bool process_demo_command_line(const int argc, const char **argv, std::string &assembly_fn,
...
int main(int argc, const char *argv[]) {
    ...
    typedef ram_base_field<default_ram> FieldType;
    ...
    printf("================================================================================\n\n");
    const ram_ppzksnark_keypair<default_tinyram_ppzksnark_pp> keypair =
        ram_ppzksnark_generator<default_tinyram_ppzksnark_pp>(ap, boot_trace_size_bound, time_bound);
    ...
    const ram_ppzksnark_proof<default_tinyram_ppzksnark_pp> proof =
        ram_ppzksnark_prover<default_tinyram_ppzksnark_pp>(keypair.pk, boot_trace, auxiliary_input);
