...
//static
        fe25519 fe25519::invert(const fe25519 &z) {
            fe t0;
            fe t1;
            fe t2;
            fe t3;
        ...
        fe25519 fe25519::pow_22523(const fe &z) {
            fe t0;
            fe t1;
            fe t2;
...
//static
        fe25519 fe25519::sqr_iter(const fe25519 &f, size_t iter) {
            int32_t f0 = f[0];
            int32_t f1 = f[1];
            int32_t f2 = f[2];
            int32_t f3 = f[3];
...
//static
        fe25519 fe25519::sqr2(const fe25519 &f) {
            const int32_t f0 = f[0];
            const int32_t f1 = f[1];
            const int32_t f2 = f[2];
            const int32_t f3 = f[3];
...
*/
        ...
        void fe25519::from_bytes(const uint8_t s[32]) {
            int64_t h0 = load_4(s);
...
*/
        ...
        void fe25519::to_bytes(uint8_t s[32]) const {
