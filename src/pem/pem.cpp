...
*/
            secure_vector <uint8_t> decode_check_label(data_source &source, const std::string &label_want) {
...
* Decode PEM down to raw BER/DER
*/
            secure_vector <uint8_t> decode(data_source &source, std::string &label) {
...
*/
            bool matches(data_source &source, const std::string &extra, size_t search_range) {
