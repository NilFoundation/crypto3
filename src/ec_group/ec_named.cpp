...
//static
        std::shared_ptr<ec_group_data> ec_group::ec_group_info(const oid_t &oid) {
            // P-256
            if (oid == oid_t{1, 2, 840, 10045, 3, 1, 7}) {
                return load_ec_group_info("0xFFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF",
                                          ...
                                          "0xFFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551", oid);
            }

            // P-384
            if (oid == oid_t{1, 3, 132, 0, 34}) {
            ...
            if (oid == oid_t{1, 3, 36, 3, 3, 2, 8, 1, 1, 5}) {
                return load_ec_group_info("0xD7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FF",
                                          ...
                                          "0xD7C134AA264366862A18302575D0FB98D116BC4B6DDEBCA3A5A7939F", oid);
            }
            // brainpool256r1
            if (oid == oid_t{1, 3, 36, 3, 3, 2, 8, 1, 1, 7}) {
                return load_ec_group_info("0xA9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377",
                                          ...
                                          "0xA9FB57DBA1EEA9BC3E660A909D838D718C397AA3B561A6F7901E0E82974856A7", oid);
            }
            // brainpool320r1
            if (oid == oid_t{1, 3, 36, 3, 3, 2, 8, 1, 1, 9}) {
                return load_ec_group_info(
                        ...
                        "0xD35E472036BC4FB7E13C785ED201E065F98FCFA5B68F12A32D482EC7EE8658E98691555B44C59311", oid);
            }
            // brainpool384r1
            if (oid == oid_t{1, 3, 36, 3, 3, 2, 8, 1, 1, 11}) {
                return load_ec_group_info(
            ...
            // brainpool512r1
            if (oid == oid_t{1, 3, 36, 3, 3, 2, 8, 1, 1, 13}) {
                return load_ec_group_info(
            ...
            // frp256v1
            if (oid == oid_t{1, 2, 250, 1, 223, 101, 256, 1}) {
                return load_ec_group_info("0xF1FD178C0B3AD58F10126DE8CE42435B3961ADBCABC8CA6DE8FCF353D86E9C03",
                                          ...
                                          "0xF1FD178C0B3AD58F10126DE8CE42435B53DC67E140D2BF941FFDD459C6D655E1", oid);
            }
            // gost_256A
            if (oid == oid_t{1, 2, 643, 2, 2, 35, 1}) {
                return load_ec_group_info("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFD97",
                                          "0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFD94", "0xA6",
                                          "0x1", "0x8D91E471E0989CDA27DF505A453F2B7635294F2DDF23E3B122ACC99C9E9F1E14",
                                          "0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF6C611070995AD10045841B09B761B893", oid);
            }
            // secp160k1
            if (oid == oid_t{1, 3, 132, 0, 9}) {
                return load_ec_group_info("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC73", "0x0", "0x7",
                                          "0x3B4C382CE37AA192A4019E763036F4F5DD4D7EBB",
                                          "0x938CF935318FDCED6BC28286531733C3F03C4FEE",
                                          "0x100000000000000000001B8FA16DFAB9ACA16B6B3", oid);
            }
            // secp160r1
            if (oid == oid_t{1, 3, 132, 0, 8}) {
                return load_ec_group_info("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFF",
                                          ...
                                          "0x100000000000000000001F4C8F927AED3CA752257", oid);
            }
            // secp160r2
            if (oid == oid_t{1, 3, 132, 0, 30}) {
                return load_ec_group_info("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC73",
                                          ...
                                          "0x100000000000000000000351EE786A818F3A1A16B", oid);
            }
            // secp192k1
            if (oid == oid_t{1, 3, 132, 0, 31}) {
                return load_ec_group_info("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFEE37", "0x0", "0x3",
                                          "0xDB4FF10EC057E9AE26B07D0280B7F4341DA5D1B1EAE06C7D",
                                          "0x9B2F2F6D9C5628A7844163D015BE86344082AA88D95E2F9D",
                                          "0xFFFFFFFFFFFFFFFFFFFFFFFE26F2FC170F69466A74DEFD8D", oid);
            }
            // secp192r1
            if (oid == oid_t{1, 2, 840, 10045, 3, 1, 1}) {
                return load_ec_group_info("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFF",
                                          ...
                                          "0xFFFFFFFFFFFFFFFFFFFFFFFF99DEF836146BC9B1B4D22831", oid);
            }
            // secp224k1
            if (oid == oid_t{1, 3, 132, 0, 32}) {
                return load_ec_group_info("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFE56D", "0x0", "0x5",
                                          "0xA1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C",
                                          "0x7E089FED7FBA344282CAFBD6F7E319F7C0B0BD59E2CA4BDB556D61A5",
                                          "0x10000000000000000000000000001DCE8D2EC6184CAF0A971769FB1F7", oid);
            }
            // secp224r1
            if (oid == oid_t{1, 3, 132, 0, 33}) {
                return load_ec_group_info("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001",
                                          ...
                                          "0xFFFFFFFFFFFFFFFFFFFFFFFFFFFF16A2E0B8F03E13DD29455C5C2A3D", oid);
            }
            // secp256k1
            if (oid == oid_t{1, 3, 132, 0, 10}) {
                return load_ec_group_info("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFC2F", "0x0",
                                          "0x7", "0x79BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798",
                                          "0x483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8",
                                          "0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141", oid);
            }

            // sm2p256v1
            if (oid == oid_t{1, 2, 156, 10197, 1, 301}) {
                return load_ec_group_info("0xFFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF00000000FFFFFFFFFFFFFFFF",
                                          ...
                                          "0xFFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFF7203DF6B21C6052B53BBF40939D54123", oid);
            }
            // x962_p192v2
            if (oid == oid_t{1, 2, 840, 10045, 3, 1, 2}) {
                return load_ec_group_info("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFF",
                                          "0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC",
                                          ...
                                          "0xFFFFFFFFFFFFFFFFFFFFFFFE5FB1A724DC80418648D8DD31", oid);
            }
            // x962_p192v3
            if (oid == oid_t{1, 2, 840, 10045, 3, 1, 3}) {
                return load_ec_group_info("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFF",
                                          "0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC",
                                          ...
                                          "0xFFFFFFFFFFFFFFFFFFFFFFFF7A62D031C83F4294F640EC13", oid);
            }
            // x962_p239v1
            if (oid == oid_t{1, 2, 840, 10045, 3, 1, 4}) {
                return load_ec_group_info("0x7FFFFFFFFFFFFFFFFFFFFFFF7FFFFFFFFFFF8000000000007FFFFFFFFFFF",
                                          ...
                                          "0x7FFFFFFFFFFFFFFFFFFFFFFF7FFFFF9E5E9A9F5D9071FBD1522688909D0B", oid);
            }
            // x962_p239v2
            if (oid == oid_t{1, 2, 840, 10045, 3, 1, 5}) {
                return load_ec_group_info("0x7FFFFFFFFFFFFFFFFFFFFFFF7FFFFFFFFFFF8000000000007FFFFFFFFFFF",
                                          "0x7FFFFFFFFFFFFFFFFFFFFFFF7FFFFFFFFFFF8000000000007FFFFFFFFFFC",
                                          ...
                                          "0x7FFFFFFFFFFFFFFFFFFFFFFF800000CFA7E8594377D414C03821BC582063", oid);
            }
            // x962_p239v3
            if (oid == oid_t{1, 2, 840, 10045, 3, 1, 6}) {
                return load_ec_group_info("0x7FFFFFFFFFFFFFFFFFFFFFFF7FFFFFFFFFFF8000000000007FFFFFFFFFFF",
                                          "0x7FFFFFFFFFFFFFFFFFFFFFFF7FFFFFFFFFFF8000000000007FFFFFFFFFFC",
                                          ...
                                          "0x7FFFFFFFFFFFFFFFFFFFFFFF7FFFFF975DEB41B3A6057C3C432146526551", oid);
            }
...
//static
        const std::set<std::string> &ec_group::known_named_groups() {
            static const std::set<std::string> named_groups = {"secp160k1", "secp160r1", "secp160r2", "secp192k1",
                                                               "secp192r1", "secp224k1", "secp224r1", "secp256k1",
                                                               "secp256r1", "secp384r1", "secp521r1", "brainpool160r1",
                                                               "brainpool192r1", "brainpool224r1", "brainpool256r1",
                                                               "brainpool320r1", "brainpool384r1", "brainpool512r1",
                                                               "x962_p192v2", "x962_p192v3", "x962_p239v1",
                                                               "x962_p239v2", "x962_p239v3", "gost_256A", "frp256v1",
                                                               "sm2p256v1"};
            return named_groups;
        }
    }
