...
#include <nil/crypto3/internal/xmss_verification_operation.h>

namespace nil {
    namespace crypto3 {

        XMSS_Verification_Operation::XMSS_Verification_Operation(const XMSS_PublicKey &public_key) : XMSS_Common_Ops(
                public_key.xmss_oid()), m_pub_key(public_key), m_msg_buf(0) {
        }
