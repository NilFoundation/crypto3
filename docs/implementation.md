...
## Architecture Overview {#mac_arch}
...
node [shape="box"]
  ...
  a [label="Algorithms" color="#F5F2F1" fontcolor="#F5F2F1" URL="@ref mac_algorithms"];
  b [label="Stream Processors" color="#F5F2F1" fontcolor="#F5F2F1" URL="@ref mac_stream"];
  c [label="Constructions and Compressors" color="#F5F2F1" fontcolor="#F5F2F1" URL="@ref mac_pol"];
  d [label="Accumulators" color="#F5F2F1" fontcolor="#F5F2F1" URL="@ref mac_acc"];
  e [label="Value Processors" color="#F5F2F1" fontcolor="#F5F2F1" URL="@ref mac_val"];
...
## Stream Data Processing {#mac_stream}
...
parameter set unique for each [`Hash`](@ref mac_concept) type, which takes 
...
Now with this a [`Hash`](@ref mac_concept) instance of [sha2](@ref hash::sha2) 
can be fed.
...
## Hash Algorithms {#mac_pol}

## Accumulators {#mac_acc}

## Value Postprocessors {#mac_val}